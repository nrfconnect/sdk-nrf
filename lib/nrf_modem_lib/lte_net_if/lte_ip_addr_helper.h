...
/** @brief Add IPv4 address for a specific PDP context to the network interface.
 *
...
/** @brief Add IPv6 address for a specific PDP context to the network interface.
 *
 *  @param iface Pointer to network interface.
 *  @param cid PDP context ID.
 *
 *  @retval 0 on success.
 *  @retval -EINVAL if the passed in network interface pointer was NULL or invalid CID.
...
/** @brief Remove IPv4 address that was previously associated with a specific PDP context
...
/** @brief Remove IPv6 address that was previously associated with a specific PDP context
 *         from the network interface.
 *
 *  @param iface Pointer to network interface.
 *  @param cid PDP context ID.
