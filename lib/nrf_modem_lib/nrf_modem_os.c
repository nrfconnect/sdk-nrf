...
extern struct nrf_modem_lib_shmem {
...
#endif
} __aligned(4) nrf_modem_lib_shmem;

#define SHMEM_TX_HEAP_ADDR (nrf_modem_lib_shmem.tx)
#define SHMEM_TX_HEAP_SIZE (sizeof(nrf_modem_lib_shmem.tx))
