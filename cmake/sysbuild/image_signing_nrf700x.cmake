...
function(nrf7x_signing_tasks input output_hex output_bin dependencies)
  ...
  if(SB_CONFIG_PARTITION_MANAGER)
    ...
    set(imgtool_sign ${PYTHON_EXECUTABLE} ${IMGTOOL} sign --version ${CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION} --align ${write_block_size} --slot-size $<TARGET_PROPERTY:partition_manager,PM_NRF70_WIFI_FW_SIZE> --pad-header --header-size ${SB_CONFIG_PM_MCUBOOT_PAD})
    ...
    dt_nodelabel(nrf70_wifi_fw_partition_nodelabel TARGET ${DEFAULT_IMAGE} NODELABEL "nrf70_wifi_fw_partition")
    dt_reg_size(nrf70_wifi_fw_partition_size TARGET ${DEFAULT_IMAGE} PATH "${nrf70_wifi_fw_partition_nodelabel}")
    sysbuild_get(CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION IMAGE ${DEFAULT_IMAGE} VAR CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION KCONFIG)
    sysbuild_get(CONFIG_ROM_START_OFFSET IMAGE ${DEFAULT_IMAGE} VAR CONFIG_ROM_START_OFFSET KCONFIG)
    set(imgtool_sign ${PYTHON_EXECUTABLE} ${IMGTOOL} sign --version ${CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION} --align ${write_block_size} --slot-size ${nrf70_wifi_fw_partition_size} --pad-header --header-size ${CONFIG_ROM_START_OFFSET})
    sysbuild_get(CONFIG_MCUBOOT_HARDWARE_DOWNGRADE_PREVENTION IMAGE ${DEFAULT_IMAGE} VAR CONFIG_MCUBOOT_HARDWARE_DOWNGRADE_PREVENTION KCONFIG)
  endif()
