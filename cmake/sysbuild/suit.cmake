...
function(suit_create_package)
  ...
  foreach(image ${IMAGES})
    ...
    if(encrypt)
      ...
      if(SB_CONFIG_SUIT_ENVELOPE_KMS_SCRIPT_BASIC AND NOT default_kms_warning_displayed)
        message(WARNING "
        -----------------------------------------------------------
       ...
       set(default_kms_warning_displayed TRUE)
      endif()

      set(SUIT_ENCRYPT_ARGS)
      sysbuild_get(CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_STRING_KEY_ID IMAGE ${image} VAR CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_STRING_KEY_ID KCONFIG)
      sysbuild_get(CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_KEY_NAME IMAGE ${image} VAR CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_KEY_NAME KCONFIG)
      sysbuild_get(CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_PLAINTEXT_HASH_ALG IMAGE ${image} VAR CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_PLAINTEXT_HASH_ALG KCONFIG)

      list(APPEND SUIT_ENCRYPT_ARGS --firmware ${BINARY_DIR}/zephyr/${BINARY_FILE})
      list(APPEND SUIT_ENCRYPT_ARGS --key-name ${CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_KEY_NAME})
      list(APPEND SUIT_ENCRYPT_ARGS --string-key-id ${CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_STRING_KEY_ID})
      list(APPEND SUIT_ENCRYPT_ARGS --hash-alg ${CONFIG_SUIT_ENVELOPE_TARGET_ENCRYPT_PLAINTEXT_HASH_ALG})
      list(APPEND SUIT_ENCRYPT_ARGS --context ${SB_CONFIG_SUIT_ENVELOPE_KMS_SCRIPT_CONTEXT})
      list(APPEND SUIT_ENCRYPT_ARGS --kms-script ${SB_CONFIG_SUIT_ENVELOPE_KMS_SCRIPT_PATH})
