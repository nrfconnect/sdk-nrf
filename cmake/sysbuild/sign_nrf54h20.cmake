...
function(mcuboot_sign_merged_nrf54h20 merged_hex main_image merged_images)
  ...
  if(SB_CONFIG_NCS_MCUBOOT_LOAD_PERIPHCONF)
    ...
    generate_ironside_se_tlvs_sysbuild(${tlv_prefix} tlv_extra_imgtool_args tlv_extra_sign_depends
  ...
  if(SB_CONFIG_NCS_MCUBOOT_LOAD_PERIPHCONF AND SB_CONFIG_BUILD_OUTPUT_HEX)
    add_ironside_se_tlv_conf_validate_targets_merged(${tlv_prefix}
      signed_${main_image} "${BYPRODUCT_KERNEL_SIGNED_HEX_NAME}" ${start_offset}
    )
  endif()
endfunction()
