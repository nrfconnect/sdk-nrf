...
function(merge_images_nrf54h20 output_artifact output_extra_imgtool_args prefix images)
  ...
  if(ironside_se_tlv_args)
    ...
    if(SB_CONFIG_MCUBOOT_LOAD_PERIPHCONF)
      ...
      # TODO: How to get TLV ID here?
      list(APPEND extra_imgtool_args --custom-tlv-file 0xA1 ${periphconf_tlv_bin})
    endif()
    set(ironside_se_tlv_cmd
      COMMAND
      ${PYTHON_EXECUTABLE}
