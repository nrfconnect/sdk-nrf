...
function(sign_with_modifiers modifiers imgtool_sign file_to_sign output imgtool_cmds byproducts)
  ...
  elseif(modifiers_length GREATER_EQUAL 2)
    ...
    # processed.
    # Pop the last modifiers and call the signing function once agan, so teven if the list is empty,
...
function(mcuboot_sign_sysbuild main_image)
  ...
  # If MCUboot image is present in the buld, use it's DTS as a slource for slot
...
if(SB_CONFIG_MCUBOOT_SYSBUILD_SIGN)
  ...
  foreach(image ${images})
    # Images signed through sysbuild are matrked as build only.
