...
function(egpio_update_kconfig)
  if(SB_CONFIG_EGPIO_BACKEND_MBOX)
    ...
    endforeach()
    if(DEFINED SB_CONFIG_SOC_NRF54L15_ENGA AND DEFINED SB_CONFIG_SOC_NRF54L15)
      sysbuild_cache_set(VAR flpr_egpio_EXTRA_DTC_OVERLAY_FILE APPEND REMOVE_DUPLICATES "./boards/nrf54l15pdk_nrf54l15_cpuflpr_mbox.overlay")
    elseif(DEFINED SB_CONFIG_SOC_NRF54L15)
  ...
  elseif(SB_CONFIG_EGPIO_BACKEND_ICMSG)
    ...
    if(DEFINED SB_CONFIG_SOC_NRF54L15_ENGA AND DEFINED SB_CONFIG_SOC_NRF54L15)
      sysbuild_cache_set(VAR flpr_egpio_EXTRA_DTC_OVERLAY_FILE APPEND REMOVE_DUPLICATES "./boards/nrf54l15pdk_nrf54l15_cpuflpr_icmsg.overlay")
    elseif(DEFINED SB_CONFIG_SOC_NRF54L15)
