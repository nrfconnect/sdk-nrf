    ...
    if(NOT EXISTS ${SIGNATURE_PUBLIC_KEY_FILE} OR IS_DIRECTORY ${SIGNATURE_PUBLIC_KEY_FILE})
      ...
      execute_process (
        ...
        if(NOT "${keyhash}" STREQUAL "0")
          message(WARNING "Key file ${SIGNATURE_PUBLIC_KEY_FILE} yelds HASH that contains 0xffff which isn't allowed due to limitations of the internal clockworks. To solve the issue use another key.")
        endif()
    endif()
  else()
