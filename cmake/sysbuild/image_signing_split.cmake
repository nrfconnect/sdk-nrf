...
function(zephyr_mcuboot_tasks)
  ...
  if("${code_partition_path}" STREQUAL "${slot0_partition_path}" OR
    (slot0_ns_partition_path AND "${code_partition_path}" STREQUAL "${slot0_ns_partition_path}")
  )
  ...
  elseif("${code_partition_path}" STREQUAL "${slot1_partition_path}" OR
    (slot1_ns_partition_path AND "${code_partition_path}" STREQUAL "${slot1_ns_partition_path}")
  )
