...
foreach(d APP ${PM_DOMAINS})
  ...
  sysbuild_get(${image_name}_CONFIG_SOC_NRF54L15_ENGA_CPUAPP IMAGE ${image_name} VAR CONFIG_SOC_NRF54L15_ENGA_CPUAPP KCONFIG)
  ...
  elseif (DEFINED ${image_name}_CONFIG_SOC_NRF54L15_ENGA_CPUAPP)
  ...
  if (${image_name}_CONFIG_SOC_SERIES_NRF91X OR ${image_name}_CONFIG_SOC_NRF5340_CPUAPP OR ${image_name}_CONFIG_SOC_NRF54L15_ENGA_CPUAPP)
    add_region(
      NAME otp
      SIZE ${otp_size}
      BASE ${otp_start_addr}
