...
foreach(d APP ${PM_DOMAINS})
  ...
  if (${image_name}_CONFIG_SOC_SERIES_NRF91X OR ${image_name}_CONFIG_SOC_NRF5340_CPUAPP OR ${image_name}_CONFIG_SOC_NRF54L15_CPUAPP OR ${image_name}_CONFIG_SOC_NRF54L05_CPUAPP OR ${image_name}_CONFIG_SOC_NRF54L10_CPUAPP OR ${image_name}_CONFIG_SOC_NRF54LV10A_ENGA_CPUAPP)
    add_region(
      NAME otp
      SIZE ${otp_size}
      BASE ${otp_start_addr}
