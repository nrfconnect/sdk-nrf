  ...
  if(SB_CONFIG_DFU_ZIP_APP)
    if(SB_CONFIG_QSPI_XIP_SPLIT_IMAGE)
      ...
      if(SB_CONFIG_BOOT_ENCRYPTION)
        ...
        set(secondary_app_update_name mcuboot_secondary_app.signed.encrypted.bin)
      else()
      ...
      if(NOT SB_CONFIG_MCUBOOT_BUILD_DIRECT_XIP_VARIANT)
        ...
        if(SB_CONFIG_BOOT_ENCRYPTION)
          list(APPEND bin_files
               "${CMAKE_BINARY_DIR}/${DEFAULT_IMAGE}/zephyr/${CONFIG_KERNEL_BIN_NAME}.signed.encrypted.bin"
               "${CMAKE_BINARY_DIR}/mcuboot_secondary_app/zephyr/${CONFIG_KERNEL_BIN_NAME}.signed.encrypted.bin"
          )
          set(exclude_files EXCLUDE
              ${CMAKE_BINARY_DIR}/${DEFAULT_IMAGE}/zephyr/${CONFIG_KERNEL_BIN_NAME}.signed.encrypted.bin
              ${CMAKE_BINARY_DIR}/mcuboot_secondary_app/zephyr/${CONFIG_KERNEL_BIN_NAME}.signed.encrypted.bin
