...
function(fast_pair_hex_pm)
  ...
  set(fp_partition_name_defined $<TARGET_PROPERTY:partition_manager,PM_BT_FAST_PAIR_NAME>)
  ...
  add_custom_target(
    ...
    COMMAND
    ${CMAKE_COMMAND} -D PARTITION_NAME=${fp_partition_name} -D PARTITION_NAME_DEFINED=${fp_partition_name_defined} -P ${ZEPHYR_NRF_MODULE_DIR}/cmake/sysbuild/fast_pair/pm_partition_validation.cmake
    WORKING_DIRECTORY
...
function(fast_pair_hex_dts)
  ...
  if(NOT bt_fast_pair_partition_node_full_path)
    message(FATAL_ERROR
            "The `bt_fast_pair_partition` partition node is not defined in the DTS overlay "
...
function(fast_pair_device_model_warning)
  # Maintains the list of Nordic owned Fast Pair device models. These models are automatically
  # supplied to the Fast Pair projects that are maintained in the nRF Connect SDK.
  if(SB_CONFIG_BT_FAST_PAIR_MODEL_ID STREQUAL "0x2A410B" OR
     SB_CONFIG_BT_FAST_PAIR_MODEL_ID STREQUAL "0x4A436B" OR
     SB_CONFIG_BT_FAST_PAIR_MODEL_ID STREQUAL "0x52FF02" OR
     SB_CONFIG_BT_FAST_PAIR_MODEL_ID STREQUAL "0x8E717D")
    message(WARNING "
    -------------------------------------------------------
