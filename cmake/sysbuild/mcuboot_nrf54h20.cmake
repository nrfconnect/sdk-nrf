...
if(SB_CONFIG_MCUBOOT_SIGN_MERGED_BINARY)
  ...
  merge_images_nrf54h20(${MERGED_IMAGES_HEX} extra_imgtool_args "merged" "${images}")
  ...
  if(variants)
    ...
    merge_images_nrf54h20(${MERGED_IMAGES_SECONDARY_HEX}
      extra_imgtool_args "merged_secondary_app" "${variants}")
  ...
  if(firmware_updater)
    ...
    merge_images_nrf54h20(${MERGED_IMAGES_FIRMWARE_UPDATER_HEX}
      extra_imgtool_args "merged_firmware_updater" "${firmware_updater}")
