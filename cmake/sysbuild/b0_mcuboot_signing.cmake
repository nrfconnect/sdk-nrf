...
function(ncs_secure_boot_mcuboot_sign application bin_files signed_targets prefix)
  ...
  set(imgtool_sign ${PYTHON_EXECUTABLE} ${IMGTOOL} sign --version ${SB_CONFIG_SECURE_BOOT_MCUBOOT_VERSION} --align ${alignment} --slot-size ${slot_size} --overwrite-only --header-size ${header_size} ${pad_header} --rom-fixed ${slot_address})
