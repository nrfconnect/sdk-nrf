...
function(ncs_secure_boot_mcuboot_sign application bin_files signed_targets prefix)
  ...
  if(SB_CONFIG_PARTITION_MANAGER)
    ...
    sysbuild_dt_chosen(code_partition_node IMAGE ${application} PROPERTY "zephyr,code-partition")
    sysbuild_dt_reg_size(slot_size IMAGE ${application} PATH ${code_partition_node})
