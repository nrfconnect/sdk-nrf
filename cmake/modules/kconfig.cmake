...
if(CONFIG_NCS_IS_VARIANT_IMAGE)
  ...
  if(SB_CONFIG_PARTITION_MANAGER)
    ...
    elseif(soc_series_nrf54l EQUAL 1)
      ...
      # partition labeled s0_partition, and s1_image to run from partition labeled s1_partition.
      ...
      if(code_partition_offset EQUAL s0_slot_addr)
        ...
        message(FATAL_ERROR "Expected zephyr,code-partition to match s0_partition for MCUboot build")
      endif()
    else()
