...
export NRF_CONNECT_BASE=$( builtin cd "$( dirname "$DIR" )" && pwd ${PWD_OPT})
export ZEPHYR_BASE=$(echo $NRF_CONNECT_BASE | sed s/connect-nrf/connect-zephyr/g)
unset PWD_OPT
