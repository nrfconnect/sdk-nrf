...
struct audio_metadata {
	 ...
	 * word (int_32), 100 samples in each of 2 locations and a data
	 * length in us of 10000 then:
	 *     bitrate_bps = (32 * 100 * 2) / 0.01
	 *                 = 640000 bps
	 * For encoded data the bit-rate will be determined by the
	 * encoding process.
	 */
