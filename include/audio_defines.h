...
struct audio_metadata {
	...
	/* Number of bytes per channel (left/right etc) */
	...
	/* A bitfield to indicate if any channel has errors (1 = bad, 0 = good).
	 * Note: Timestamps are still valid even though this is set.
	 */
	uint32_t bad_data;
};
