...
struct bt_fast_pair_adv_manager_trigger_config {
	...
	/** Request suspension of the RPA used by Fast Pair advertising set.
	 *
 ...
 *  is enabled with this function and is configured for the pairing mode.
 *
 ...
 *
 *  It is possible to use this API and the change the trigger state when the Fast Pair Advertising
