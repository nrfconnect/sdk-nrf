...
#ifndef BT_GATT_BMS_SRV_H_
#define BT_GATT_BMS_SRV_H_

/**@file
 * @defgroup bt_gatt_bms_srv Bond Management Service API
 * @{
...
struct bt_gatt_bms_srv_feature {
	/* Support the feature. */
	uint8_t supported : 1;
...
struct bt_gatt_bms_srv_features {
	/* Support the operation to delete all bonds. */
	struct bt_gatt_bms_srv_feature delete_all;

	/* Support the operation to delete the bonds of
	 * the requesting device.
	 */
	struct bt_gatt_bms_srv_feature delete_requesting;

	/* Support the operation to delete all bonds except for the bond of
	 * the requesting device.
	 */
	struct bt_gatt_bms_srv_feature delete_rest;
};

/** @brief BMS initialization parameters. */
struct bt_gatt_bms_srv_init_params {
	/* Callbacks. */
	struct bt_gatt_bms_srv_cb *cbs;
	/* Features. */
