...
/**@brief DST Offset enumerations as defined by the Bluetooth specification (Characteristic 0x2A0D). */
...
typedef void (*bt_cts_lti_read_cb)(struct bt_cts_client *cts_c,
...
/**@brief Function for reading the peer's Current Time Service Local Time Information characteristic.
 *
 * @param[in] cts_c  Current Time Service client structure.
 * @param[in] func   The callback function.
 *
