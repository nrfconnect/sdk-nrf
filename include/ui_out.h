...
#define __UI_OUT_LED_ASSIGN(_led) \
	BIT((_led) - 1)

#define UI_OUT_LED_ADV __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_ADV_STARTED_LED)
#define UI_OUT_LED_CONNECTED __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_CONNECTED_LED)
#define UI_OUT_LED_BONDING __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_BONDING_LED)
#define UI_OUT_LED_SCANNING __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_SCANNING_LED)

#define UI_OUT_LED_USER_LED1 __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_USER_LED1)
#define UI_OUT_LED_USER_LED2 __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_USER_LED2)
#define UI_OUT_LED_USER_LED3 __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_USER_LED3)
#define UI_OUT_LED_USER_LED4 __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_USER_LED4)

#define UI_OUT_LED_ALERT __UI_OUT_LED_ASSIGN(CONFIG_UI_OUT_ALERT_LED)
