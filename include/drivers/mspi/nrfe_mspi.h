...
#define NRFE_MSPI_DQ4_PIN_NUMBER 5
#define NRFE_MSPI_DQ5_PIN_NUMBER 6
#define NRFE_MSPI_DQ6_PIN_NUMBER 7
#define NRFE_MSPI_DQ7_PIN_NUMBER 8
#define NRFE_MSPI_CS0_PIN_NUMBER 9
#define NRFE_MSPI_PINS_MAX 10
