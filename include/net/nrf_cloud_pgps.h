...
enum nrf_cloud_pgps_event_type {
	 ...
	 *  The event is intended to be used when @option{CONFIG_NRF_CLOUD_PGPS_TRANSPORT_MQTT}
	 *  is disabled to let the application decide when and how to use
	 *  the request information.
	 *  This event type is not received if @option{CONFIG_NRF_CLOUD_PGPS_TRANSPORT_MQTT}
	 *  is enabled.
	 */
	PGPS_EVT_REQUEST,
};
