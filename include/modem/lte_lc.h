...
enum lte_lc_evt_type {
	 ...
	 * separately.
	 *
	 * The associated payload is the @c lte_lc_evt.time member of type
	 * @c uint64_t in the event.
	 */
	 ...
	 * The @c time parameter indicates the time until modem exits sleep.
	 */
	 ...
	 * The associated payload is the @c lte_lc_evt.modem_sleep member of type
	 * @ref lte_lc_modem_sleep in the event.
	 * The @c time parameter indicates the duration of the sleep.
	 */
