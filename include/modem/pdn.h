 ...
 *
 * @deprecated Use lte_lc_pdn_ctx_activate().
 *
 * @param cid The PDP context ID.
 ...
 *
 * @deprecated Use lte_lc_pdn_ctx_deactivate().
 *
 * @param cid The PDP context ID.
 *
 * @return int Zero on success or a negative errno otherwise.
 ...
 *
 * @deprecated Use lte_lc_pdn_ctx_connection_id_get().
 *
 * @param cid The PDP context ID.
 *
 ...
 *
 * @deprecated Use lte_lc_pdn_ctx_dynamic_info_get().
 *
 ...
 *
 * @deprecated Use lte_lc_pdn_default_apn_get().
 *
