...
/**
 * @file
 * @defgroup nfc_t4t_isodep NFC Type 4 Tag isodep API
 * @{
...
#define NFC_T4T_ISODEP_HIST_MAX_LEN 0x12
...
struct nfc_t4t_isodep_cb {
	 ...
	 *
	 * The valid RATS response from tag was received.
	 */
	void (*selected)(const struct nfc_t4t_isodep_tag *t4t_tag);

	/**@brief ISO-DEP data send callback.
	 *
	 * After calling this callback, ISO-DEP Protocol data
	 ...
	 */
	void (*data_send)(u8_t *data, size_t data_len, u32_t ftd);
