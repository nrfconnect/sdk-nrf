...
/**
 * @defgroup nfc_t4t_apdu_select Parameters used when selecting
...
enum nfc_t4t_apdu_comm_ins {
	...
	NFC_T4T_APDU_COMM_SELECT_INS = 0xA4,

	/** Code used for selecting EF or NDEF application. */
	NFC_T4T_APDU_COM_READ_INS   = 0xB0,

	/** Code used for selecting EF or NDEF application. */
	NFC_T4T_APDU_COM_UPDATE_INS = 0xD6
};
...
/** @brief Function for clearing C-APDU descriptor and restoring
 *         its default values.
 *
...
/** @brief Function for clearing R-APDU descriptor and restoring
 *         its default values.
 *
