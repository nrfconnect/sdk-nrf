...
/**
 * @brief Creates a continuous aarray in the locations in the net_buf of given in locations, from a
 ...
 * @retval EPERM    If any sizes or location is out of range.
 * @retval ENXIO    On NULL pointer.
 * @retval EINVAL   If the _finite_po sor locations are out of range.
 */
