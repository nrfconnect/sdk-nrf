...
#if defined(CONFIG_PARTITION_MANAGER_ENABLED) || !defined(CONFIG_USE_DT_CODE_PARTITION)
...
#else /* defined(CONFIG_PARTITION_MANAGER_ENABLED) || !defined(CONFIG_USE_DT_CODE_PARTITION) */
...
#endif /* defined(CONFIG_PARTITION_MANAGER_ENABLED) || !defined(CONFIG_USE_DT_CODE_PARTITION) */
