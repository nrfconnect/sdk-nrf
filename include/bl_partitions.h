...
#if defined(CONFIG_SECURE_BOOT_STATIC_DTS)
...
#if defined(CONFIG_NCS_MCUBOOT_IN_BUILD)
#define NSIB_S0_SIZE DT_REG_SIZE(DT_NODELABEL(boot_partition))
#define NSIB_S1_SIZE DT_REG_SIZE(DT_NODELABEL(boot_partition_slot1))
#else
#define NSIB_S0_SIZE DT_REG_SIZE(DT_NODELABEL(slot0_partition))
#define NSIB_S1_SIZE DT_REG_SIZE(DT_NODELABEL(slot1_partition))
#endif

#else /* defined(CONFIG_SECURE_BOOT_STATIC_DTS) */
...
#endif /* defined(CONFIG_SECURE_BOOT_STATIC_DTS) */
