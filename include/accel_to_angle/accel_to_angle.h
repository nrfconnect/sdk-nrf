 ...
 * is needed.
 *
 * The filter instance shall be allocated by the user.
 * The filter instance shall be accessible during the whole time the library is used.
 ...
 * stored in the @ref accel_to_angle_ctx context.
 *
