...
int mpsl_fem_utils_gpiote_pin_init(mpsl_fem_gpiote_pin_config_t *gpiote_pin)
{
	...
	nrfx_gppi_channel_endpoints_setup(gppi_ch,
		...
		nrf_gpiote_task_address_get(gpiote_pin->p_gpiote, nrf_gpiote_clr_task_get(gpiote_pin->gpiote_ch_id)));
	...
	nrfx_gppi_channel_endpoints_setup(gppi_ch,
			nrfx_ppib_receive_event_address_get(&ppib11_21.right, ppib_ch),
			nrf_gpiote_task_address_get(gpiote_pin->p_gpiote, nrf_gpiote_set_task_get(gpiote_pin->gpiote_ch_id)));
