...
static int mpsl_radio_pin_debug_init(void)
{
	...
	/* GPIOTE channel allocation is not available for GPIOTE0. Simply use channel 0 and 1 */
	uint8_t radio_ready_radio_disabled_gpiote_channel = 0;
	uint8_t radio_address_radio_end_gpiote_channel = 1;
