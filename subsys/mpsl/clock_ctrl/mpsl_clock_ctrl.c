...
#include <zephyr/logging/log.h>
	...
	!IS_ENABLED(CONFIG_HAS_NORDIC_MULTI_OPTION_CLOCKS)
...
#elif defined(CONFIG_CLOCK_CONTROL_NRF_COMMON) && IS_ENABLED(CONFIG_HAS_NORDIC_MULTI_OPTION_CLOCKS)
...
static void m_lfclk_calibration_start(void)
{
	/* This function is not supported when CONFIG_CLOCK_CONTROL_NRF_COMMON is set.
...
static bool m_lfclk_calibration_is_enabled(void)
{
	/* This function should not be called from MPSL if CONFIG_CLOCK_CONTROL_NRF_COMMON is set */
	__ASSERT_NO_MSG(false);
	return false;
}
...
#if defined(CONFIG_CLOCK_CONTROL_NRF_COMMON) && IS_ENABLED(CONFIG_HAS_NORDIC_MULTI_OPTION_CLOCKS)
...
#endif /* CONFIG_CLOCK_CONTROL_NRF_COMMON && IS_ENABLED(CONFIG_HAS_NORDIC_MULTI_OPTION_CLOCKS) */
