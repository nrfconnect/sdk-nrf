...
struct dult_user_slot {
	...
	const void *mem_refs[MEM_REF_COUNT];
};
...
void dult_user_slot_foreach(void (*cb)(const struct dult_user *user, const void *user_data),
...
int dult_user_slot_mem_ref_get(const struct dult_user *user, size_t id, const void **ref)
{
	struct dult_user_slot *slot = slot_find(user);
...
int dult_user_slot_mem_ref_set(const struct dult_user *user, size_t id, const void *ref)
{
	struct dult_user_slot *slot = slot_find(user);
