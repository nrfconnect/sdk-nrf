 ...
 */
static void claimed_notify_cb(const struct dult_user *user, const void *user_data)
{
 ...
 */
static void released_notify_cb(const struct dult_user *user, const void *user_data)
{
				...
				const struct dult_multi_user_cb *cb)
{
	...
	return dult_user_slot_mem_ref_set(user, multi_user_cb_id, cb);
}
