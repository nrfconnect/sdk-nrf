...
/* Some short operations must be done in very short time frames, so we need to disable all
 * interrupts to avoid some timing issues related to peripherals.
 */
#define ENABLE_ALL_IRQS __enable_irq
#define DISABLE_ALL_IRQS __disable_irq
