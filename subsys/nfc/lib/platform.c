...
#if IS_ENABLED(CONFIG_CLOCK_CONTROL_NRF) || IS_ENABLED(CONFIG_CLOCK_CONTROL_NRFX_COMMON)
...
#elif IS_ENABLED(CONFIG_CLOCK_CONTROL_NRF_COMMON) || defined(CONFIG_CLOCK_CONTROL_NRFX_HFCLK) || \
