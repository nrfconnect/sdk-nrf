  ...
  if(SB_CONFIG_DFU_MULTI_IMAGE_PACKAGE_NET)
    ...
    if(SB_CONFIG_SECURE_BOOT_NETCORE)
      if(SB_CONFIG_BOOTLOADER_MCUBOOT)
        list(APPEND dfu_multi_image_paths "${CMAKE_BINARY_DIR}/signed_by_mcuboot_and_b0_${SB_CONFIG_NETCORE_IMAGE_NAME}.bin")
        list(APPEND dfu_multi_image_targets ${SB_CONFIG_NETCORE_IMAGE_NAME}_extra_byproducts ${SB_CONFIG_NETCORE_IMAGE_NAME}_signed_kernel_hex_target ${SB_CONFIG_NETCORE_IMAGE_NAME}_signed_packaged_target)
      else()
        list(APPEND dfu_multi_image_paths "${CMAKE_BINARY_DIR}/signed_by_b0_${SB_CONFIG_NETCORE_IMAGE_NAME}.bin")
        list(APPEND dfu_multi_image_targets ${SB_CONFIG_NETCORE_IMAGE_NAME}_extra_byproducts ${SB_CONFIG_NETCORE_IMAGE_NAME}_signed_kernel_hex_target)
      endif()
    else()
      if(SB_CONFIG_BOOTLOADER_MCUBOOT)
        sysbuild_get(net_image_dir IMAGE ${SB_CONFIG_NETCORE_IMAGE_NAME} VAR APPLICATION_BINARY_DIR CACHE)
        sysbuild_get(net_kernel_name IMAGE ${SB_CONFIG_NETCORE_IMAGE_NAME} VAR CONFIG_KERNEL_BIN_NAME KCONFIG)
        ...
        list(APPEND dfu_multi_image_targets ${SB_CONFIG_NETCORE_IMAGE_NAME}_extra_byproducts ${dfu_multi_image_paths})
      else()
