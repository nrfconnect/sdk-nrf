...
static void bt_conn_remote_update_ref_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	int8_t count;
...
static void bt_conn_foreach_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int type;
...
static void bt_conn_lookup_addr_le_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
...
static void bt_conn_get_dst_out_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	bool result;
	const struct bt_conn *conn;
...
static void bt_conn_get_info_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int result;
	const struct bt_conn *conn;
...
static void bt_conn_get_remote_info_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int result;
	struct bt_conn *conn;
	size_t buffer_size_max = 5;
...
static void bt_conn_le_param_update_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
...
static void bt_conn_le_data_len_update_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
...
static void bt_conn_le_phy_update_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
...
static void bt_conn_disconnect_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	uint8_t reason;
	int result;
...
static void bt_conn_le_create_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int result;
	bt_addr_le_t peer_data;
	const bt_addr_le_t *peer;
...
static void bt_conn_le_create_auto_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn_le_create_param create_param;
	struct bt_le_conn_param conn_param;
	int result;
...
static void bt_conn_create_auto_stop_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int result;
...
#if !defined(CONFIG_BT_FILTER_ACCEPT_LIST)
static void bt_le_set_auto_conn_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
...
static void bt_conn_set_security_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	bt_security_t sec;
	int result;
...
static void bt_conn_get_security_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
...
static void bt_conn_enc_key_size_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	uint8_t result;
...
static void bt_conn_cb_register_on_remote_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
						      void *handler_data)
{
	nrf_rpc_cbor_decoding_done(ctx);
...
#if defined(CONFIG_BT_SMP)
static void bt_set_bondable_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	bool enable;
...
static void bt_set_oob_data_flag_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	bool enable;
...
static void bt_le_oob_set_legacy_tk_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	const uint8_t *tk;
	int result;
...
static void bt_le_oob_set_sc_data_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
...
static void bt_le_oob_get_sc_data_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	int result;
	struct bt_conn *conn;
	size_t buffer_size_max = 5;
...
static void bt_passkey_set_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
...
static void bt_rpc_auth_cb_pairing_accept_rpc_rsp(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
...
static void bt_conn_auth_cb_register_on_remote_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
							   void *handler_data)
{
	uint16_t flags;
	int result;
...
static void bt_conn_auth_info_cb_register_on_remote_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
								void *handler_data)
{
	uint16_t flags;
	int result;
...
static void bt_conn_auth_info_cb_unregister_on_remote_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
								  void *handler_data)
{
	int result;
...
static void bt_conn_auth_passkey_entry_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	unsigned int passkey;
	int result;
...
static void bt_conn_auth_cancel_rpc_handler(struct nrf_rpc_cbor_ctx *ctx, void *handler_data)
{
	struct bt_conn *conn;
	int result;
...
static void bt_conn_auth_passkey_confirm_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
						     void *handler_data)
{
	struct bt_conn *conn;
	int result;
...
static void bt_conn_auth_pairing_confirm_rpc_handler(struct nrf_rpc_cbor_ctx *ctx,
						     void *handler_data)
{
	struct bt_conn *conn;
	int result;
