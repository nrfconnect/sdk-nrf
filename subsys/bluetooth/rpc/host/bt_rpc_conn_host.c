...
#if defined(CONFIG_BT_SMP) || defined(CONFIG_BT_BREDR) || defined(NRF_RPC_GENERATOR)
...
#endif /* defined(CONFIG_BT_SMP) || defined(CONFIG_BT_BREDR) || defined(NRF_RPC_GENERATOR) */
