...
#define BT_GATT_PRIMARY_SERVICE(_service)				\
	BT_GATT_ATTRIBUTE(BT_UUID_GATT_PRIMARY, BT_GATT_PERM_READ,	\
			 (bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_SERVICE, NULL, _service)
...
#define BT_GATT_INCLUDE_SERVICE(_service_incl)				\
	/* TODO: Send this attr and resolve its index later if it is in \
	dynamically registered servise*/ \
	BT_GATT_INCLUDE_SERVICE_is_not_implemented_in_BT_RPC
...
#define BT_GATT_CHARACTERISTIC(_uuid, _props, _perm, _read, _write, _value)  \
	BT_GATT_ATTRIBUTE(BT_UUID_GATT_CHRC, BT_GATT_PERM_READ,              \
			  (bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CHRC, NULL,               \
...
#define BT_GATT_CCC_MANAGED(_ccc, _perm)				\
	...
	(bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CCC, \
	BT_RPC_GATT_SPECIAL_FLAGS(CONFIF_BT_RPC_GATT_CCC_MANAGED_READ_SYNC, CONFIF_BT_RPC_GATT_CCC_MANAGED_WRITE_SYNC), \
	_ccc)
...
#define BT_GATT_CCC(_changed, _perm)				\
	BT_GATT_ATTRIBUTE(BT_UUID_GATT_CCC, _perm,			\
	(bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CCC, \
	BT_RPC_GATT_SPECIAL_FLAGS(CONFIF_BT_RPC_GATT_CCC_READ_SYNC, CONFIF_BT_RPC_GATT_CCC_WRITE_SYNC), \
	((struct _bt_gatt_ccc[]) {BT_GATT_CCC_INITIALIZER(_changed, NULL, NULL)}))
...
#define BT_GATT_CEP(_value)						\
	BT_GATT_DESCRIPTOR(BT_UUID_GATT_CEP, BT_GATT_PERM_READ,		\
		(bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CEP, \
		BT_RPC_GATT_SPECIAL_FLAGS(CONFIF_BT_RPC_GATT_CEP_READ_SYNC, CONFIF_BT_RPC_GATT_CEP_WRITE_SYNC), \
		(void *)_value)
...
#define BT_GATT_CUD(_value, _perm)					\
	BT_GATT_DESCRIPTOR(BT_UUID_GATT_CUD, _perm, \
		(bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CUD, \
		BT_RPC_GATT_SPECIAL_FLAGS(CONFIF_BT_RPC_GATT_CUD_READ_SYNC, CONFIF_BT_RPC_GATT_CUD_WRITE_SYNC), \
		(void *)_value)
...
#define BT_GATT_CPF(_value)						\
	BT_GATT_DESCRIPTOR(BT_UUID_GATT_CPF, BT_GATT_PERM_READ,		\
		(bt_gatt_attr_read_cb_t)BT_RPC_GATT_ATTR_SPECIAL_CPF, \
		BT_RPC_GATT_SPECIAL_FLAGS(CONFIF_BT_RPC_GATT_CPF_READ_SYNC, CONFIF_BT_RPC_GATT_CPF_WRITE_SYNC), \
		(void *)_value)
