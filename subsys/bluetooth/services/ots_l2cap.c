 ...
 */
#define BLE_GATT_OTS_L2CAP_PSM	0x0025
...
{
	chan->rx.mtu = CONFIG_BT_GATT_OTS_L2CAP_CHAN_RX_MTU;
...
static struct bt_l2cap_server l2cap_server = {
	.psm = BLE_GATT_OTS_L2CAP_PSM,
	.accept	= l2cap_accept,
};

static int bt_gatt_ots_l2cap_init(struct device *arg)
{
	int err;
