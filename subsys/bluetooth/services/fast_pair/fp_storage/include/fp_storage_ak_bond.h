 ...
 *  finalized using the @ref fp_storage_ak_bond_conn_finalize API.
 *
 ...
 *  be earlier created using the @ref fp_storage_ak_bond_conn_create API.
 *
 ...
 *  earlier using the @ref fp_storage_ak_bond_conn_create API.
 *
 * @param[in] conn_ctx Connection context associated with the Bluetooth bond.
 */
 ...
 *
 *  The association should be earlier created using the @ref fp_storage_ak_bond_conn_create API.
 *
 * @param[in] conn_ctx Connection context associated with the Bluetooth bond.
 * @param[in] addr The Bluetooth address of the bond.
 */
