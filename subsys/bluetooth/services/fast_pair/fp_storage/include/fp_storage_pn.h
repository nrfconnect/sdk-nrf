 ...
 *
 * @param[in] pn_to_save Personalized Name to be saved. Length of Personalized Name string can not
 *			 be greater than @ref CONFIG_BT_FAST_PAIR_STORAGE_EXT_PN_LEN_MAX.
 *
