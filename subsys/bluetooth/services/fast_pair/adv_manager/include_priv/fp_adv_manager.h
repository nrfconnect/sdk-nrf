...
#ifndef _FP_ADV_MANAGER_H_
#define _FP_ADV_MANAGER_H_
...
/**
 * @defgroup fp_adv_manager Fast Pair Advertising Manager
 * @brief Internal API for Fast Pair Advertising Manager
 *
 * @{
 */
 ...
 *
 *  This function can only be called before enabling Fast Pair with the
