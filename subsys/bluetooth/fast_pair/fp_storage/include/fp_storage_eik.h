...
/**
 * @defgroup fp_storage_eik Fast Pair Ephemeral Identity Key (EIK) storage for the FHN extension
 * @brief Internal API of Fast Pair Ephemeral Identity Key (EIK) storage for the FHN extension
 *
