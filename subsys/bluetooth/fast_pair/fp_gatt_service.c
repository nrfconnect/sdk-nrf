...
#if defined(CONFIG_BT_FAST_PAIR_FHN_BEACON_ACTIONS)
#include "fp_fhn_beacon_actions.h"
#endif
...
#if defined(CONFIG_BT_FAST_PAIR_FHN_BEACON_ACTIONS)
	FP_FHN_BEACON_ACTIONS_CHARACTERISTIC,
#endif /* CONFIG_BT_FAST_PAIR_FHN_BEACON_ACTIONS */
);
