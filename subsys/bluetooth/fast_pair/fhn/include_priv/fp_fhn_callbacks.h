...
#ifndef _FP_FHN_CALLBACKS_H_
#define _FP_FHN_CALLBACKS_H_
...
/**
 * @defgroup fp_fhn_callbacks Fast Pair FHN Callbacks
 * @brief Internal API for Fast Pair FHN Callbacks
 *
 * @{
 */
 ...
 *  of the FHN module (see @ref bt_fast_pair_is_ready function). This API for
