...
psa_status_t ssf_psa_get_key_attributes(mbedtls_svc_key_id_t key, psa_key_attributes_t *attributes)
{
	...
	sys_cache_data_flush_and_invd_range((void *)attributes, sizeof(psa_key_attributes_t));
			      ...
			      mbedtls_svc_key_id_t *target_key)
{
	...
	sys_cache_data_flush_and_invd_range((void *)attributes, sizeof(const psa_key_attributes_t));
	sys_cache_data_flush_and_invd_range((void *)target_key, sizeof(mbedtls_svc_key_id_t));
				...
				size_t data_length, mbedtls_svc_key_id_t *key)
{
	...
	sys_cache_data_flush_and_invd_range((void *)key, sizeof(mbedtls_svc_key_id_t));
				...
				size_t *data_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)data_length, sizeof(size_t));
				  ...
				  uint8_t *hash, size_t hash_size, size_t *hash_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)hash_length, sizeof(size_t));
...
psa_status_t ssf_psa_hash_setup(mbedtls_psa_client_handle_t *p_handle, psa_algorithm_t alg)
{
	...
	sys_cache_data_flush_and_invd_range((void *)p_handle, sizeof(mbedtls_psa_client_handle_t));
				 ...
				 size_t mac_size, size_t *mac_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)mac_length, sizeof(size_t));
				    ...
				    size_t output_size, size_t *output_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)output_length, sizeof(size_t));
					...
					size_t iv_size, size_t *iv_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)iv_length, sizeof(size_t));
				  ...
				  size_t *ciphertext_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)ciphertext_length, sizeof(size_t));
				  ...
				  size_t *plaintext_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)plaintext_length, sizeof(size_t));
					 ...
					 size_t nonce_size, size_t *nonce_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)nonce_length, sizeof(size_t));
				 ...
				 size_t tag_size, size_t *tag_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)tag_length, sizeof(size_t));
				  ...
				  size_t signature_size, size_t *signature_length)
{
	...
	sys_cache_data_flush_and_invd_range((void *)signature_length, sizeof(size_t));
						 ...
						 size_t *capacity)
{
	...
	sys_cache_data_flush_and_invd_range((void *)capacity, sizeof(size_t));
				...
				const psa_pake_cipher_suite_t *cipher_suite)
{
	...
	sys_cache_data_flush_and_invd_range((void *)p_handle, sizeof(mbedtls_psa_client_handle_t));
	sys_cache_data_flush_and_invd_range((void *)cipher_suite,
					    sizeof(const psa_pake_cipher_suite_t));
