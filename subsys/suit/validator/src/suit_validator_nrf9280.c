...
static suit_plat_err_t validate_candidate_location_common(const uint8_t *address, size_t size)
{
...
suit_plat_err_t suit_validator_validate_cache_pool_location(const uint8_t *address, size_t size)
{
