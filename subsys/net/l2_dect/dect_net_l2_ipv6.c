					...
					uint32_t peer_long_rd_id)
{
	...
	if (!IS_ENABLED(CONFIG_NET_L2_DECT_IPV6_IFACE_UNICAST_INSTALL)) {
...
#if !defined(CONFIG_NET_L2_DECT_IPV6_IFACE_UNICAST_INSTALL)
...
#endif /* !CONFIG_NET_L2_DECT_IPV6_IFACE_UNICAST_INSTALL */
