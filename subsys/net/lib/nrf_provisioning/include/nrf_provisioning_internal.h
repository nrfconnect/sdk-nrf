 ...
 *	  connectivity state.
 *
 * This function notifies the provided provisioning event via the provided callback and waits
 ...
 * between offline and online connectivity states in order to perform provisioning operations.
 *
 ...
 * @param event The provisioning event to notify. Must be either NRF_PROVISIONING_EVENT_NEED_LTE_DEACTIVATED
 *              or NRF_PROVISIONING_EVENT_NEED_LTE_ACTIVATED.
