...
static int client_connect(struct mqtt_helper_conn_params *conn_params)
{
	...
	// Generally it is not safe to send a password unless protected by TLS, 
	// but there may be situations where a private network (or private access point name) is used
