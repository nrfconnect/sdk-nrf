...
/* CoAP extended options: When multiple options are used,
 * for simplicity, always put COAP_OPTION_ACCEPT first
 */
#define ACPT_IDX 0 /* COAP_OPTION_ACCEPT */
#define PRXY_IDX 1 /* COAP_OPTION_PROXY_URI */
