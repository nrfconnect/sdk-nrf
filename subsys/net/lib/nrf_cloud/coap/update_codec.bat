...
zcbor code -c cddl\nrf_cloud_coap_pgnss.cddl       --default-max-qty 10 -e -t pgnss_req --oc generated\src\pgnss_encode.c --oh generated\include\pgnss_encode.h --oht generated\include\pgnss_encode_types.h --file-header %HDR%
zcbor code -c cddl\nrf_cloud_coap_pgnss.cddl       --default-max-qty 10 -d -t pgnss_resp --oc generated\src\pgnss_decode.c --oh generated\include\pgnss_decode.h --oht generated\include\pgnss_decode_types.h --file-header %HDR%
