...
zcbor code -c cddl\nrf_cloud_coap_agnss.cddl       --default-max-qty 10 -e -t agnss_req --oc src\agnss_encode.c --oh include\agnss_encode.h --oht include\agnss_encode_types.h --file-header %HDR%
