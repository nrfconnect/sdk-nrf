...
#define PGPS_PREDICTION_PAD                                                                        \
	(PGPS_PREDICTION_STORAGE_SIZE - sizeof(struct nrf_cloud_pgps_prediction))
...
#define PGPS_PREDICTION_DL_SIZE                                                                    \
	(sizeof(struct nrf_cloud_pgps_prediction) - PGPS_SCHEMA_SIZE - PGPS_SENTINEL_SIZE)
