...
#define TOPIC_VAL_RCV_PGNSS     (NRF_CLOUD_JSON_VAL_TOPIC_PGNSS NRF_CLOUD_JSON_VAL_TOPIC_RCV)
...
enum nrf_cloud_rcv_topic nrf_cloud_dc_rx_topic_decode(const char *const topic)
{
	...
	} else if (strstr(topic, TOPIC_VAL_RCV_PGNSS)) {
		return NRF_CLOUD_RCV_TOPIC_PGNSS;
