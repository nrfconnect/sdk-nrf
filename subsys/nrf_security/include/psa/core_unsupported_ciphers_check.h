...
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_128) && !defined(CONFIG_PSA_ACCEL_AES128_CFB)
#error "No crypto implementation for 128 bit AES-CFB"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_192) && !defined(CONFIG_PSA_ACCEL_AES192_CFB)
#error "No crypto implementation for 192 bit AES-CFB"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_256) && !defined(CONFIG_PSA_ACCEL_AES256_CFB)
...
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_128) && !defined(CONFIG_PSA_ACCEL_AES128_OFB)
#error "No crypto implementation for 128 bit AES-OFB"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_192) && !defined(CONFIG_PSA_ACCEL_AES192_OFB)
#error "No crypto implementation for 192 bit AES-OFB"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_256) && !defined(CONFIG_PSA_ACCEL_AES256_OFB)
...
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_128) && !defined(CONFIG_PSA_ACCEL_AES128_XTS)
#error "No crypto implementation for 128 bit AES-XTS"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_192) && !defined(CONFIG_PSA_ACCEL_AES192_XTS)
#error "No crypto implementation for 192 bit AES-XTS"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_256) && !defined(CONFIG_PSA_ACCEL_AES256_XTS)
...
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_128) && !defined(CONFIG_PSA_ACCEL_AES128_CBC_MAC)
#error "No crypto implementation for 128 bit AES-CBC-MAC"
#endif
#if defined(CONFIG_PSA_WANT_AES_KEY_SIZE_192) && !defined(CONFIG_PSA_ACCEL_AES192_CBC_MAC)
...
#error "No crypto implementation for X448"
	...
	!defined(CONFIG_PSA_ACCEL_ECDSA_ED448)
...
#if defined(CONFIG_PSA_WANT_ECC_SECP_K1_192) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K192)
#error "No crypto implementation for secp-k1-192"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECP_K1_224) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K224)
#error "No crypto implementation for secp-k1-224"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECP_K1_256) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K256)
#error "No crypto implementation for secp-k1-256"
#endif

#if defined(CONFIG_PSA_WANT_ECC_SECP_R1_192) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_P192)
#error "No crypto implementation for secp-r1-192"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECP_R1_521) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R521)
#error "No crypto implementation for secp-r1-521"
#endif

#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_163) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K163)
#error "No crypto implementation for sect-k1-163"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_233) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K233)
#error "No crypto implementation for sect-k1-233"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_239) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K239)
#error "No crypto implementation for sect-k1-239"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_283) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K283)
#error "No crypto implementation for sect-k1-283"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_409) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K409)
#error "No crypto implementation for sect-k1-409"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_K1_571) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_K571)
#error "No crypto implementation for sect-k1-571"
#endif

#if defined(CONFIG_PSA_WANT_ECC_SECT_R1_163) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R163)
#error "No crypto implementation for sect-r1-163"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_R1_233) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R233)
#error "No crypto implementation for sect-r1-233"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_R1_283) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R283)
#error "No crypto implementation for sect-r1-283"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_R1_409) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R409)
#error "No crypto implementation for sect-r1-409"
#endif
#if defined(CONFIG_PSA_WANT_ECC_SECT_R1_571) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_R571)
#error "No crypto implementation for sect-r1-571"
#endif

#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_160) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB160)
#error "No crypto implementation for brainpoolP160r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_192) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB192)
#error "No crypto implementation for brainpoolP192r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_224) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB224)
#error "No crypto implementation for brainpoolP224r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_256) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB256)
#error "No crypto implementation for brainpoolP256r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_320) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB320)
#error "No crypto implementation for brainpoolP320r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_384) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB384)
#error "No crypto implementation for brainpoolP384r1"
#endif
#if defined(CONFIG_PSA_WANT_ECC_BRAINPOOL_P_R1_512) && !defined(CONFIG_PSA_ACCEL_KEY_PAIR_PB512)
