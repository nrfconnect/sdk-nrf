...
#ifdef PSA_NEED_OBERON_KEY_PAIR_P224
#include "ocrypto_ecdh_p224.h"
#endif /* PSA_NEED_OBERON_KEY_PAIR_P224 */
#ifdef PSA_NEED_OBERON_KEY_PAIR_P256
#include "ocrypto_ecdh_p256.h"
#endif /* PSA_NEED_OBERON_KEY_PAIR_P256 */
#ifdef PSA_NEED_OBERON_KEY_PAIR_P384
#include "ocrypto_ecdh_p384.h"
#endif /* PSA_NEED_OBERON_KEY_PAIR_P384 */
#ifdef PSA_NEED_OBERON_KEY_PAIR_X25519
#include "ocrypto_curve25519.h"
#endif /* PSA_NEED_OBERON_KEY_PAIR_X25519 */
#ifdef PSA_NEED_OBERON_KEY_PAIR_ED25519
    ...
    uint8_t *data, size_t data_size, size_t *data_length)
{
    ...
    switch (type) {
#ifdef PSA_NEED_OBERON_KEY_PAIR_SECP
    case PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_SECP_R1):
        ...
        *data_length = key_length * 2 + 1;
        ...
        break;
#endif /* PSA_NEED_OBERON_KEY_PAIR_SECP */
#ifdef PSA_NEED_OBERON_KEY_PAIR_X25519
    ...
    case PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_TWISTED_EDWARDS):
        ...
        *data_length = key_length;
        ...
        break;
#endif /* PSA_NEED_OBERON_KEY_PAIR_ED25519 */
    default:
        (void)res;
        return PSA_ERROR_NOT_SUPPORTED;
    }
    ...
    size_t *key_bits)
{
...
#ifdef PSA_NEED_OBERON_KEY_PAIR_P521
    ...
    case PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_SECP_R1):
        ...
        break;
#endif /* PSA_NEED_OBERON_KEY_PAIR_SECP */
#ifdef PSA_NEED_OBERON_KEY_PAIR_25519
#ifdef PSA_NEED_OBERON_KEY_PAIR_X25519
    case PSA_KEY_TYPE_ECC_KEY_PAIR(PSA_ECC_FAMILY_MONTGOMERY):
    ...
    case PSA_KEY_TYPE_ECC_PUBLIC_KEY(PSA_ECC_FAMILY_TWISTED_EDWARDS):
        ...
        break;
#endif /* PSA_NEED_OBERON_KEY_PAIR_25519 */
    default:
        (void)res;
        return PSA_ERROR_NOT_SUPPORTED;
    }
