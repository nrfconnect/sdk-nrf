...
# TF-M defines this to 1 in build system
...
kconfig_check_and_set_base(MBEDTLS_ENABLE_HEAP)
kconfig_check_and_set_base(MBEDTLS_HEAP_SIZE)
kconfig_check_and_set_base(MBEDTLS_MEMORY_DEBUG)
kconfig_check_and_set_base(MBEDTLS_MEMORY_BACKTRACE)
...
kconfig_check_and_set_base(MBEDTLS_VERSION_FEATURES)
...
# Legacy crypto configurations for _ALT defines
...
# Legacy configurations for crypto APIs
if(NOT CONFIG_MBEDTLS_PSA_CRYPTO_SPM)
  ...
  # Legacy configurations for optimizations
  kconfig_check_and_set_base(MBEDTLS_AES_FEWER_TABLES)
  kconfig_check_and_set_base(MBEDTLS_AES_ROM_TABLES)
  kconfig_check_and_set_base(MBEDTLS_ECP_NIST_OPTIM)
  kconfig_check_and_set_base_int(MBEDTLS_ECP_WINDOW_SIZE)
  kconfig_check_and_set_base_int(MBEDTLS_MPI_WINDOW_SIZE)
  kconfig_check_and_set_base_int(MBEDTLS_MPI_MAX_SIZE)
  kconfig_check_and_set_base(MBEDTLS_SHA256_SMALLER)
  kconfig_check_and_set_base(MBEDTLS_SHA512_SMALLER)
endif()
...
kconfig_check_and_set_base(MBEDTLS_BIGNUM_C)
kconfig_check_and_set_base(MBEDTLS_ERROR_C)
kconfig_check_and_set_base(MBEDTLS_NIST_KW_C)
kconfig_check_and_set_base(MBEDTLS_OID_C)
kconfig_check_and_set_base(MBEDTLS_PKCS5_C)
kconfig_check_and_set_base(MBEDTLS_PKCS12_C)
kconfig_check_and_set_base(MBEDTLS_PEM_PARSE_C)
kconfig_check_and_set_base(MBEDTLS_PEM_WRITE_C)

# Legacy configurations for Wrapper APIs
...
if (NOT CONFIG_MBEDTLS_PSA_CRYPTO_SPM)
  ...
  kconfig_check_and_set_base(MBEDTLS_DEBUG_LEVEL_C)
...
if(CONFIG_GENERATE_MBEDTLS_CFG_FILE)
  ...
  # Add the generated generated incldue path
