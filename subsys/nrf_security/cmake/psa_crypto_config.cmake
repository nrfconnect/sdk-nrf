...
kconfig_check_and_set_base_to_one(MBEDTLS_PLATFORM_NO_STD_FUNCTIONS)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_KEM_1024)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_KEM_512)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_KEM_768)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_KEM)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_DSA_44)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_DSA_65)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_DSA_87)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_DETERMINISTIC_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_HASH_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_DETERMINISTIC_HASH_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_ASYMMETRIC_SIGNATURE_ANY_ML_DSA)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_AES_MMO_ZIGBEE)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_HASH_DRIVER)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_SHAKE128)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_SHAKE256)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_XOF_DRIVER)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_DSA_KEY_PAIR_EXPORT)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_DSA_KEY_PAIR_IMPORT)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_DSA_PUBLIC_KEY)

kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_KEM_KEY_PAIR_EXPORT)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_KEM_KEY_PAIR_IMPORT)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_TYPE_ML_KEM_PUBLIC_KEY)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KMU_KEY_IMPORT)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KMU_KEY_GENERATE)
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KMU_KEY_COPY)
...
kconfig_check_and_set_base_to_one(PSA_NEED_CRACEN_KEY_ENCAPSULATION_DRIVER)
