...
kconfig_check_and_set_base_to_one(MBEDTLS_MEMORY_DEBUG)
...
kconfig_check_and_set_base_to_one(MBEDTLS_DECLARE_PRIVATE_IDENTIFIERS)
kconfig_check_and_set_base_to_one(MBEDTLS_BIGNUM_C)
kconfig_check_and_set_base_to_one(MBEDTLS_ECP_C)
kconfig_check_and_set_base_to_one(MBEDTLS_ECP_NIST_OPTIM)
kconfig_check_and_set_base_to_one(MBEDTLS_HAVE_ASM)
...
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_AES_MMO_ZIGBEE)
...
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_WPA3_SAE_H2E)
...
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_WPA3_SAE)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_PUBLIC_KEY)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_BASIC)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_IMPORT)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_EXPORT)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_GENERATE)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_DSA_KEY_PAIR_DERIVE)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_PUBLIC_KEY)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_KEY_PAIR_BASIC)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_KEY_PAIR_IMPORT)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_KEY_PAIR_EXPORT)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_KEY_PAIR_GENERATE)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ML_KEM_KEY_PAIR_DERIVE)
...
kconfig_check_and_set_base_to_one(PSA_WANT_ML_DSA_KEY_SIZE_44)
kconfig_check_and_set_base_to_one(PSA_WANT_ML_DSA_KEY_SIZE_65)
kconfig_check_and_set_base_to_one(PSA_WANT_ML_DSA_KEY_SIZE_87)
kconfig_check_and_set_base_to_one(PSA_WANT_ML_KEM_KEY_SIZE_512)
kconfig_check_and_set_base_to_one(PSA_WANT_ML_KEM_KEY_SIZE_768)
kconfig_check_and_set_base_to_one(PSA_WANT_ML_KEM_KEY_SIZE_1024)
...
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_WPA3_SAE_FIXED)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_WPA3_SAE_GDH)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_ASCON_AEAD128)
kconfig_check_and_set_base_to_one(PSA_WANT_KEY_TYPE_ASCON)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_DETERMINISTIC_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_DETERMINISTIC_HASH_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_HASH_ML_DSA)
kconfig_check_and_set_base_to_one(PSA_WANT_ALG_ML_KEM)
