...
macro(generate_mbedcrypto_library_configs)
  ...
  if(NOT (CONFIG_MBEDTLS_PSA_CRYPTO_SPM OR CONFIG_PSA_SSF_CRYPTO_CLIENT))
    ...
    kconfig_backup_current_config(CONFIG_MBEDTLS_PLATFORM_NO_STD_FUNCTIONS)
    kconfig_backup_current_config(CONFIG_MBEDTLS_THREADING_C)
    kconfig_backup_current_config(CONFIG_MBEDTLS_THREADING_ALT)
    ...
    if(CONFIG_BUILD_WITH_TFM)
      ...
      # CONFIG_MBEDTLS_PLATFORM_NO_STD_FUNCTIONS must be set for the library build in TF-M
      set(CONFIG_MBEDTLS_PLATFORM_NO_STD_FUNCTIONS True)
      # Disable threading for the PSA interface used in TF-M build (NS and S image)
      set(CONFIG_MBEDTLS_THREADING_C False)
      set(CONFIG_MBEDTLS_THREADING_ALT False)
    ...
    kconfig_restore_backup_config(CONFIG_MBEDTLS_PLATFORM_NO_STD_FUNCTIONS)
    kconfig_restore_backup_config(CONFIG_MBEDTLS_THREADING_C)
    kconfig_restore_backup_config(CONFIG_MBEDTLS_THREADING_ALT)
