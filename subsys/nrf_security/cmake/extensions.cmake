...
macro(kconfig_backup_current_config config)
  if(${config})
    nrf_security_debug("Backup: ${config}: True")
    set(${config}_COPY True})
  else()
    nrf_security_debug("Backup: ${config}: False")
...
macro(kconfig_restore_backup_config config)
  if(${config}_COPY)
    nrf_security_debug("Restore: ${config}: True")
    set(${config} True)
  else()
    nrf_security_debug("Restore: ${config}: False")
    set(${config} False)
  endif()
endmacro()
