 ...
 */
#ifndef NRF_SECURITY_MEM_HELPERS_H__
#define NRF_SECURITY_MEM_HELPERS_H__

/** @file
 * @addtogroup nrf_security_mem_helpers
 * @{
 * @brief Generic constant-time memory utilities.
 *
...
#endif /* NRF_SECURITY_MEM_HELPERS_H__ */
