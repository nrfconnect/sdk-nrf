...
if(BUILD_INSIDE_TFM)
  ...
  # Do not link to the kernel target to avoid a cyclic dependency (kernel ->
  # ... -> nrf_security -> nrf_security_utils -> kernel). Link by path instead
  # so the kernel symbols (k_mutex_*, k_event_*, etc.) are available.
  target_link_libraries(nrf_security_utils
    PRIVATE
