 ...
 * @{
 * @brief Primitive operations and data structures for CRACEN PSA driver.
 *
...
struct cracen_hash_operation_s {
	...
	/* The driver can perform a processing round after getting a multiple of the blocksize.
	 * Therefore we have to know how much data is left to fill up to the next block.
	 */
...
/** Software CCM context for workarounds. */
...
/** ECC signature representation with const pointers. */
