...
/**
 * @defgroup cracen_psa_ikg Identity Key Generation
 * @brief Identity Key Generation (IKG) operations (internal use only)
 */
 ...
 * @brief Primitive operations and data structures
 *
 ...
 * @brief Key ID definitions and constants
 *
 ...
 * @brief Built-in key policy definitions
 *
