 ...
 * @param[out] data_length            Size of the data buffer in bytes.
 * @param[in] key                     Key material of the unwrapped key.
 * @param[out] key_size               Size of the buffer containing the unwrapped key.
