 ...
 * - The curve operation size can be obtained via sx_pk_curve_opsize().
 ...
 *
 * These ECDSA implementation functions perform minimal input validation for performance, with the following limitations:
 ...
 * @param[in] hashalg       Hash algorithm to use for message digesting, given as a sxhashalg struct.
