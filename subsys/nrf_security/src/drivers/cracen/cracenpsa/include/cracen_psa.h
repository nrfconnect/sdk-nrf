 ...
 *
 * @note This is the public driver API. Applications should use the PSA Crypto API
...
/** @brief Sign a hash or digest.
 *
 * @param[in] attributes      Key attributes.
 * @param[in] key_buffer      Key material buffer.
 * @param[in] key_buffer_size Size of the key buffer in bytes.
 * @param[in] alg             Signing algorithm.
 * @param[in] hash            Hash or digest to sign.
...
/** @brief Verify a hash signature.
 *
 * @param[in] attributes        Key attributes.
 * @param[in] key_buffer        Key material buffer.
 * @param[in] key_buffer_size   Size of the key buffer in bytes.
 * @param[in] alg               Verification algorithm.
 * @param[in] hash              Hash or digest that was signed.
 * @param[in] hash_length       Length of the hash in bytes.
 * @param[in] signature         Signature to verify.
 * @param[in] signature_length  Length of the signature in bytes.
 *
...
/** @brief Update a hash operation with input data.
 *
 * @param[in,out] operation   Hash operation context.
 ...
 * @param[in] additional_data_length Length of additional data in bytes.
...
/** @brief Decrypt and verify a message using AEAD.
 *
 * @param[in] attributes            Key attributes.
 * @param[in] key_buffer           Key material buffer.
 * @param[in] key_buffer_size      Size of the key buffer in bytes.
 ...
 *
 * @param[in,out] operation       AEAD operation context.
 * @param[in] ad_length          Length of additional authenticated data in bytes.
 * @param[in] plaintext_length   Length of plaintext in bytes.
 *
 * @retval PSA_SUCCESS         The operation completed successfully.
 * @retval PSA_ERROR_BAD_STATE The operation is not in a valid state.
 */
...
/** @brief Add additional authenticated data to an AEAD operation.
 *
 * @param[in,out] operation   AEAD operation context.
 * @param[in] input          Additional authenticated data.
 * @param[in] input_length   Length of the additional data in bytes.
 *
 * @retval PSA_SUCCESS         The operation completed successfully.
 * @retval PSA_ERROR_BAD_STATE The operation is not in a valid state.
 */
 ...
 * @param[out] key_buffer         Buffer to store the imported key.
 * @param[in] key_buffer_size     Size of the key buffer in bytes.
 * @param[out] key_buffer_length Length of the imported key in bytes.
 ...
 *
 * @param[in] attributes          Key attributes.
 * @param[out] key_buffer         Buffer to store the generated key.
 * @param[in] key_buffer_size     Size of the key buffer in bytes.
 * @param[out] key_buffer_length Length of the generated key in bytes.
 *
 * @retval PSA_SUCCESS              The operation completed successfully.
 ...
 * @param[out] key_buffer         Buffer to store the key.
 * @param[in] key_buffer_size     Size of the key buffer in bytes.
 * @param[out] key_buffer_length Length of the key in bytes.
 *
 * @retval PSA_SUCCESS              The operation completed successfully.
 ...
 * @param[out] target_key_buffer_length Length of the copied key in bytes.
 *
 * @retval PSA_SUCCESS              The operation completed successfully.
 ...
 *
 * @param[in] attributes Key attributes.
 * @param[out] key_size  Size of the key in bytes.
 *
 * @retval PSA_SUCCESS              The operation completed successfully.
 * @retval PSA_ERROR_INVALID_HANDLE The key handle is invalid.
 */
