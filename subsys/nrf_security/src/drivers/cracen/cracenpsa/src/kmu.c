					      ...
					      psa_key_attributes_t *key_attr)
{
...
#ifdef CONFIG_PSA_WANT_ALG_CHACHA20
	...
	case METADATA_ALG_SP800_108_COUNTER_CMAC:
		...
		break;
#endif
#ifdef CONFIG_PSA_WANT_ALG_ALG_CMAC
	case METADATA_ALG_CMAC:
		psa_set_key_type(key_attr, PSA_KEY_TYPE_AES);
		psa_set_key_algorithm(key_attr, PSA_ALG_CMAC);
		break;
#endif
#ifdef CONFIG_PSA_WANT_ALG_ED25519
						...
						kmu_metadata *metadata)
{
	...
	case PSA_ALG_CHACHA20_POLY1305:
		...
		break;
#endif
#ifdef CONFIG_PSA_WANT_ALG_ALG_GCM
	case PSA_ALG_GCM:
