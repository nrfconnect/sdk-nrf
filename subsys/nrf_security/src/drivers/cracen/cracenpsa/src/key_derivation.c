...
#if defined(CONFIG_PSA_NEED_CRACEN_HKDF) || defined(CONFIG_PSA_NEED_CRACEN_PBKDF2_HMAC) ||         \
	defined(CONFIG_PSA_NEED_CRACEN_TLS12_PRF) ||                                               \
	defined(CONFIG_PSA_NEED_CRACEN_TLS12_PSK_TO_MS)
/**
