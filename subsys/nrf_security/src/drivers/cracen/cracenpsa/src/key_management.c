...
static size_t cracen_get_ikg_opaque_size(const psa_key_attributes_t *attributes){
#ifdef CONFIG_PSA_NEED_CRACEN_PLATFORM_KEYS
...
static void cracen_set_ikg_key_buffer(psa_key_attributes_t *attributes, psa_drv_slot_number_t slot_number, uint8_t *key_buffer)
{
