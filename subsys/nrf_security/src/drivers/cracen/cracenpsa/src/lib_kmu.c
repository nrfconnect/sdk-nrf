...
static void mram_sicr_perm_set(bool permission)
{
	if (permission) {
		 ...
		 */
		nrfy_mramc_confignvr_perm_set(true, 3);
	} else {
		...
		nrfy_mramc_confignvr_perm_set(false, 3);
	}
}
#endif
