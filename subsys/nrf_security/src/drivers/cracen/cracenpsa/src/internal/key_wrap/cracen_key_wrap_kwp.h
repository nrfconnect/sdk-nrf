...
#ifndef CRACEN_KEY_WRAP_KWP_H
#define CRACEN_KEY_WRAP_KWP_H
...
/** @brief Perform a key wrap operation using AES-KWP algorithm.
 *
...
/** @brief Perform a key unwrap operation using AES-KWP algorithm.
 *
