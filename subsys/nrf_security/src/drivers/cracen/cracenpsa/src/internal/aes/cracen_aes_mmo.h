 ...
 *
 * There is no setup call: a zeroed context is a context that is ready to use.
 * The PSA core zeroes the driver part of a hash operation before it calls
 * cracen_hash_setup(), so nothing has to be done there either.
 *
