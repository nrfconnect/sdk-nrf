...
int no_si_ed25519_sign(const uint8_t *ed25519, char *signature, const uint8_t *message)
{
	char workmem[160];
	 ...
	 */
	r = sx_ed25519_ptmult((const struct sx_ed25519_dgst *)(workmem + 96), (struct sx_ed25519_pt *)pointr);
	if (r != 0) {
		return r;
	...
	return r;
	/*End ed25519_sign_finish*/

/*end si_sig_create_ed_25510 sign*/


}

int no_si_create_ed25519_verify(const uint8_t *pubkey, const char* message, size_t message_length, const char *signature)
{
