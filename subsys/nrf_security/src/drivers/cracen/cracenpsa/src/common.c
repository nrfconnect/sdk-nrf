...
{
#if CONFIG_PSA_NEED_CRACEN_PLATFORM_KEYS
	return true ? cracen_platform_keys_is_ikg_key(attributes) : false;
#else
...
static psa_status_t cracen_load_ikg_keyref(const psa_key_attributes_t *attributes, const uint8_t *key_buffer,
