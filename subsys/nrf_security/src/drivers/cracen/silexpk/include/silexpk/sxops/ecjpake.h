 ...
 *
 */
static inline int sx_ecjpake_generate_zkp(sx_pk_req *req,
 ...
 *
 */
static inline int sx_ecjpake_verify_zkp(sx_pk_req *req,
 ...
 *
 */
static inline int sx_ecjpake_3pt_add(sx_pk_req *req,
					 const struct sx_pk_ecurve *curve,
 ...
 *
 */
static inline int sx_ecjpake_gen_sess_key(sx_pk_req *req,
					  const struct sx_pk_ecurve *curve,
 ...
 * @return ::SX_ERR_PK_RETRY
 */
static inline int sx_ecjpake_gen_step_2(sx_pk_req *req,
					const struct sx_pk_ecurve *curve,
					const sx_pk_const_affine_point *x4,
