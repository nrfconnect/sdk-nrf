...
static int ed25519_ptmult_run(sx_pk_req *req, const struct sx_ed25519_dgst *r)
{
...
static void ed25519_ptmult_read(sx_pk_req *req, struct sx_ed25519_pt *pt)
{
...
int sx_ed25519_ptmult(sx_pk_req *req, const struct sx_ed25519_dgst *r, struct sx_ed25519_pt *pt)
{
	...
	int status = ed25519_ptmult_run(req, r);
	...
	ed25519_ptmult_read(req, pt);

	return SX_OK;
}

static int ed25519_sign_run(sx_pk_req *req, const struct sx_ed25519_dgst *k,
...
static void ed25519_sign_read(sx_pk_req *req, struct sx_ed25519_v *sig_s)
{
	const uint8_t **outputs = sx_pk_get_output_ops(req);
		    ...
		    struct sx_ed25519_v *sig_s)
{
	...
	int status = ed25519_sign_run(req, k, r, s);
...
static inline void ed25519_pt_write_y(const struct sx_ed25519_pt *pt, uint8_t *ay)
{
	sx_wrpkmem(ay, pt->encoded, SX_ED25519_PT_SZ);
	sx_wrpkmem_byte(&ay[SX_ED25519_PT_SZ - 1], pt->encoded[SX_ED25519_PT_SZ - 1] & 0x7f);
}

static int ed25519_verify_run(sx_pk_req *req, const struct sx_ed25519_dgst *k,
		      ...
		      const struct sx_ed25519_pt *r)
{
	...
	int status = ed25519_verify_run(req, k, a, sig_s, r);
