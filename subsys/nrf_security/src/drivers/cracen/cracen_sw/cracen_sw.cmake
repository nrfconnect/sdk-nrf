...
if(CONFIG_CRACEN_NEED_CTR_SIZE_WORKAROUNDS AND CONFIG_PSA_NEED_CRACEN_CTR_AES)
  list(APPEND cracen_driver_sources
    ${CMAKE_CURRENT_LIST_DIR}/src/cracen_sw_aes_ctr.c
  )
endif()

if(CONFIG_CRACEN_NEED_MULTIPART_WORKAROUNDS AND (CONFIG_PSA_NEED_CRACEN_CBC_NO_PADDING_AES OR CONFIG_PSA_NEED_CRACEN_CBC_PKCS7_AES))
  list(APPEND cracen_driver_sources
