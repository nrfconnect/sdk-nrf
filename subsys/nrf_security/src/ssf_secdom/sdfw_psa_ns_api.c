...
psa_status_t psa_call_buffered_and_flushed(psa_handle_t handle, int32_t type,
 ...
 */
psa_status_t psa_call_buffered(psa_handle_t handle, int32_t type,
                      const psa_invec *in_vec, size_t in_len,
                      psa_outvec *out_vec, size_t out_len)
{
	...
	psa_status_t status = psa_call_buffered_and_flushed(handle, type, in_vec, in_len, out_vec, out_len);
