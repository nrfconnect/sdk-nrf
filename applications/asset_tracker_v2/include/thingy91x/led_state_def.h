...
static const struct led_effect asset_tracker_led_effect[] = {
	[LED_STATE_LTE_CONNECTING]	= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_NORMAL,
								LED_COLOR_YELLOW(255)),
	[LED_STATE_LOCATION_SEARCHING]	= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_NORMAL,
								LED_COLOR_MAGENTA(255)),
	[LED_STATE_CLOUD_PUBLISHING]	= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_NORMAL,
								LED_COLOR_GREEN(255)),
	...
	[LED_STATE_CLOUD_ASSOCIATING]	= LED_EFFECT_LED_CLOCK(LED_TICKS_DOUBLE,
							       LED_COLOR_WHITE(255)),
	[LED_STATE_CLOUD_ASSOCIATED]	= LED_EFFECT_LED_ON_EASE_OFF(LED_COLOR_WHITE(255),
								   LED_PERIOD_NORMAL,
								   LED_PERIOD_RAPID),
	[LED_STATE_ACTIVE_MODE]		= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_NORMAL,
								LED_COLOR_CYAN(255)),
	[LED_STATE_PASSIVE_MODE]	= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_NORMAL,
								LED_COLOR_BLUE(255)),
	[LED_STATE_ERROR_SYSTEM_FAULT]	= LED_EFFECT_LED_ON(LED_COLOR_RED(255)),
	[LED_STATE_FOTA_UPDATING]	= LED_EFFECT_LED_BREATH_LINEAR(LED_PERIOD_RAPID,
								LED_COLOR_ORANGE(255)),
	[LED_STATE_FOTA_UPDATE_REBOOT]	= LED_EFFECT_LED_ON(LED_COLOR_ORANGE(255)),
