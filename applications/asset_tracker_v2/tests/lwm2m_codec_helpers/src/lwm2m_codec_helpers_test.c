...
void test_codec_helpers_setup_resource_buffers(void)
{
	...
	__wrap_lwm2m_engine_set_float_IgnoreAndReturn(0);
...
void test_codec_helpers_set_sensor_boundaries(void)
{
	...
	__wrap_lwm2m_engine_set_res_buf_IgnoreAndReturn(0);
...
void test_codec_helpers_setup_configuration_object(void)
{
	...
	__wrap_lwm2m_engine_register_post_write_callback_IgnoreAndReturn(0);
...
void test_codec_helpers_setup_configuration_object_handler(void)
{
	...
	__wrap_lwm2m_engine_set_float_IgnoreAndReturn(0);
	__wrap_lwm2m_engine_set_s32_IgnoreAndReturn(0);
	__wrap_lwm2m_engine_set_bool_IgnoreAndReturn(0);
...
void test_codec_helpers_get_configuration_object(void)
{
	...
	TEST_ASSERT_EQUAL(GNSS_TIMEOUT, cfg.gnss_timeout);
