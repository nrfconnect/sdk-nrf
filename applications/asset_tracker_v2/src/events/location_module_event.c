...
static char *get_evt_type_str(enum location_module_event_type type)
{
	...
	case LOCATION_MODULE_EVT_NEIGHBOR_CELLS_DATA_READY:
		return "LOCATION_MODULE_EVT_NEIGHBOR_CELLS_DATA_READY";
	case LOCATION_MODULE_EVT_WIFI_ACCESS_POINTS_DATA_READY:
		return "LOCATION_MODULE_EVT_WIFI_ACCESS_POINTS_DATA_READY";
	...
	case LOCATION_MODULE_EVT_AGPS_NEEDED:
		return "LOCATION_MODULE_EVT_AGPS_NEEDED";
