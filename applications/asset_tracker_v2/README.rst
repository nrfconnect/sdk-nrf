...
This enables the cloud to indirectly fetch A-GPS and P-GPS data from `nRF Cloud`_ though REST calls and relay the data to the nRF9160 DK using the pre-established MQTT connection.
