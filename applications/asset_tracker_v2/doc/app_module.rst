...
When the application boots, the module initializes the :ref:`app_evt_mgr` and sends out the initial event :c:enum:`APP_EVT_START` that starts the rest of the modules in the application.
