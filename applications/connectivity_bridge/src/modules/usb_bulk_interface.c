...
static struct usb_ep_cfg_data dapusb_ep_data[] = {
	{.ep_cb = usb_transfer_ep_callback, .ep_addr = DAP_USB_EP_OUT},
	{.ep_cb = usb_transfer_ep_callback, .ep_addr = DAP_USB_EP_IN},
};
...
K_THREAD_DEFINE(dap_usb_thread, 1024, dap_usb_thread_fn, NULL, NULL, NULL, 5, 0, 0);
