...
* :ncs-file:`/applications/ipc_radio/overlay-802154.conf` - Configuration file enabling IEEE 802.15.4.
* :ncs-file:`/applications/ipc_radio/overlay-bt_hci_ipc.conf` - Configuration file enabling Bluetooth Low Energy over HCI.
* :ncs-file:`/applications/ipc_radio/overlay-bt_rpc.conf` - Configuration file enabling Bluetooth Low Energy over RPC.
...
.. note::
   ...
   For instance, the :kconfig:option:`SB_CONFIG_NETCORE_IPC_RADIO_IEEE802154` sysbuild Kconfig option enables the :ncs-file:`/applications/ipc_radio/overlay-802154.conf` configuration file to be used with the IPC radio firmware.
