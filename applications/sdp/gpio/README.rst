...
This application demonstrates how to create HPF driver on FLPR in Zephyr threadless mode by implementing a subset of Zephyr GPIO API.
...
For example, to build with icmsg backend, run the following commands:
  ...
  .. code-block:: console
     ...
     west build -b nrf54l15dk/nrf54l15/cpuapp -- -DSB_CONFIG_PARTITION_MANAGER=n -DSB_CONFIG_HPF=y -DSB_CONFIG_HPF_GPIO=y -DSB_CONFIG_HPF_GPIO_BACKEND_ICMSG=y -DEXTRA_DTC_OVERLAY_FILE="./boards/nrf54l15dk_nrf54l15_cpuapp_egpio.overlay"
     west flash
