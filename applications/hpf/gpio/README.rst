...
For example, to build with icmsg backend for nRF54L15, run the following commands:
...
For nRF7120, use the corresponding board and overlay file:

  .. code-block:: console

     west build -b nrf7120pdk/nrf7120/cpuapp -- -DSB_CONFIG_PARTITION_MANAGER=n -DSB_CONFIG_HPF=y -DSB_CONFIG_HPF_GPIO=y -DSB_CONFIG_HPF_GPIO_BACKEND_ICMSG=y -DEXTRA_DTC_OVERLAY_FILE="./boards/nrf7120pdk_nrf7120_cpuapp_hpf_gpio.overlay"
     west flash
 ...
 * Assembly: :file:`applications/hpf/gpio/src/hrt/hrt-nrf7120.s`
