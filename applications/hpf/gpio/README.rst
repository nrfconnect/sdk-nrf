...
For example, to build with icmsg backend, run the following commands (replace ``<build_target>`` with your target board, such as ``nrf54l15dk/nrf54l15/cpuapp`` or ``nrf7120dk/nrf7120/cpuapp``):
