...
For example, to build with icmsg backend, run the following commands (replace ``<board>`` with your target board, such as ``nrf54l15dk/nrf54l15/cpuapp`` or ``nrf54lm20dk/nrf54lm20a/cpuapp``):
 ...
 * Assembly: :file:`applications/hpf/gpio/src/hrt/hrt-nrf54lm20a.s`
