...
.. _nrf_audio_unicast_client_app_ui:
...
.. _nrf_audio_unicast_client_app_configuration:
...
.. _nrf_audio_unicast_client_app_building:

Building and running
********************

This application can be found under :file:`applications/nrf_audio/unicast_client` in the nRF Connect SDK folder structure, but it uses :file:`.conf` files at :file:`applications/nrf_audio/`.
...
.. _nrf_audio_unicast_client_app_testing:
...
The recommended approach is to use another nRF5340 Audio DK programmed with the :ref:`unicast server application <nrf_audio_unicast_server_app>`, but you can also use an external CIS headset device.
...
For other testing options, refer to :ref:`nrf_audio_unicast_client_app_ui`.
...
.. _nrf_audio_unicast_client_app_testing_steps_cis_walkie_talkie:
