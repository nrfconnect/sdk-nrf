...
.. _nrf_audio_app_requirements_codec:

Software codec requirements
***************************

The nRF Audio applications only support the :ref:`LC3 software codec <nrfxlib:lc3>`, developed specifically for use with LE Audio.
...
.. _nrf_audio_app_dk:
.. _nrf_audio_app_dk_features:

nRF5340 Audio development kit
*****************************

The nRF5340 Audio development kit is a hardware development platform that demonstrates the nRF Audio applications.
Read the `nRF5340 Audio DK Hardware`_ documentation for more information about this development kit.

You can :ref:`test the DK out of the box <nrf_audio_app_dk_testing_out_of_the_box>` before you program it.

.. _nrf_audio_app_configuration_files:
...
See :ref:`nrf_audio_app_building_standard` for more information.

When building using the script, you :ref:`specify parameters for building <nrf_audio_app_building_script_running>` instead of the file names.
