...
This nRF Audio application source files can be found in their respective folders under :file:`applications/nrf_audio` in the nRF Connect SDK folder structure.

You can build and program the applications in one of the following ways:

* :ref:`nrf_audio_app_building_script` - This is the suggested method.
  Using this method allows you to build and program multiple development kits at the same time.
* :ref:`nrf_audio_app_building_standard` - Using either of these methods requires manually providing source files for building each build configuration.

.. note::
   Check the :ref:`nRF Audio application known issues <known_issues_nrf_audio>` before building and programming the applications.
...
.. _nrf_audio_app_dk_testing_out_of_the_box:
...
.. _nrf_audio_app_building_script:
...
The script automates the process of selecting :ref:`configuration files <nrf_audio_app_configuration_files>` and building different applications.
This eases the process of building and programming images for multiple development kits.

The script is located in the :file:`applications/nrf_audio/tools/buildprog` directory.
...
* ``location`` - This field is valid only for headsets.
  It sets the location on which the headset is meant to work, especially when using the :ref:`default CIS transport mode configuration <nrf_audio_transport_mode_configuration>`.
  For more information, see :ref:`nrf_audio_app_configuration_headset_location`.

.. _nrf_audio_app_building_script_running:
...
.. list-table:: Parameters for the script
   ...
   * - Device type (``-d``)
     ...
     - :ref:`nrf_audio_app_overview_gateway_headsets`
...
.. _nrf_audio_app_building_standard:

Building and programming using standard methods
***********************************************

You can build the nRF Audio applications using the standard |NCS| :ref:`build steps <programming_cmd>` for |nRFVSC| or the command line.
This method requires manually providing source files for building each build configuration.

.. _nrf_audio_app_building_config_files:
...
.. _nrf_audio_app_configuration_select_build:
...
.. include:: ../index.rst
   :start-after: nrf_audio_app_overview_table_start
   :end-before: nrf_audio_app_overview_table_end
...
.. tabs::
   ...
   .. group-tab:: |nRFVSC|
      ...
      #. Create a new audio application in |nRFVSC| by completing the steps listed in the :ref:`creating_vsc` section.
         Use the :guilabel:`Copy a sample` option and select the :guilabel:`nRF Audio` application when prompted.
      ...
      See :ref:`nrf_audio_app_building_standard_programming`.
   ...
   .. group-tab:: Command line
      ...
      #. Build the application using the standard :ref:`build steps <building>` for the command line.
         ...
         Alternatively, you can use the :ref:`nrf_audio_app_building_script`, which handles this automatically.

.. _nrf_audio_app_building_standard_programming:
...
When using the :ref:`default CIS transport mode configuration <nrf_audio_transport_mode_configuration>`, if you want to use two headset devices or the stereo configuration, you must :ref:`configure the headset location <nrf_audio_app_configuration_headset_location>`.
