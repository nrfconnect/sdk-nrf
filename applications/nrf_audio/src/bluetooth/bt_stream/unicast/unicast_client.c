				       ...
				       enum bt_audio_location loc)
{
	...
	if ((loc == BT_AUDIO_LOCATION_MONO_AUDIO) || (loc & BT_AUDIO_LOCATION_LOW_FREQ_EFFECTS_1) ||
...
/* Get the supported source or sink channels from all connected unicast servers, called once per
 * server.
 ...
 */
static bool channels_get(struct server_store *server, void *user_data)
{
