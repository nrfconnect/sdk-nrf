...
#define NRF_AUDIO_GATEWAY_SCAN_TYPE   BT_LE_SCAN_TYPE_ACTIVE
#define NRF_AUDIO_GATEWAY_SCAN_PARAMS BT_LE_SCAN_ACTIVE
#elif (CONFIG_SCAN_MODE_PASSIVE)
#define NRF_AUDIO_GATEWAY_SCAN_TYPE   BT_LE_SCAN_TYPE_PASSIVE
#define NRF_AUDIO_GATEWAY_SCAN_PARAMS BT_LE_SCAN_PASSIVE
#else
