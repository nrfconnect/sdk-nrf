...
.. list-table::
   ...
   * - Cyan
     - Connecting to the nRF Connect for Cloud
   * - Yellow
...
#. Observe in the terminal window that the connection to the nRF Connect for Cloud is established. This may take several minutes.
...
#. Press Button 1 (SW3 on Thingy:91) to send BUTTON data to the nRF Connect for Cloud.
