...
static inline int net_if_ipv6_addr_lookup_by_index(const struct in6_addr * addr)
{
	...
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke1(*(u32_t *)&addr, K_SYSCALL_NET_IF_IPV6_ADDR_LOOKUP_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke4(*(u32_t *)&index, *(u32_t *)&addr, *(u32_t *)&addr_type, *(u32_t *)&vlifetime, K_SYSCALL_NET_IF_IPV6_ADDR_ADD_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke2(*(u32_t *)&index, *(u32_t *)&addr, K_SYSCALL_NET_IF_IPV6_ADDR_RM_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke1(*(u32_t *)&addr, K_SYSCALL_NET_IF_IPV4_ADDR_LOOKUP_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke4(*(u32_t *)&index, *(u32_t *)&addr, *(u32_t *)&addr_type, *(u32_t *)&vlifetime, K_SYSCALL_NET_IF_IPV4_ADDR_ADD_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke2(*(u32_t *)&index, *(u32_t *)&addr, K_SYSCALL_NET_IF_IPV4_ADDR_RM_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke2(*(u32_t *)&index, *(u32_t *)&netmask, K_SYSCALL_NET_IF_IPV4_SET_NETMASK_BY_INDEX);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (bool) z_arch_syscall_invoke2(*(u32_t *)&index, *(u32_t *)&gw, K_SYSCALL_NET_IF_IPV4_SET_GW_BY_INDEX);
	}
#endif
	compiler_barrier();
