...
static inline int gpio_config(struct device * port, int access_op, u32_t pin, int flags)
{
	...
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke4(*(u32_t *)&port, *(u32_t *)&access_op, *(u32_t *)&pin, *(u32_t *)&flags, K_SYSCALL_GPIO_CONFIG);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke4(*(u32_t *)&port, *(u32_t *)&access_op, *(u32_t *)&pin, *(u32_t *)&value, K_SYSCALL_GPIO_WRITE);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke4(*(u32_t *)&port, *(u32_t *)&access_op, *(u32_t *)&pin, *(u32_t *)&value, K_SYSCALL_GPIO_READ);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke3(*(u32_t *)&port, *(u32_t *)&access_op, *(u32_t *)&pin, K_SYSCALL_GPIO_ENABLE_CALLBACK);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke3(*(u32_t *)&port, *(u32_t *)&access_op, *(u32_t *)&pin, K_SYSCALL_GPIO_DISABLE_CALLBACK);
	}
#endif
	compiler_barrier();
...
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		return (int) z_arch_syscall_invoke1(*(u32_t *)&dev, K_SYSCALL_GPIO_GET_PENDING_INT);
	}
#endif
	compiler_barrier();
