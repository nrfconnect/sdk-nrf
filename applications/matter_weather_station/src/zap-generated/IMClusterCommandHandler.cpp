...
namespace app
{
	...
	namespace clusters
	{
		namespace AdministratorCommissioning
		{
			void DispatchServerCommand(CommandHandler *apCommandObj,
						   CommandId aCommandId, EndpointId aEndpointId,
						   TLV::TLVReader &aDataTlv)
			{
				...
				bool wasHandled = false;
				{
					...
					case Clusters::AdministratorCommissioning::Commands::Ids::
						...
						while ((TLVError = aDataTlv.Next()) ==
							...
							currentDecodeTagId = TLV::TagNumFromTag(
								aDataTlv.GetTag());
							if (currentDecodeTagId < 1) {
								if (argExists[currentDecodeTagId]) {
									ChipLogProgress(
										Zcl,
										"Duplicate TLV tag %" PRIx32,
										TLV::TagNumFromTag(
											aDataTlv.GetTag()));
									TLVUnpackError =
					...
					case Clusters::AdministratorCommissioning::Commands::Ids::
						...
						while ((TLVError = aDataTlv.Next()) ==
							...
							case 1:
								TLVUnpackError =
									aDataTlv.Get(PAKEVerifier);
								break;
							case 2:
								TLVUnpackError =
									aDataTlv.Get(Discriminator);
								break;
							case 3:
								TLVUnpackError =
									aDataTlv.Get(Iterations);
								break;
							case 4:
					...
					default: {
						...
						ReportCommandUnsupported(
							apCommandObj, aEndpointId,
				...
				if (CHIP_NO_ERROR != TLVError || CHIP_NO_ERROR != TLVUnpackError ||
					...
					CommandPathParams returnStatusParam = {
						...
						0, // GroupId
						Clusters::AdministratorCommissioning::Id,
						aCommandId, (CommandPathFlags::kEndpointIdValid)
					};
					apCommandObj->AddStatusCode(
						returnStatusParam,
						Protocols::SecureChannel::GeneralStatusCode::
							kBadRequest,
						Protocols::SecureChannel::Id,
					...
					ChipLogProgress(
						...
						TLVError.Format(), TLVUnpackError.Format(),
						currentDecodeTagId);
		...
		namespace GeneralCommissioning
		{
						   ...
						   TLV::TLVReader &aDataTlv)
			{
				...
				{
					switch (aCommandId) {
					case Clusters::GeneralCommissioning::Commands::Ids::
						ArmFailSafe: {
						...
						while ((TLVError = aDataTlv.Next()) ==
							...
							case 1:
								TLVUnpackError =
									aDataTlv.Get(breadcrumb);
								break;
							case 2:
								TLVUnpackError =
									aDataTlv.Get(timeoutMs);
								break;
							default:
								// Unsupported tag, ignore it.
								ChipLogProgress(
				...
				bool wasHandled = false;
				{
					...
					case Clusters::OperationalCredentials::Commands::Ids::AddNOC: {
						...
						while ((TLVError = aDataTlv.Next()) ==
							...
							case 0:
								TLVUnpackError =
									aDataTlv.Get(NOCValue);
								break;
							case 1:
								TLVUnpackError =
									aDataTlv.Get(ICACValue);
								break;
							case 2:
								TLVUnpackError =
									aDataTlv.Get(IPKValue);
								break;
							case 3:
								TLVUnpackError =
									aDataTlv.Get(CaseAdminNode);
								break;
							case 4:
								TLVUnpackError =
									aDataTlv.Get(AdminVendorId);
								break;
							default:
								// Unsupported tag, ignore it.
								ChipLogProgress(
		...
		namespace SoftwareDiagnostics
		{
						   ...
						   TLV::TLVReader &aDataTlv)
			{
				...
				{
					switch (aCommandId) {
					case Clusters::SoftwareDiagnostics::Commands::Ids::
						ResetWatermarks: {
						wasHandled =
		...
		namespace ThreadNetworkDiagnostics
		{
						   ...
						   TLV::TLVReader &aDataTlv)
			{
				...
				{
					switch (aCommandId) {
					case Clusters::ThreadNetworkDiagnostics::Commands::Ids::
						ResetCounts: {
						wasHandled =
	...
	void DispatchSingleClusterCommand(ClusterId aClusterId, CommandId aCommandId,
					  EndpointId aEndPointId, TLV::TLVReader &aReader,
					  CommandHandler *apCommandObj)
	{
		...
		case Clusters::SoftwareDiagnostics::Id:
			clusters::SoftwareDiagnostics::DispatchServerCommand(
				apCommandObj, aCommandId, aEndPointId, aReader);
			break;
	...
	void DispatchSingleClusterResponseCommand(ClusterId aClusterId, CommandId aCommandId,
						  EndpointId aEndPointId, TLV::TLVReader &aReader,
