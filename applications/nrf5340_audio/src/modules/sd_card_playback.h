 ...
 * background playback through dedicated threads. It integrates with @ref nrf5340_audio_system
 * for synchronized audio delivery and provides file format detection and validation
