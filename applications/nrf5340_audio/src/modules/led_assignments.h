...
#define LED_AUDIO_CONN_STATUS DT_NODE_CHILD_IDX(DT_NODELABEL(led0))
#else
...
#define LED_AUDIO_APP_STATUS DT_NODE_CHILD_IDX(DT_NODELABEL(led1))
#else
...
#define LED_AUDIO_SYNC_STATUS DT_NODE_CHILD_IDX(DT_NODELABEL(led2))
#else
