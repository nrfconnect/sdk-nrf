...
#define PCM_NUM_BYTES_MULTI_CHAN      (PCM_NUM_BYTES_MONO * CONFIG_AUDIO_OUTPUT_CHANNELS_MAX)
 ...
 *
 * @param[in]	audio_frame_in	Pointer to the audio encoded buffer.
 * @param[out]	audio_frame_out	Pointer to the audio PCM buffer.
 *
