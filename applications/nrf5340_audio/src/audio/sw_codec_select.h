...
#define OPUS_PCM_FRAME_SIZE_SAMPLES_MONO ((CONFIG_OPUS_SAMPLE_RATE * OPUS_MAX_FRAME_SIZE_MS) / 1000)
#define OPUS_ENC_MONO_FRAME_SIZE (CONFIG_OPUS_BITRATE * OPUS_MAX_FRAME_SIZE_MS / (8 * 1000))

#define OPUS_PCM_NUM_BYTES_MONO                                                                    \
	(CONFIG_OPUS_SAMPLE_RATE * CONFIG_AUDIO_BIT_DEPTH_OCTETS * OPUS_MAX_FRAME_SIZE_MS / 1000)
...
#define ENC_MAX_FRAME_SIZE MAX(LC3_ENC_MONO_FRAME_SIZE, OPUS_ENC_MONO_FRAME_SIZE)
#define ENC_TIME_US MAX(LC3_ENC_TIME_US, OPUS_ENC_TIME_US)
#define DEC_TIME_US MAX(LC3_DEC_TIME_US, OPUS_DEC_TIME_US)
