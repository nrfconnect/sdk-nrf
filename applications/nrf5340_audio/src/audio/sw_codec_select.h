...
#define LC3_ENC_MONO_FRAME_SIZE_MAX (CONFIG_LC3_BITRATE_MAX * LC3_MAX_FRAME_SIZE_MS / (8 * 1000))
...
#else
#define LC3_ENC_MONO_FRAME_SIZE_MAX 0
...
#define ENC_MAX_FRAME_SIZE   MAX(LC3_ENC_MONO_FRAME_SIZE_MAX, 0)
