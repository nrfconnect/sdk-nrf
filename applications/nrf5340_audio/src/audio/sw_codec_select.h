...
#else
/** LC3 encoder mono frame size when LC3 codec is not enabled. */
#define LC3_ENC_MONO_FRAME_SIZE 0

/** LC3 PCM bytes per mono frame when LC3 codec is not enabled. */
#define LC3_PCM_NUM_BYTES_MONO	0

/** LC3 encoder processing time when LC3 codec is not enabled. */
#define LC3_ENC_TIME_US		0

/** LC3 decoder processing time when LC3 codec is not enabled. */
#define LC3_DEC_TIME_US		0
#endif /* CONFIG_SW_CODEC_LC3 */

/** Maximum encoder frame size across all supported codecs. */
#define ENC_MAX_FRAME_SIZE   MAX(LC3_ENC_MONO_FRAME_SIZE, 0)

/** Maximum encoder processing time across all supported codecs. */
#define ENC_TIME_US	     MAX(LC3_ENC_TIME_US, 0)

/** Maximum decoder processing time across all supported codecs. */
 ...
 *
 * @see @ref audio_system_encode_test_tone_set for test tone generation
 * @see @ref sw_codec_decode for decoding operations
 */
