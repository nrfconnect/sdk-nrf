...
The :ref:`CONFIG_NRF5340_AUDIO <config_audio_app_options>` option is the main Kconfig option that activates all nRF5340 Audio functionality.
...
The :ref:`CONFIG_AUDIO_DEV <config_audio_app_options>` Kconfig option defines the nRF5340 Audio device role.
The device role can be either a gateway (:ref:`CONFIG_AUDIO_DEV=2 <config_audio_app_options>`) or a headset (:ref:`CONFIG_AUDIO_DEV=1 <config_audio_app_options>`).
...
* (Default mode) :ref:`CONFIG_TRANSPORT_CIS <config_audio_app_options>` - Enables CIS mode for clients and servers (unicast applications).
  With this option enabled, you can configure :ref:`application Kconfig options specific to unicast communication <config_audio_app_options_unicast>`.
* :ref:`CONFIG_TRANSPORT_BIS <config_audio_app_options>` - Enables BIS mode for `Auracast™`_ sources and sinks (broadcast applications).
  With this option enabled, you can configure :ref:`application Kconfig options specific to broadcast communication <config_audio_app_options_broadcast>`.
...
To switch to the bidirectional mode, set the :ref:`CONFIG_STREAM_BIDIRECTIONAL<config_audio_app_options>` Kconfig option to ``y``  in the :file:`applications/nrf5340_audio/prj.conf` file (for the debug version) or in the :file:`applications/nrf5340_audio/prj_release.conf` file (for the release version).
...
To switch to using the walkie-talkie, set the :ref:`CONFIG_WALKIE_TALKIE_DEMO<config_audio_app_options>` Kconfig option to ``y``  in the :file:`applications/nrf5340_audio/prj.conf` file (for the debug version) or in the :file:`applications/nrf5340_audio/prj_release.conf` file (for the release version).
...
To configure the second gateway, add both the :ref:`CONFIG_TRANSPORT_BIS<config_audio_app_options>` and the :ref:`CONFIG_BT_AUDIO_USE_BROADCAST_NAME_ALT<config_audio_app_options>` Kconfig options set to ``y`` to the :file:`applications/nrf5340_audio/prj.conf` file for the debug version and to the :file:`applications/nrf5340_audio/prj_release.conf` file for the release version.
You can provide an alternative name to the second gateway using the :ref:`CONFIG_BT_AUDIO_BROADCAST_NAME_ALT<config_audio_app_options>` or use the default alternative name.
...
* USB audio source (:ref:`CONFIG_AUDIO_SOURCE_USB <config_audio_app_options>`) - Uses USB as the audio source (default for gateway)
* I2S audio source (:ref:`CONFIG_AUDIO_SOURCE_I2S <config_audio_app_options>`) - Uses 3.5 mm jack analog input using I2S
...
To switch to using the 3.5 mm jack analog input, set the :ref:`CONFIG_AUDIO_SOURCE_I2S<config_audio_app_options>` Kconfig option to ``y`` in the :file:`applications/nrf5340_audio/prj.conf` file for the debug version and in the :file:`applications/nrf5340_audio/prj_release.conf` file for the release version.
...
You can configure the software codec using the following Kconfig options:

* :ref:`CONFIG_SW_CODEC_LC3 <config_audio_app_options>` - LC3 codec (mandatory for LE Audio)
* :ref:`CONFIG_SW_CODEC_NONE <config_audio_app_options>` - No software codec

You can configure the hardware codec using the following Kconfig option:

* :ref:`CONFIG_NRF5340_AUDIO_CS47L63_DRIVER <config_audio_app_options>` - CS47L63 hardware codec driver
...
* Frame duration (example: :ref:`CONFIG_AUDIO_FRAME_DURATION_7_5_MS <config_audio_app_options>`)
* Sample rates (example: :ref:`CONFIG_AUDIO_SAMPLE_RATE_16000_HZ <config_audio_app_options>`)
* Bit depth (example: :ref:`CONFIG_AUDIO_BIT_DEPTH_16 <config_audio_app_options>`)
* Presentation delay (example: :ref:`CONFIG_AUDIO_MIN_PRES_DLY_US <config_audio_app_options>`)
...
* :ref:`CONFIG_NRF5340_AUDIO_SD_CARD_MODULE<config_audio_app_options>` - to enable the SD card module; this option is enabled by default on nRF5340 Audio DK
* :ref:`CONFIG_SD_CARD_PLAYBACK<config_audio_app_options>` - to enable the playback functionality

Optionally, you can also set the following Kconfig options:

* :ref:`CONFIG_SD_CARD_PLAYBACK_STACK_SIZE<config_audio_app_options>`
* :ref:`CONFIG_SD_CARD_PLAYBACK_RING_BUF_SIZE<config_audio_app_options>`
* :ref:`CONFIG_SD_CARD_PLAYBACK_THREAD_PRIO<config_audio_app_options>`
...
* :ref:`CONFIG_NRF5340_AUDIO_POWER_MEASUREMENT <config_audio_app_options>` - Power measurement functionality
* :ref:`CONFIG_POWER_MEAS_INTERVAL_MS <config_audio_app_options>` - Power measurement interval
* :ref:`CONFIG_POWER_MEAS_START_ON_BOOT <config_audio_app_options>` - Auto-start power measurements
...
Power measurement
* :ref:`CONFIG_POWER_MEAS_THREAD_PRIO <config_audio_app_options>` - Power measurement thread priority
* :ref:`CONFIG_POWER_MEAS_STACK_SIZE <config_audio_app_options>` - Power measurement stack size

Button handling
* :ref:`CONFIG_BUTTON_PUBLISH_THREAD_PRIO <config_audio_app_options>` - Button publish thread priority
* :ref:`CONFIG_BUTTON_PUBLISH_STACK_SIZE <config_audio_app_options>` - Button publish stack size
* :ref:`CONFIG_BUTTON_DEBOUNCE_MS <config_audio_app_options>` - Button debounce time

Volume control
* :ref:`CONFIG_VOLUME_MSG_SUB_THREAD_PRIO <config_audio_app_options>` - Volume message subscribe thread priority
* :ref:`CONFIG_VOLUME_MSG_SUB_STACK_SIZE <config_audio_app_options>` - Volume message subscribe stack size
* :ref:`CONFIG_VOLUME_MSG_SUB_QUEUE_SIZE <config_audio_app_options>` - Volume message subscriber queue size
...
* :ref:`CONFIG_FIFO_FRAME_SPLIT_NUM <config_audio_app_options>` - Number of blocks per audio frame
* :ref:`CONFIG_FIFO_TX_FRAME_COUNT <config_audio_app_options>` - Max TX audio frames
* :ref:`CONFIG_FIFO_RX_FRAME_COUNT <config_audio_app_options>` - Max RX audio frames
...
* :ref:`CONFIG_TESTING_BLE_ADDRESS_RANDOM <config_audio_app_options>` - Random address generation for testing
* :ref:`CONFIG_AUDIO_TEST_TONE <config_audio_app_options>` - Test tone generation
* :ref:`CONFIG_AUDIO_MUTE <config_audio_app_options>` - Audio muting functionality
