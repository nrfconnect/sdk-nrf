...
| **Button 4**  |                                                                                                           | * :ref:`nrf53_audio_unicast_client_app`     |                  |            |
|               +-----------------------------------------------------------------------------------------------------------+---------------------------------------------+------------------+------------+
...
|                          +-----------------------------------------------------------------------------------------------------------+                                             +------------------+------------+
|                          | Rapid flashing green - IFMCU/Debugger operation ongoing.                                                              |                                             |         N        |      Y     |
+--------------------------+-----------------------------------------------------------------------------------------------------------+---------------------------------------------+------------------+------------+
| **LED1,2,3 and 4**       | All solid green - Fault in the application core has occurred.                                             | All                                         |         N        |      Y     |
