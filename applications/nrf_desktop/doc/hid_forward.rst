...
#. The HID forward module is enabled with the :option:`CONFIG_DESKTOP_HID_FORWARD_ENABLE` option.
...
Up to :option:`CONFIG_DESKTOP_HID_FORWARD_MAX_ENQUEUED_REPORTS` reports can be enqueued at a time.
