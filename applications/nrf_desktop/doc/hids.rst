...
Right now, the only board that displays information received in the HID output report using hardware LEDs is the :zephyr:board:`nrf52840dk` in ``keyboard`` build type configuration.
