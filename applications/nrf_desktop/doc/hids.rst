...
The peripheral must use the SoftDevice Link Layer (:kconfig:option:`CONFIG_BT_LL_SOFTDEVICE`).
...
.. note::
   ...
   At the same time, the current consumption increased - for nRF54L15DK in the release configuration from around 250 µA to around 1 mA.
