...
If Nordic Semiconductor's proprietary Bluetooth LE Link Layer is selected (:option:`CONFIG_BT_LL_SOFTDEVICE`), the module sends a Bluetooth HCI command to enable the LLPM when Bluetooth is ready.
