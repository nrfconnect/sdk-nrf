...
After ``ble_peer_event`` regarding disconnection or connection failure is received by all other application modules, the |ble_state| unreferences the :cpp:class:`bt_conn` object by using :c:func:`bt_conn_unref`.
