...
union _input_report_size_max {
	...
	uint8_t _mouse_report[REPORT_SIZE_MOUSE_BOOT];
#endif
#if CONFIG_DESKTOP_HID_REPORT_BOOT_INTERFACE_KEYBOARD
	uint8_t _keyboard_report[REPORT_SIZE_KEYBOARD_BOOT];
#endif
};
...
/* Size of the biggest supported HID input report that is part of output reports map. */
