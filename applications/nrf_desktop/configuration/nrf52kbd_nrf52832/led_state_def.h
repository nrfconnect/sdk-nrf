...
static const struct led_effect led_peer_state_effect[LED_PEER_COUNT][LED_PEER_STATE_COUNT] = {
	{[LED_PEER_STATE_DISCONNECTED]   = LED_EFFECT_LED_OFF(),
	 [LED_PEER_STATE_CONNECTED]      = LED_EFFECT_LED_ON_EASE_OFF(
							LED_COLOR_WHITE(255), 5000, 3000),
	 [LED_PEER_STATE_PEER_SEARCH]    = LED_EFFECT_LED_BREATH_LINEAR(500, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_SELECT] = LED_EFFECT_LED_CLOCK(1, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_ERASE]  = LED_EFFECT_LED_BLINK(25, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_ERASE_ADV]	= LED_EFFECT_LED_BREATH_LINEAR(100, LED_COLOR_WHITE(255)),
	},
	{[LED_PEER_STATE_DISCONNECTED]   = LED_EFFECT_LED_OFF(),
	 [LED_PEER_STATE_CONNECTED] = LED_EFFECT_LED_ON_EASE_OFF(
							LED_COLOR_WHITE(255), 5000, 3000),
	 [LED_PEER_STATE_PEER_SEARCH]    = LED_EFFECT_LED_BREATH_LINEAR(500, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_SELECT] = LED_EFFECT_LED_CLOCK(2, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_ERASE]  = LED_EFFECT_LED_BLINK(25, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_ERASE_ADV]	= LED_EFFECT_LED_BREATH_LINEAR(100, LED_COLOR_WHITE(255)),
	},
	{[LED_PEER_STATE_DISCONNECTED]   = LED_EFFECT_LED_OFF(),
	 [LED_PEER_STATE_CONNECTED] = LED_EFFECT_LED_ON_EASE_OFF(
							LED_COLOR_WHITE(255), 5000, 3000),
	 [LED_PEER_STATE_PEER_SEARCH]    = LED_EFFECT_LED_BREATH_LINEAR(500, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_SELECT] = LED_EFFECT_LED_CLOCK(3, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_CONFIRM_ERASE]  = LED_EFFECT_LED_BLINK(25, LED_COLOR_WHITE(255)),
	 [LED_PEER_STATE_ERASE_ADV]	= LED_EFFECT_LED_BREATH_LINEAR(100, LED_COLOR_WHITE(255)),
	},
};
