...
static const struct led_effect led_peer_state_effect[LED_PEER_COUNT][LED_PEER_STATE_COUNT] = {
	{
		...
		[LED_PEER_STATE_PEER_SEARCH]    = LED_EFFECT_LED_BLINK(500, LED_COLOR(0, 0, 255)),
		[LED_PEER_STATE_CONFIRM_SELECT] = LED_EFFECT_LED_BLINK(50, LED_COLOR(0, 0, 255)),
		[LED_PEER_STATE_CONFIRM_ERASE]  = LED_EFFECT_LED_BLINK(25, LED_COLOR(0, 0, 255)),
		[LED_PEER_STATE_ERASE_ADV]	= LED_EFFECT_LED_BLINK(100, LED_COLOR(0, 0, 255)),
	},
};
