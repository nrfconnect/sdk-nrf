...
* The ``SB_CONFIG_BT_FAST_PAIR_MODEL_ID`` and ``SB_CONFIG_BT_FAST_PAIR_ANTI_SPOOFING_PRIVATE_KEY`` Kconfig options are set in sysbuild configuration to generate the hex file with Fast Pair provisioning data.
