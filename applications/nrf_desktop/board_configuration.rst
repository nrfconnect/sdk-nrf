...
nRF52840 USB Dongle (``nrf52840dongle/nrf52840``) and nRF52833 USB Dongle (``nrf52833dongle``)
      ...
      * The nRF5 MBR partition (``nrf5_mbr``) added by the board is not used.
        Define it with address and size both set to zero to prevent Partition Manager from trying to place it dynamically.
