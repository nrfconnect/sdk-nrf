 ...
 *
 * @param[out] q		HID event queue object.
 ...
 *
 * The function removes enqueued events with timestamp lower than provided minimal valid timestamp.
 *
 * Enqueued event related to a key press is not removed if matching key release event cannot be
