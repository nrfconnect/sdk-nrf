...
static void broadcast_subscription_changes_internal(bool subscribed_filter)
{
...
static void broadcast_subscription_changes(void)
{
	 ...
	 */
	broadcast_subscription_changes_internal(false);
	broadcast_subscription_changes_internal(true);
}
...
static void pm_evt_handler(enum bt_hids_pm_evt evt, struct bt_conn *conn)
{
	...
	broadcast_subscription_changes();
}
