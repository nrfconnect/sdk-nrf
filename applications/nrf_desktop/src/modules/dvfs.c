...
static const struct dvfs_frequency dvfs_freq_array[] = {
	{ CONFIG_DESKTOP_DVFS_FREQ_HIGH, INITIALIZE_DVFS_FREQ_MASK(ACTIVE_FREQ_HIGH) },
	{ CONFIG_DESKTOP_DVFS_FREQ_MED, INITIALIZE_DVFS_FREQ_MASK(ACTIVE_FREQ_MEDLOW) },
	{ CONFIG_DESKTOP_DVFS_FREQ_LOW, UINT8_MAX },
};
