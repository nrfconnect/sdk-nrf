...
menu "SCI default connection rate parameters"
...
# connections as the central's default window
...
config DESKTOP_BLE_CONN_PARAMS_SCI_INTERVAL_MAX_125US
	...
	default 120
	range DESKTOP_BLE_CONN_PARAMS_SCI_INTERVAL_MIN_125US 32000
	help
...
config DESKTOP_BLE_CONN_PARAMS_SCI_SUBRATE_MIN
...
config DESKTOP_BLE_CONN_PARAMS_SCI_SUBRATE_MAX
	int "Subrate factor maximum"
	default 4
	range DESKTOP_BLE_CONN_PARAMS_SCI_SUBRATE_MIN 500
	help
...
config DESKTOP_BLE_CONN_PARAMS_SCI_CONTINUATION_NUM
...
config DESKTOP_BLE_CONN_PARAMS_SCI_SUPERVISION_TIMEOUT_10MS
