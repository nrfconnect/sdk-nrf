...
.. note::
   ...
   If initialization of SLM fails, the application will send ``INIT ERROR\r\n`` message on UART if it has been capable of enabling the UART.
   More information about the error can be found in the logs.
