...
static constexpr uint8_t kBridgedOnOffLightSwitchEndpointVersion = 3;
...
static constexpr uint8_t kLightSwitchDataVersionSize = MATTER_ARRAY_SIZE(bridgedLightSwitchClusters);
