...
#define GENERATED_ATTRIBUTES                                                                                                           \
	{                                                                                                                              \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x0000000A, 65, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* SoftwareVersionString \
													       */                      \
		{ ZAP_EMPTY_DEFAULT(), 0x0000000B, 17, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* ManufacturingDate     \
													       */                      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		...
		{ ZAP_CLUSTER_INDEX(14), 2, 0 },                                                                       \
		{ ZAP_CLUSTER_INDEX(16), 11, 683 },                                                                    \
	}
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 4 }, { 0x0000000E, 2 }, { 0x00000100, 3 } }
