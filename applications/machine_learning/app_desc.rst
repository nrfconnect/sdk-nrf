...
If you want to build the application for the nRF54H20 DK in the dual-core mode, the configuration files for the Peripheral Processor (PPR) image are located in the :file:`applications/machine_learning/remote` folder.
