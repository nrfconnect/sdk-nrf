...
* Thingy:53 supports sensor sleeping functionality - sensor stops sampling when there is no activity
  and resumes it when movement was detected.
...
* Thingy:52 and Thingy:53 display the application state in the RGB scale.
  ...
  * If sensor enters into sleep mode LED would generate short blinks.

    * In machine learning mode LED would blink in green color.
    * In data forwarder it would blink in red color
