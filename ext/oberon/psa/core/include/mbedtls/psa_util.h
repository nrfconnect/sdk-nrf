...
//static mbedtls_f_rng_t *const mbedtls_psa_get_random = mbedtls_ctr_drbg_random;   /* !!OM */
...
//static mbedtls_f_rng_t *const mbedtls_psa_get_random = mbedtls_hmac_drbg_random;   /* !!OM */
#endif
