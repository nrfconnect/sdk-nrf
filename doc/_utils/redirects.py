...
NRF = [
    ...
    ("config_and_build/pin_control", "config_and_build/hardware/pin_control"),
    ("config_and_build/use_gpio_pin_directly", "config_and_build/hardware/use_gpio_pin_directly"),
