...
NRF = [
    ...
    ("protocols/wifi/powersave","protocols/wifi/station_mode/powersave.rst"),
    ...
    ("protocols/wifi/raw_tx_operation","protocols/wifi/advanced_modes/raw_tx_operation.rst"),
    ...
    ("protocols/wifi/scan_operation","protocols/wifi/scan_mode/scan_operation.rst"),
