...
The following sections list the supported cryptographic features and algorithms for each of the Nordic Semiconductor device Series and cryptographicdrivers: :ref:`nrf_cc3xx <crypto_drivers_cc3xx>`, :ref:`CRACEN <crypto_drivers_cracen>`, and :ref:`nrf_oberon <crypto_drivers_oberon>`.
...
The options are grouped by Series and driver, and support for each device is listed.
   ...
   .. tab:: nRF53 Series
      ...
      .. tabs::
         ...
         .. tab:: nrf_cc3xx
            ...
            .. note::
               - :kconfig:option:`CONFIG_PSA_WANT_ALG_RSA_PKCS1V15_SIGN` is limited to RSA key sizes ≤ 2048 bits.
               - :kconfig:option:`CONFIG_PSA_WANT_ALG_RSA_PKCS1V15_SIGN_RAW` is limited to RSA key sizes ≤ 2048 bits.
            ...
            .. list-table:: Asymmetric signature driver support (nrf_cc3xx driver) - nRF52 Series
               ...
               * - :kconfig:option:`CONFIG_PSA_USE_CC3XX_ASYMMETRIC_SIGNATURE_DRIVER`
                 - | :kconfig:option:`CONFIG_PSA_WANT_ALG_ECDSA`
                   ...
                   | :kconfig:option:`CONFIG_PSA_WANT_ALG_DETERMINISTIC_ECDSA`
                   | :kconfig:option:`CONFIG_PSA_WANT_ALG_PURE_EDDSA`
                   | :kconfig:option:`CONFIG_PSA_WANT_ALG_RSA_PKCS1V15_SIGN` (limited to RSA key sizes ≤ 2048 bits)
                   | :kconfig:option:`CONFIG_PSA_WANT_ALG_RSA_PKCS1V15_SIGN_RAW` (limited to RSA key sizes ≤ 2048 bits)
