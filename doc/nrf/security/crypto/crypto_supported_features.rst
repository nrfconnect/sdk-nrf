...
The tables are also available on the :ref:`software_maturity` page.
...
The following sections list the supported cryptographic features and algorithms and the Kconfig options to enable them.

.. note::
   Cryptographic features and algorithms that are not listed are to be considered not supported by Oberon PSA Crypto in the |NCS|.
...
.. list-table:: Key management support per driver
   ...
   * - :ref:`nrf_security_drivers_cracen`
     - :kconfig:option:`CONFIG_PSA_USE_CRACEN_KEY_MANAGEMENT_DRIVER`
     - AES, Chacha20, ECC Key Pair, ECC Public Key, RSA Key Pair, RSA Public Key
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled key types. Acts as fallback for the other drivers.
     - AES, Chacha20, ECC Key Pair, ECC Public Key, RSA Key Pair, RSA Public Key

Cipher modes and drivers
========================
...
.. list-table:: Cipher driver support
   ...
   * - :ref:`nrf_security_drivers_cracen`
     ...
     - ECB no padding, CBC no padding, CBC PKCS#7 padding, CTR, Stream cipher
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled cipher modes. Acts as fallback for the other drivers.
...
Key agreement algorithms and drivers
====================================
...
.. note::
   The algorithm support when using ECC key types is dependent on one or more Kconfig options enabling curve support according to `ECC curve types and drivers`_.
...
.. list-table:: Key agreement driver support
   ...
   * - :ref:`nrf_security_drivers_cracen`
     ...
     - ECDH
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled key agreement algorithms. Acts as fallback for the other drivers.
     - ECDH (limited to curve types secp224r1, secp256r1, secp384r1, and Curve25519)

Key derivation function algorithms and drivers
==============================================
...
.. list-table:: KDF driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled KDF algorithms. Acts as fallback for the other drivers.
     - HKDF, HKDF-Extract, HKDF-Expand, PBKDF2-HMAC, PBKDF2-AES-CMAC-PRF-128, TLS 1.2 PRF, TLS 1.2 PSK to MS, TLS 1.2 EC J-PAKE to PMS

MAC algorithms and drivers
==========================

The following table shows the Kconfig options for requesting Oberon PSA Crypto to use specific MAC algorithms, as well as their support for each driver:
...
.. list-table:: MAC driver support
   ...
   * - :ref:`nrf_security_drivers_cracen`
     ...
     - CMAC, HMAC
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled MAC algorithms. Acts as fallback for the other drivers.
     - CMAC, HMAC

AEAD algorithms and drivers
===========================
...
.. list-table:: AEAD driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled AEAD algorithms. Acts as fallback for the other drivers.
     - CCM, GCM, ChaCha20-Poly1305

Asymmetric signature algorithms and drivers
===========================================
...
.. list-table:: Asymmetric signature driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled asymmetric signature algorithms. Acts as fallback for the other drivers.
...
Asymmetric encryption algorithms and drivers
============================================
...
.. list-table:: Asymmetric encryption driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled asymmetric encryption algorithms. Acts as fallback for the other drivers.
     - RSA OAEP, RSA PKCS#1 v1.5 crypt (does not support RSA key pair generation)

ECC curve types and drivers
===========================
...
.. list-table:: ECC curve driver support
   ...
   * - :ref:`nrf_security_drivers_cracen`
     - :kconfig:option:`CONFIG_PSA_USE_CRACEN_KEY_MANAGEMENT_DRIVER`
     - BrainpoolP192r1, BrainpoolP224r1, BrainpoolP256r1, BrainpoolP320r1, BrainpoolP384r1, BrainpoolP512r1, Curve25519 (X25519), Curve448 (X448), Edwards25519 (Ed25519), Edwards448 (Ed448), secp192k1, secp256k1, secp192r1, secp224r1, secp256r1, secp384r1, secp521r1
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled ECC curve types. Acts as fallback for the other drivers.
     - Curve25519 (X25519), Edwards25519 (Ed25519), secp224r1, secp256r1, secp384r1

RNG algorithms and drivers
==========================
...
.. list-table:: RNG driver support
   ...
   * - :ref:`nrf_security_drivers_cracen`
     ...
     - CTR-DRBG
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled RNG algorithms. Acts as fallback for the other drivers.
     - CTR-DRBG, HMAC-DRBG (software implementation, entropy provided by nRF RNG peripheral)

Hash algorithms and drivers
===========================
...
.. list-table:: Hash driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled hash algorithms. Acts as fallback for the other drivers.
     - SHA-1 (weak), SHA-224, SHA-256, SHA-384, SHA-512

Password-authenticated key exchange algorithms and drivers
==========================================================
...
.. list-table:: PAKE driver support
   ...
   * - :ref:`nrf_security_drivers_oberon`
     - Configuration automatically generated based on the user-enabled PAKE algorithms. Acts as fallback for the other drivers.
     - EC J-PAKE, SPAKE2+ with HMAC, SPAKE2+ with CMAC, SPAKE2+ for Matter, SRP-6, SRP-6 password hashing
