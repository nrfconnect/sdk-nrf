...
* For the :ref:`TF-M Crypto Service implementation <ug_crypto_architecture_implementation_standards_tfm>`, enable :kconfig:option:`CONFIG_NRF_SECURITY` and :kconfig:option:`CONFIG_BUILD_WITH_TFM` Kconfig options.
