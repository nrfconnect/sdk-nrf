...
It has :ref:`specific sizing requirements <ug_tfm_partitioning_its_sizing>` and must not be accessed directly by a user application :ref:`placed in the Non-Secure Processing Environment <app_boards_spe_nspe_cpuapp_ns>`.
...
The PS service partition has :ref:`specific sizing requirements <ug_tfm_partitioning_ps_sizing>`.
