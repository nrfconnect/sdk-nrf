...
See the `psa/crypto.h`_ file for versioning.
...
See the `psa/protected_storage.h`_ file for versioning.
...
The PSA Protected Storage API implementation in the |NCS| does not support storing data to external flash.
...
See `psa/initial_attestation.h`_ for versioning.
