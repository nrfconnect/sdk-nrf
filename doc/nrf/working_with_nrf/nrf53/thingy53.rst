...
Use the options :kconfig:option:`CONFIG_MCUMGR_GRP_IMG` and :kconfig:option:`CONFIG_MCUMGR_GRP_OS`.

You also have to enable the MCUmanager processing of basic Zephyr group commands and storage erase commands.
Use the options :kconfig:option:`CONFIG_MCUMGR_GRP_ZBASIC` and :kconfig:option:`CONFIG_MCUMGR_GRP_ZBASIC_STORAGE_ERASE`.
