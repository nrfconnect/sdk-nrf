...
* :ncs-file:`/drivers/wifi/nrf71/inc/common/fw_if/nrf71_wifi_common.h` - Common message headers, system-level commands, and events.
* :ncs-file:`/drivers/wifi/nrf71/inc/common/fw_if/nrf71_wifi_ctrl.h` - Control path commands and events (UMAC interface).
* :ncs-file:`/drivers/wifi/nrf71/inc/common/fw_if/nrf71_wifi_rf.h` - RF and baseband control parameters.
* :ncs-file:`/drivers/wifi/nrf71/inc/common/fw_if/nrf71_wifi_debug_stats.h` - Debug and statistics interface.
