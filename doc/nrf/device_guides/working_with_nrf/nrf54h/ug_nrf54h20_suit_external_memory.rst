...
#. Build and flash the application by completing the following:
...
#. Use the `nRF Connect Device Manager`_ mobile app to update your device with the new firmware by completing the following:
   ...
   #. Press the :guilabel:`SELECT FILE` button and select the :file:`suit.zip` archive.
