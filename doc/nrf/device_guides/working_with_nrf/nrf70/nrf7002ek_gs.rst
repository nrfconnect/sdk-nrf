...
To build for the nRF7002 EK and the nRF7002 IC with nRF5340 DK, use the ``nrf5340dk/nrf5340/cpuapp`` board target with the CMake ``SHIELD`` variable set to ``nrf7002ek``.
