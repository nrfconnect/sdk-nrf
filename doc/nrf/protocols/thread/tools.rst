...
.. note::
   The nRF Sniffer for 802.15.4 is intended to be used for development and testing purposes.
...
.. note::
   The nRF Thread Topology Monitor is intended to be used for development and testing purposes.
...
For example, you can use the Docker container when you want to establish IP communication between an application running on Linux, and an application running on a Thread node.
...
.. note::
   All the mentioned applications: ``ot-cli``, ``ot-daemon``, and ``ot-ctl`` are intended to be used for development and testing purposes.
