...
The PSA Internal Trusted Storage (ITS) is an encrypted storage within the Zephyr Setting or dedicated partition that can be used to store the Thread cryptographic materials.
...
.. list-table:: Thread cryptographic materials
   ...
   * - Commissioning Credential
     - Human readable commissioning credential used to form the PSKc key.
     - Volatile
     - Password
     - 8-255 bytes
     - 1
