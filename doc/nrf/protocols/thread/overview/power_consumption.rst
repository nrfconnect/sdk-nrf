...
.. tabs::
   ...
   .. group-tab:: Thread 1.3 SED
      ...
      .. table:: Power consumption
         ...
         +-------------------------------+-------------------+
         | Parameter                     | nrf5340dk_nrf5340 |
         +===============================+===================+
         | Average sleep current [μA]    |              4.02 |
         +-------------------------------+-------------------+
         | Average data poll charge [μC] |             20.11 |
         +-------------------------------+-------------------+
         | Total charge per minute [mC]  |              1.57 |
         +-------------------------------+-------------------+
   ...
   .. group-tab:: Thread 1.3 SSED
      ...
      .. table:: Configuration
         ...
         | CSL timeout [s]               |    20 |
         +-------------------------------+-------+
         | Parent's CSL uncertainty [μs] |  ±200 |
         +-------------------------------+-------+
         | Parent's CSL accuracy [ppm]   |    ±5 |
         +-------------------------------+-------+
      ...
      .. table:: Power consumption
         ...
         | Average sleep current [μA]      |              4.02 |
         +---------------------------------+-------------------+
         | Average CSL receive charge [μC] |             14.31 |
         +---------------------------------+-------------------+
         | Total charge per minute [mC]    |              1.25 |
         +---------------------------------+-------------------+
