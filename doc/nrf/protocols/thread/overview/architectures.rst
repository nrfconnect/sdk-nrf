...
.. list-table:: Thread architecture options
   ...
   * - Integrates Zephyr networking features, such as Sockets, IPv6, DNS, DHCPv6, zperf, etc.
...
Depending on the integration with the Zephyr networking layer or not, there are two different designs:

.. tabs::

  .. tab:: Integration with Zephyr networking layer
  ...
  .. tab:: Direct IEEE 802.15.4 radio integration with OpenThread stack
