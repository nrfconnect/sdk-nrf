...
|                        |                                      |                      |              |             | The usage of NFC onboarding is the only use case that requires the passcode to be present in the factory data, nevertheless including it in the same partition as the SPAKE2+ verifier violates the specification.          |
+------------------------+--------------------------------------+----------------------+--------------+-------------+-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------+
