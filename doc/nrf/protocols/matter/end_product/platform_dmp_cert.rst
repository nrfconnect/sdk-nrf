...
+===================+===================+=====================+=====================+==================+====================================================+==========================================+
| 3.1.1             | 1.4.2             | |NCS|               | CSA25001MCPM0001-24 | Thread, BLE      | `Matter nRF Connect SDK Platform Certificate`_     | nRF52 family, nRF53 family, nRF54 family |
+-------------------+-------------------+---------------------+---------------------+------------------+----------------------------------------------------+------------------------------------------+
...
If you need more information about which test cases have been executed on the platform during certification, you can request the official Test Report for the certified platform (which includes the list of executed test cases) via the `DevZone`_.
...
Are the Matter samples in the |NCS| certified or can they be used as certified implementations?
   No, the Matter samples included in the |NCS| are not certified and are not part of the compliant platform. They are maintained to closely follow the Matter specification for reference and development purposes, but should not be considered certified implementations. For certification, you must use the platform as described in the certified configuration and follow the official certification process.
