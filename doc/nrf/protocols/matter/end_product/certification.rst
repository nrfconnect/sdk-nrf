...
With FastTrack, you can test updated products and obtain a Matter certification of the result.
...
The conformance of every certified Matter product is initially validated by an Alliance-approved Authorized Test Lab (ATL), but with FastTrack, you can validate the conformance of software updates to your certified Matter product without returning to the ATL.
