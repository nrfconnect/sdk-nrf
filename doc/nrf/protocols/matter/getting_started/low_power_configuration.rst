...
* For the nRF54L15, nRF54LC10, and nRF54LM20 DK, the MOSFET transistors controlling the LEDs are included in the measurement circuit.
  ...
  To measure the current consumption of the nRF54L15, nRF54LC10, or nRF54LM20 SoC without including development kit components, such as LEDs, it is recommended to disable them.
