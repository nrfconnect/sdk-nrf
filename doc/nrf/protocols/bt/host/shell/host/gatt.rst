...
Another option available through the GATT command is initiating the MTU exchange using the
:code:`gatt exchange-mtu` command.
To update the shell maximum MTU, you need to update the Kconfig options in the configuration file of
the shell.
