...
Some of the features the Bluetooth Mesh in |NCS| can offer are:
...
The Bluetooth Mesh in the |NCS| supports all mandatory features of the `Bluetooth Mesh profile specification`_ and the `Bluetooth Mesh model specification`_, as well as most of the optional features.
