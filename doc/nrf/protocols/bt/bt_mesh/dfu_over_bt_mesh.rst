...
Additionally, the metadata string and firmware ID required by the ``mesh models dfu slot add`` command are printed in the command-line window when the application is built::
