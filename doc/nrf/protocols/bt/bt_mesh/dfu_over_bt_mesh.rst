...
.. tabs::
   ...
   .. group-tab:: Shell
      ...
      * Through the shell management subsystem of MCU manager (for example, using the `nRF Mesh mobile app for Android`_ or :ref:`Mcumgr command-line tool <dfu_tools_mcumgr_cli>`).
...
.. tabs::
   ...
   .. group-tab:: nRF Mesh app (iOS)
      ...
      #. To remove a slot: swipe left on the slot and tap :guilabel:`Delete` or to remove all slots: click :guilabel:`Delete All`.
