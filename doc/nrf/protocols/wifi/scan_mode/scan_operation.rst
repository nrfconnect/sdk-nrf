...
.. note::
   The timing and current measurements, the energy profile values, and the figures in this section are for the nRF70 companion ICs.
   Other nRF Wi-Fi device families can have different bands and power characteristics.
