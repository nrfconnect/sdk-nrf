...
To create a P2P group and start as the Group Owner (GO), use the following commands:
...
This command creates a P2P group with the device acting as the Group Owner, allowing other devices to connect to it.
