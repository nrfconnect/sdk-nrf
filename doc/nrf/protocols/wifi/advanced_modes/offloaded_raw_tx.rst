...
The offloaded raw transmit operation is supported as a separate stand-alone compile-time mode of operation in the :ref:`nrf700x_wifi` and is exclusive to the following existing modes of operation:
...
* Transmit power : Power consumption increases as the transmit power is increases.

See https://devzone.nordicsemi.com/power/w/opp/14/online-power-profiler-for-wi-fi for simulated power profile.
