...
The Nordic Semiconductor Wi-Fi device supports :term:`Software-enabled Access Point (SoftAP or SAP)` mode.
...
Nordic Wi-Fi devices support Wi-Fi provisioning using the SoftAP mode as one of the provisioning methods.

Supported functionality and limitations
***************************************

The SAP mode in the Nordic Wi-Fi devices provides SoftAP support with the following limitations:
...
For a typical SAP mode operation, the Nordic Wi-Fi device acts as a virtual router, allowing other station devices to connect to it.
