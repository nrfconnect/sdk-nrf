...
.. note::
   The :ref:`bt_fast_pair_adv_manager_readme` helper module can be configured to automatically handle locator tag guidelines related to the Fast Pair advertising.
