...
#. Determine what revision of the |NCS| you want to work with.
   ...
   * To work with a specific release, the revision is the corresponding tag (for example, ``v1.3.1``).
...
#. Initialize west with the revision of the |NCS| that you want to check out, replacing *NCS_revision* with the revision:
   ...
   For example, to check out the v1.3.1 release, enter the following command::
...
For example, to switch to release v1.3.1 of the |NCS|, enter the following commands in the ``ncs/nrf`` directory::
