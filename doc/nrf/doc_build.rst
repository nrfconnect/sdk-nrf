...
In addition to these tools, you must install `mscgen`_ and make sure the :file:`mscgen` executable is in your ``PATH``.

.. note::
   On Windows, the Sphinx executable :file:`sphinx-build.exe` is placed in the :file:`Scripts` folder of your Python installation path.
