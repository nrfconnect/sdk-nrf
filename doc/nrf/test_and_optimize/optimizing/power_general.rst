...
It is optimized for low power operation on the ``nrf9151dk/nrf9151/ns``, ``nrf9161dk/nrf9161/ns``, or ``nrf9160dk/nrf9160/ns`` board target without any modifications.
