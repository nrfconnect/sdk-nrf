...
For reference, you can find minimal footprint configurations of the :ref:`peripheral_lbs` sample in :ncs-file:`/samples/bluetooth/peripheral_lbs/prj_minimal.conf` and the :ref:`peripheral_uart` sample in :ncs-file:`/samples/bluetooth/peripheral_uart/prj_minimal.conf`.
