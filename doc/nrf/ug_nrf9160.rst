...
* ``nrf9160dk_nrf9160`` for the Secure Processing Environment (SPE) only.
* ``nrf9160dk_nrf9160_ns`` for adding the Non-Secure Processing Environment (NSPE) alongside SPE.
