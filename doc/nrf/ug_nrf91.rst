...
Devices in the nRF91 Series are supported by these boards in the Zephyr open source project and in |NCS|.
...
.. list-table::
   ...
   * - Thingy91
     - PCA20035
     - ``thingy91_nrf9160_ns``
     - | `Product Specification <Thingy91 Product Specification_>`_
...
.. note::
   ...
   For Thingy:91 the build target has changed to ``thingy91_nrf9160_ns`` from ``thingy91_nrf9160ns``
