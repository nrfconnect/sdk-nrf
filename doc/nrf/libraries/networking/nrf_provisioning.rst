...
When the :kconfig:option:`CONFIG_NRF_PROVISIONING_AUTO_START_ON_INIT` Kconfig is set, the library initializes and starts provisioning according to the configured interval.
