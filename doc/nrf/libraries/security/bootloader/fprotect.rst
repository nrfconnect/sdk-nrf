...
To enable the hardware flash write protection driver, set the :kconfig:option:`CONFIG_FPROTECT` Kconfig option.

For additional configuration options, see other `CONFIG_FPROTECT_*`_ Kconfig options.
