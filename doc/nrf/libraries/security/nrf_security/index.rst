...
* Hardware acceleration through dedicated cryptographic libraries on selected SoCs (``cc3xx``, ``nrf_oberon``, CRACEN), with binary versions of the libraries listed in :ref:`nrfxlib:crypto`
* Software fallbacks when hardware acceleration is unavailable
