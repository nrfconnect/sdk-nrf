...
The PSA Crypto in the |NCS| provides secure crypto operations via standardized :ref:`Platform Security Architecture <ug_psa_certified_api_overview>`.
...
To enable the :ref:`nrf_security_drivers_cc3xx` driver, set the :kconfig:option:`CONFIG_PSA_CRYPTO_DRIVER_CC3XX` Kconfig option.
...
To enable the :ref:`nrf_security_drivers_cracen` driver, set the :kconfig:option:`CONFIG_PSA_CRYPTO_DRIVER_CRACEN` Kconfig option.
