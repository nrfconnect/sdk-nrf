...
All sensor formats and sensor types are collected in the :ncs-file:`/include/bluetooth/mesh/sensor_types.h` file, and are divided into the categories listed in the page index.
