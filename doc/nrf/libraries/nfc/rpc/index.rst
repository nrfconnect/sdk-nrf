...
The NFC RPC solution consists of the following components:
  ...
  * NFC RPC Server, the Type 4 or/and Type 2 Tag library and common libraries that enable communication with NFC RPC Client.
    This software needs to run on a device or CPU that has NFC radio hardware peripheral.
