...
Connection Parameters Evaluation:
  Use the :kconfig:option:`CONFIG_LTE_LC_CONN_EVAL` Kconfig option to enable the following functionality related to Connection Parameters Evaluation:

  * :c:func:`lte_lc_conn_eval_params_get`

eDRX (Extended Discontinuous Reception):
  Use the :kconfig:option:`CONFIG_LTE_LC_EDRX` Kconfig option to enable all the following functionalities related to eDRX:
...
Neighboring Cell Measurements:
  Use the :kconfig:option:`CONFIG_LTE_LC_NEIGHBOR_CELL_MEAS` Kconfig option to enable all the following functionalities related to Neighboring Cell Measurements:
...
Periodic Search Configuration:
  Use the :kconfig:option:`CONFIG_LTE_LC_PERIODIC_SEARCH` Kconfig option to enable all the following functionalities related to Periodic Search Configuration:
...
PSM (Power Saving Mode):
  Use the :kconfig:option:`CONFIG_LTE_LC_PSM` Kconfig option to enable all the following functionalities related to PSM:
...
Release Assistance Indication (RAI):
  Use the :kconfig:option:`CONFIG_LTE_LC_RAI` Kconfig option to enable the following functionalities related to RAI:

  * :c:enumerator:`LTE_LC_EVT_RAI_UPDATE` events
  * :kconfig:option:`CONFIG_LTE_RAI_REQ`

Modem Sleep Notifications:
  Use the :kconfig:option:`CONFIG_LTE_LC_MODEM_SLEEP` Kconfig option to enable all the following functionalities related to Modem Sleep Notifications:
...
Tracking Area Update (TAU) Pre-warning:
  Use the :kconfig:option:`CONFIG_LTE_LC_TAU_PRE_WARNING` Kconfig option to enable the following functionalities related to TAU Pre-warning:
...
To enable this module, use the :kconfig:option:`CONFIG_LTE_LC_CONN_EVAL` Kconfig option.
