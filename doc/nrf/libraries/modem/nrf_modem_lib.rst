...
If the modem trace transport is unable to keep up with the modem traces, the heap size can be increased by configuring :kconfig:option:`CONFIG_NRF_MODEM_LIB_TRACE_MEDIUM_UART`.
