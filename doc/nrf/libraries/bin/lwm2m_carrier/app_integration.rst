...
* :c:macro:`LWM2M_CARRIER_EVENT_ERROR`:
  ...
  * Following are the valid error codes:
    ...
    * :c:macro:`LWM2M_CARRIER_ERROR_BOOTSTRAP` - This error is generated during the bootstrap procedure.
      ...
      +--------------------------------------------------------+-----------------------------------------------------------------------------+--------------------------------------------------+
      | Failure to fetch MSISDN or ICCID values (``-EFAULT``). | These values are received from the network.                                 | Library will retry upon next network connection. |
      |                                                        | If they have not been issued yet, the bootstrap process can not proceed.    |                                                  |
      +--------------------------------------------------------+-----------------------------------------------------------------------------+--------------------------------------------------+
