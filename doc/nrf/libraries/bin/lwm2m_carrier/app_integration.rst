...
* |NCS| modules:
  ...
  * :ref:`lib_uicc_lwm2m`
  ...
  The inclusion of the :ref:`lib_uicc_lwm2m` library is optional via the :kconfig:option:`CONFIG_UICC_LWM2M` Kconfig option.
  This module allows the LwM2M carrier library to use the bootstrap information stored on the SIM card. If present, the configuration in the SIM will take precedence over any other configuration.
