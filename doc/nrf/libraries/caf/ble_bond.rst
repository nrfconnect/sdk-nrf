...
#. Set the :kconfig:option:`CONFIG_CAF_BLE_BOND_PEER_ERASE_CLICK_TIMEOUT` Kconfig option to specify the waiting time for detecting the button click after boot.
