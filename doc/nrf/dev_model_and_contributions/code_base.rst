...
+----------------------------+----------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
| ``MAJOR.MINOR.PATCH-csN``  | Customer sampling tag, marked through a postfix added to the end of the    | Not part of the regular release cycle. Designed specifically to support early adopters working with specific devices.                |
|                            | version. Indicates a snapshot of the development state that is tailored    | For this reason, it has a narrow scope and all of the functionalities it introduces are to be considered experimental.               |
|                            | exclusively for participants in a customer sampling program.               | If you are not participating in the customer sampling program, use the latest stable release of |NCS|.                               |
|                            |                                                                            | The ``-csN`` version might not be subjected to the same amount of testing as a regular |NCS| release.                                |
+----------------------------+----------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------------------------------------+
