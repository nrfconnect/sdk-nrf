...
* Fixed a bug where a user-defined HEX file that was provided in the static configuration of the partition_manager was not included in the merge operation.
