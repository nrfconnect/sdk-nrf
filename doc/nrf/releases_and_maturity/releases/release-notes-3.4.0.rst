...
* Updated the ``matter_window_covering_sample`` sample to use the Thread Sleepy End Device (SED) device type by default.
...
* Removed:
  ...
  * The AWS IoT integration variant from the ``matter_light_bulb_sample`` sample.
