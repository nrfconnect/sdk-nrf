...
* Added :ref:`experimental support <software_maturity>` for the following features:
  ...
  * PMIC: nPM1300 PMIC and nPM1300 EK:
    ...
    * Sample showing fuel gauge functionality.
...
* Added the nPM1300: Fuel gauge sample that demonstrates how to calculate the battery state of charge using the :ref:`nrfxlib:nrf_fuel_gauge`.
