...
* Updated:
  ...
  * The :ref:`ug_nrf54h20_ironside_snapshot` page by adding a note about the snapshot services limitations.
  * The :ref:`abi_compatibility` by adding a section about |ISE| known issues.
