...
* Updated:
  ...
  * The :ref:`ug_wifi` documentation to be agnostic to the Nordic Wi-Fi device family, moving the pages specific to the nRF70 Series (Wi-Fi stack configuration and performance, debugging, and certification) under :ref:`ug_nrf70`.
