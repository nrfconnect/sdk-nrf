...
* Added the :ref:`secure_application_pairing_sample` sample that demonstrates certificate-based authentication of Bluetooth LE application peers and protected transfer of application payloads.
