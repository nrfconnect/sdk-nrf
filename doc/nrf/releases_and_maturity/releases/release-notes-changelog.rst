...
* Update KMU mapping to ``BL_PUBKEY`` when MCUboot is used as the immutable bootloader for nRF54L Series devices.
...
* added support for S2RAM resume on nRF54h20 devices. Mcuboot act as the S2RAM resume mediator and redirects execution
  to the application native resume routine.
