...
* Updated:
  ...
  * The :ref:`nrf_desktop_dfu_mcumgr` to enable the bootloader information hook that is intended for SUIT-based DFU (see the :kconfig:option:`CONFIG_MGMT_SUITFU_GRP_OS_BOOTLOADER_INFO_HOOK` Kconfig option).
