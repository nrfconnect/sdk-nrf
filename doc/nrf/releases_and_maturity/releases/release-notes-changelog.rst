...
* Added:
  ...
  * The ``CONFIG_CRACEN_KMU_ALLOW_ANY_AEAD_TAG_LENGTH`` Kconfig option, which allows to store keys for AEAD algorithms with non-default (shortened)
	  tag lengths in the KMU.
