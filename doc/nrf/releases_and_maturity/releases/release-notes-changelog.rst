...
* Removed:
  ...
  * The standalone pages for getting started with Nordic Thingy:91.
  ...
  * The standalone pages for getting started with the nRF9160 DK.
    This pages have been replaced by the `Quick Start app`_ that supports the nRF9160 DK.
