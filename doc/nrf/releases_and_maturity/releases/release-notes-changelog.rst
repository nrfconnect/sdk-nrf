...
* Updated:
  ...
  * Removed support and integration for curve types smaller than 224 bytes from the :ref:`CRACEN driver <crypto_drivers_cracen>`.
    Also removed integration for some curve types that were marked as unsupported.
