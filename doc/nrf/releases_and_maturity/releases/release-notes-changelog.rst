...
* Updated:
  ...
  * The Identify cluster implementation in all Matter samples to use the code-driven approach instead of the zap-driven approach.
...
* Updated the :ref:`matter_weather_station_app` sample to use the code-driven approach for the Identify cluster implementation instead of the zap-driven approach.
