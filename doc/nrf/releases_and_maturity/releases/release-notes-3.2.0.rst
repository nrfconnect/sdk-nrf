...
* Added:
  ...
  * The new code-driven approach for the Matter Data Model and Cluster configuration handling.
    ...
    See the `migration guide <Migration notes for nRF Connect SDK v3.2.0_>`_ for more information.
...
* nrfx 4.0 has been released.
  ...
  For details on Zephyr changes, see the `migration guide <Migration notes for nRF Connect SDK v3.2.0_>`_.
