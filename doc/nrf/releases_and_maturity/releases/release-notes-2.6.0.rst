...
* nRF Cloud:
  ...
  * The nRF Cloud multi-service sample now includes experimental support for the following:
    ...
    * Better out-of-box experience by using the new nRF Cloud Security Services auto-onboarding feature.
...
* Added:
  ...
  * The nRF70 Series firmware patch update section that describes how to perform a DFU for firmware patches using Wi-Fi in the :ref:`ug_nrf70_developing` user guide (this feature was later removed).
...
* Added:
  ...
  * The ``CONFIG_NRF_WIFI_FW_PATCH_DFU`` Kconfig option that enables DFU support for nRF70 Series devices (this option was later removed).
...
* :ref:`lib_nrf_cloud` library:
  ...
  * Added:
    ...
    * The :file:`nrf_cloud_fota_poll.c` file to consolidate the FOTA polling code from the nRF Cloud multi-service and Cellular: nRF Cloud REST FOTA samples.
