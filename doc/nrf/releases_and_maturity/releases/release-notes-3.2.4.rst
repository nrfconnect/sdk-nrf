...
This patch release adds the following changes on top of the :ref:`nRF Connect SDK v3.2.3 <ncs_release_notes_323>` and :ref:`nRF Connect SDK v3.2.2 <ncs_release_notes_322>` and :ref:`nRF Connect SDK v3.2.1 <ncs_release_notes_321>` and :ref:`nRF Connect SDK v3.2.0 <ncs_release_notes_320>`:
.. TODO
