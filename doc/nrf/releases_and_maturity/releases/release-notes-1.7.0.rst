...
* Added:
  ...
  * Matter Template sample with a guide about creating a new Matter application.
...
* Added pages:
  ...
  * Added the Matter Weather Station application page.
...
* Updated pages:
  ...
  * :ref:`protocols` section pages:
    ...
    * Matter pages:
      ...
      * Matter Tools page - New page.
      * Matter Creating Accessory page - New page.
