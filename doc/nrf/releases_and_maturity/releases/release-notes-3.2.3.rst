...
* nRF54H20:
  ...
  * Added:
    ...
    * Support for the peripheral configuration (PERIPHCONF) service in the IronSide SE binary firmware (from IronSide SE v23.3.0+26).
    * Support in MCUboot for using the new IronSide service to load PERIPHCONF data from firmware images, enabling MCUboot to perform DFU updates of these PERIPHCONF blobs.
