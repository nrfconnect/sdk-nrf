...
* :ref:`matter_template_sample` sample:
  ...
  * Added support for the ``nrf54l15dk/nrf54l10/cpuapp`` build target.
...
* :ref:`ot_coprocessor_sample` sample:
  ...
  * Added support for the ``nrf54l15dk/nrf54l10/cpuapp`` and ``nrf54l15dk/nrf54l05/cpuapp`` build targets.
