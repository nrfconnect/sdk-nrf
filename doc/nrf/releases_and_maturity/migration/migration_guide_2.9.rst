...
Migration notes for |NCS| v2.9.0
################################
...
.. toggle::
   ...
   * For the Matter samples and applications:
      ...
      * The ``ug_matter_device_watchdog`` mode has been changed.
        Previously, the ``ug_matter_device_watchdog_pause_mode`` was enabled by default for all Matter samples.
