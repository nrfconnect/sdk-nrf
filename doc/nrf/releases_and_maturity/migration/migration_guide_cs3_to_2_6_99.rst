...
.. _migration_cs3_to_2_6_99:

Migration notes for |NCS| v2.6.99_dev1 for v2.4.99-cs3 users
############################################################
...
This document describes the changes required or recommended when migrating your application from |NCS| for the nRF54 customer sampling release v2.4.99-cs3 to |NCS| v2.6.99_dev1.

nRF54H20 PDK revision and compatibility
***************************************

To ensure the nRF54H20 PDK runs its components correctly, verify its compatibility with your release.
Check the version number on your PDK's sticker and refer to the following compatibility matrix:

+----------------------+------------------------------+
| Release version      | nRF54H20 PDK version         |
+======================+==============================+
...
The following tools have been updated for the release of the |NCS| v2.6.99_dev1:

* nRF Command Line Tools to version 10.22.4
* The |NCS| toolchain

To install the new tools, refer to the :ref:`getting_started` section of the |NCS| documentation.

Application migration notes
***************************

This section describes the changes required or recommended when migrating your application from |NCS| for the nRF54 customer sampling release v2.4.99-cs3 to |NCS| v2.6.99_dev1.
