   ...
   * The :ref:`pdn_readme` library has been deprecated in favor of the PDN management functionality provided by the :ref:`lte_lc_readme` library and will be removed in a future |NCS| release.
     ...
     #. Kconfig options:
        ...
        * Replace:
           ...
           * The ``CONFIG_PDN`` Kconfig option with the :kconfig:option:`CONFIG_LTE_LC_PDN_MODULE`
             Kconfig option.

           * The ``CONFIG_PDN_DEFAULTS_OVERRIDE`` and related PDN Kconfig options with the
             corresponding LTE link control PDN defaults options:
     ...
     #. Replace PDN API calls:
        ...
        * Replace the default-context callback registration:
          ...
          * :c:func:`pdn_default_ctx_cb_reg` and :c:func:`pdn_default_ctx_cb_dereg` with :c:func:`lte_lc_register_handler`, and handle PDN events using the :c:member:`lte_lc_evt.pdn` member as documented in the :ref:`lte_lc_pdn`.
