...
.. toggle::
   ...
   * For the Bluetooth Mesh samples and applications, a new sensor API (see :ref:`bt_mesh_sensors_readme`) is introduced with |NCS| v2.6.0.
     ...
     The usage of the new sensor API is demonstrated in samples :ref:`bluetooth_mesh_sensor_client`, :ref:`bluetooth_mesh_nlc_ambient_light_sensor` and :ref:`bluetooth_mesh_light_lc`.
