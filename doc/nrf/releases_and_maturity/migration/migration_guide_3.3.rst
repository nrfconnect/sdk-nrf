...
.. toggle::
   ...
   * The battery measurement configuration for the ``Thingy:53`` board target has changed.
     ...
     This change requires the following configuration updates:
       ...
       * Additionally, you can configure the Power Management module to decrease the power consumption of the voltage divider:
         ...
         * Enable the :kconfig:option:`CONFIG_PM_DEVICE` and :kconfig:option:`CONFIG_PM_DEVICE_RUNTIME` Kconfig options.
