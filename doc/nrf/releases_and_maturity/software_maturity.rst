...
.. _software_maturity_application_nrf_audio:

nRF Audio
=============

The following table indicates the software maturity levels of the support for the :ref:`nrf_audio_app`.

.. toggle::

   .. _software_maturity_application_nrf_audio_table:

   .. list-table:: nRF Audio application feature support
      :header-rows: 1
      :align: center
      :widths: auto
