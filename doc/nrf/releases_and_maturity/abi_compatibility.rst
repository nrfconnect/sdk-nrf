...
IronSide Secure Element (IronSide SE) v23.7.0+30
================================================
...
* The Global Resource Control (GRC) active power domain is now forced to always be on.
...
* IronSide SE now re-requests snapshot recovery during boot if SDROM has reported that snapshot recovery failed. (NCSDK-38309)
