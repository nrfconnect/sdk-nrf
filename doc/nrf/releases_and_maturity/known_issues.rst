...
KRKNWK-20815: The NordicDevKit cluster does not work with the 0.1.0 version of the Matter Cluster Editor PC tool.
  The NordicDevKit cluster from the :ref:`matter_manufacturer_specific_sample` is not supported in the 0.1.0 version of the Matter Cluster Editor PC tool.
  ...
  **Workaround:** Upgrade to the latest version of the Matter Cluster Editor PC tool.
