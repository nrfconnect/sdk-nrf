...
DRGN-29227: Incorrect return parameters from the HCI LE Read Supported States command
   Byte 0 and byte 4 are set correctly; other bits may contain undefined values.
   When :kconfig:option:`CONFIG_BT_SCAN_AND_INITIATE_IN_PARALLEL` is enabled, the controller may incorrectly report scan-and-initiate-in-parallel as unsupported.
