...
NCSDK-21590: :ref:`bluetooth_mesh_nlc_sensor_observer` sample does not compile for nRF52832
  Adding mesh shell support for the :ref:`bluetooth_mesh_nlc_sensor_observer` sample increases the need for RAM.
  The :ref:`bluetooth_mesh_nlc_sensor_observer` sample cannot compile because of RAM shortage.
