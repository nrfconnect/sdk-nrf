...
NCSDK-35186: Host might not delete entry from Resolving List when unpairing
  ...
  **Workaround:** Insert a delay (``k_sleep()``) of a few hundreed milliseconds before calling the :c:func:`bt_unpair` function.
...
NCSDK-36662: The :ref:`nrf_desktop_battery_meas` uses invalid ADC driver configuration
  The used ADC input is invalid because of the configuration misalignment after switching to nrfx v4.0.
  This might result in silently using an invalid pin as input or the :c:func:`adc_channel_setup` function call errors that lead to a fatal error state in the application module right after boot.

  **Workaround:** Manually cherry-pick and apply the commit with the fix from the ``main`` branch (commit hash: ``89bc0c016ae7ce94b540b435efbd6c36035838cf``).
...
OCT-3490: Connection pointer unfeferenced and then used
  In the :file:`bt_mgmt.c` file, the connection pointer for ``disconnected_cb`` might be unreferenced before being sent over zbus.

.. rst-class:: wontfix v3-2-0 v3-1-1 v3-1-0 v3-0-2 v3-0-1 v3-0-0 v2-9-0-nRF54H20-1 v2-9-2 v2-9-1 v2-9-0 v2-8-0 v2-7-0 v2-6-4 v2-6-3 v2-6-2 v2-6-1 v2-6-0 v2-5-3 v2-5-2 v2-5-1 v2-5-0 v2-4-4 v2-4-3 v2-4-2 v2-4-1 v2-4-0 v2-3-0 v2-2-0 v2-1-4 v2-1-3 v2-1-2 v2-1-1 v2-1-0 v2-0-2 v2-0-1 v2-0-0
...
NCSIDB-1173 Reading reset vector does not work with encrypted images
  ...
  The issue affects b0/b1 configurations and configurations that enable the :kconfig:option:`CONFIG_MCUBOOT_VERIFY_IMG_ADDRESS` Kconfig option for the MCUboot build.
