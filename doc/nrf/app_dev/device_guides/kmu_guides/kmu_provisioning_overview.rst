...
Make sure your configuration follows the device datasheet (for example, `KMU - Key management unit <nRF54L15 Key management unit_>`_ in the nRF54L15 datasheet) and the CRACEN driver's expectations.
