...
To see what key types are supported with Protected, Encrypted and Raw usage schemes, refer to the table under :ref:`ug_kmu_guides_supported_key_types`.
...
Additionally, the KMU slots can be provisioned :ref:`for development or for production <ug_kmu_provisioning_methods>`.
