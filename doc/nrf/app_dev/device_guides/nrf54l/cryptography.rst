...
.. note::
   ...
   On nRF54L15, nRF54L10, and nRF54L05 devices, this microcode needs to be uploaded to a special CRACEN RAM area before first use and after reset.
   ...
   See the :ref:`ug_nrf54l_crypto_configuration` section.
