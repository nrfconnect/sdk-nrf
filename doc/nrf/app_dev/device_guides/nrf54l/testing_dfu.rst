...
You can evaluate the DFU functionality by running the :zephyr:code-sample:`smp-svr` sample, which is available for both Bluetooth® LE and serial channels.
...
.. tabs::
   ...
   .. group-tab:: Partition Manager
      ...
      .. parsed-literal::
         ...
         west build -b *board target* -d build/smp_svr_54l zephyr/samples/subsys/mgmt/mcumgr/smp_svr -T sample.mcumgr.smp_svr.bt.nrf54l15dk.ext_flash
   ...
   .. group-tab:: DTS partitioning
      ...
      .. parsed-literal::
         ...
         west build -b *board target* -d build/smp_svr_54l_d zephyr/samples/subsys/mgmt/mcumgr/smp_svr -T sample.mcumgr.smp_svr.bt.nrf54l15dk.ext_flash.pure_dts
