...
.. note::
   Refer to VPR support table for availability and maturity of FLPR targets.

This guide provides instructions on how to build and program the nRF54L development kits.
...
* ``*board target*/cpuflpr``, where FLPR runs from SRAM, which is the recommended method.
...
* ``*board target*/cpuflpr/xip``, where FLPR runs from RRAM.
