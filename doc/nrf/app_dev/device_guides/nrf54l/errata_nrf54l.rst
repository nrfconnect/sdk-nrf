...
:sup:`1` Anomaly workaround appliance frequency can be set using :kconfig:option:`CONFIG_CLOCK_CONTROL_NRF_HFINT_CALIBRATION_PERIOD` and its value must be tuned in accordance to application-specific operating temperature and expected power consumption.
