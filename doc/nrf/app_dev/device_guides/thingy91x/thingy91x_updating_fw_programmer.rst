...
.. tabs::
   ...
   .. group-tab:: Through USB and MCUboot
      ...
      See `Programming modem firmware firmware using MCUboot serial recovery`_ to update the nRF5340 SoC firmware over the MCUboot serial recovery.
...
.. tabs::
   ...
   .. group-tab:: Through USB and MCUboot
      ...
      See `Programming application firmware using MCUboot serial recovery`_ to update the nRF9151 SiP application firmware over the MCUboot serial recovery.
