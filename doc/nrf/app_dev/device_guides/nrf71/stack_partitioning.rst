...
In the nRF71 Series SoCs, the Physical (PHY) and Medium Access Control (MAC) layers of the IEEE 802.11 protocol stack run on the Wi-Fi® sub-system, which is a dedicated processing domain.
