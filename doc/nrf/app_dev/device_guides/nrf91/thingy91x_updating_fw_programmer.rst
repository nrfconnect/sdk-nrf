...
Updating the Thingy:91 X firmware using nrfutil device
######################################################
...
You can use the nrfutil device utility for the following:
...
The following section describes how the firmware of the nRF5340 SoC on the Nordic Thingy:91 X can be updated through USB or with an external debug probe.
...
.. tabs::
   ...
   .. group-tab:: Through USB and MCUboot
      ...
      #. Enter the following command to list the connected devices and their traits::
         ...
         The Nordic Thingy\:91 X will be listed as a Thingy\:91 X UART product and have following details:

         * A 21 character serial number, for example, ``THINGY91X_C2E0AC7F599``.
         * ``mcuboot``, ``nordicUsb``, ``serialPorts``, and ``usb`` traits.


      #. Enter the following command to perform and update both the application and network core of the nRF5340 application core with a multi-image :file:`dfu_application.zip` file:
   ...
   .. group-tab:: Through external debug probe
      ...
      #. Enter the following command to program an application binary to the nRF5340 application core:
      ...
      #. Enter the following command to program an application binary to the nRF5340 network core:
...
The following section describes how the application firmware of the nRF9151 SiP on the Nordic Thingy:91 X can be updated through USB or with an external debug probe.
...
.. tabs::
   ...
   .. group-tab:: Through USB and MCUboot
      ...
      #. Enter the following command to program an application binary to the nRF9151 application core:
