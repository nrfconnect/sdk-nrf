...
* Developer mode -  The application employs a newly generated assembly file.
  ...
  You can enable it by setting the :kconfig:`SB_CONFIG_HPF_DEVELOPER_MODE` Kconfig option, when building for the application core, or :kconfig:`CONFIG_HPF_DEVELOPER_MODE`, when building for the FLPR core only.
