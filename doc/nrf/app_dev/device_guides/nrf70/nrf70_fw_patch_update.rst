...
.. tabs::
    ...
    .. group-tab:: nRF5340 DK
        ...
        #. Set the ``SB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES`` Kconfig option to ``2`` if for build without the network core, or to ``3`` if the network core is used.
        ...
        .. tabs::
            ...
            .. group-tab:: West
                    ...
                    .. code-block:: console
                        ...
                        west build -d nrf5340dk/nrf5340/cpuapp -d -- -D -DSB_CONFIG_WIFI_PATCHES_EXT_FLASH_STORE=y -DCONFIG_NRF_WIFI_FW_PATCH_DFU=y -DSB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES=3

            .. group-tab:: CMake

                    .. code-block:: console

                        cmake -GNinja -Bbuild -DBOARD=nrf5340dk/nrf5340/cpuapp -DSHIELD=nrf7002ek -DSB_CONFIG_WIFI_PATCHES_EXT_FLASH_STORE=y -DCONFIG_NRF_WIFI_FW_PATCH_DFU=y -DSB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES=3 -DAPP_DIR=*app_path* *path_to_zephyr*/share/sysbuild
                        ninja -C build
        ...
        .. tabs::
            ...
            .. group-tab:: West
                    ...
                    .. code-block:: console
                        ...
                        west build -d nrf7002dk/nrf5340/cpuapp -d -- -Dshell_SNIPPET=nrf70-fw-patch-ext-flash -DSB_CONFIG_WIFI_PATCHES_EXT_FLASH_STORE=y -DCONFIG_NRF_WIFI_FW_PATCH_DFU=y -DSB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES=2

            .. group-tab:: CMake

                    .. code-block:: console

                        cmake -GNinja -Bbuild -- -DBOARD=nrf7002dk/nrf5340/cpuapp -Dshell_SNIPPET=nrf70-fw-patch-ext-flash -DSB_CONFIG_WIFI_PATCHES_EXT_FLASH_STORE=y -DCONFIG_NRF_WIFI_FW_PATCH_DFU=y -DSB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES=2 -DAPP_DIR=*app_path* *path_to_zephyr*/share/sysbuild
                        ninja -C build
            ...
            .. group-tab:: nRF Connect for VS Code
                    ...
                    .. code-block:: console
                        ...
                        -- -Dshell_SNIPPET=nrf70-fw-patch-ext-flash -DSB_CONFIG_WIFI_PATCHES_EXT_FLASH_STORE=y -DCONFIG_NRF_WIFI_FW_PATCH_DFU=y -DSB_CONFIG_MCUBOOT_UPDATEABLE_IMAGES=2
