.. _ug_nrf7002eb2_gs:
.. _ug_nrf7002eb2_nrf54l15dk_gs:
.. _ug_nrf7002eb2_nrf54h20dk_gs:
...
The nRF7002 :term:`Expansion Board (nRF7002-EB II)` (PCA63571), part of the `nRF70 Series Family <nRF70 Series product page_>`_, can be used to provide Wi-Fi® connectivity to compatible development or evaluation boards through the nRF7002 Wi-Fi 6 companion IC.

You can use the nRF7002-EB II to provide Wi-Fi connectivity to the :ref:`zephyr:nrf54h20dk_nrf54h20` and :ref:`zephyr:nrf54l15dk_nrf54l15`.
...
For nRF54H20 DK and nRF54L15 DK, refer to the following tables for the pin mapping for these boards. The board sits on the P1 connector of these DKs
...
To build for the nRF7002-EB II, build for the compatible :ref:`board target <app_boards_names>` with the CMake ``SHIELD`` option set to the corresponding shield name.
See :ref:`cmake_options` for instructions on how to provide CMake options.

For example, if you build wi-fi shell sample for nRF54L15 DK on the command line, you can use the following command:
