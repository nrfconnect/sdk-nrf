...
To perform the manual update process using ``nrfutil`` commands, follow these steps:
...
4. Program the |ISE| update firmware:
...
8. Erase the update application:
