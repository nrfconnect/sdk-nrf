...
+----------------------+---------------------------------------------------------------------+
| UICR.RECOVERY        | Holds application-specific parameters used by the recovery          |
|                      | mechanism.                                                          |
+----------------------+---------------------------------------------------------------------+
| UICR.ITS             | Specifies the base address and size of Internal Trusted Storage     |
|                      | for application and radio domains.                                  |
+----------------------+---------------------------------------------------------------------+
...
See the following table for a mapping between the devicetree input used by ``nrf-regtool`` and the resulting output in the automatically migrated :file:`periconf.c` file.
