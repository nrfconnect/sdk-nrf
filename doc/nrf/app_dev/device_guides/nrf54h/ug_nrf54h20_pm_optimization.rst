...
Set these Kconfig options as follows for the application running on the application core:
...
Set these Kconfig options as follows for the application running on the radio core:
...
This wastes energy and incurs overhead from pre-sleep checks.
