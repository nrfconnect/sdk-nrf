...
Both methods require using the :file:`nordic_top.suit` envelope, available inside the nRF54H20 SoC binaries ZIP file in the folder.
...
* There is no need to update the version and sequence number of the manufacturer root manifest if you need to update only the SoC binaries.
