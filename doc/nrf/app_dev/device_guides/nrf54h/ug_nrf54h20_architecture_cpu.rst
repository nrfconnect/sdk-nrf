...
The Secure Domain Firmware (SDFW) is part of the nRF54H20 SoC binaries.
...
For more information on SDFW and the nRF54H20 SoC binaries, see :ref:`abi_compatibility` and :ref:`ug_nrf54h20_ironside`.
...
The System Controller Firmware (SCFW) is part of the nRF54H20 SoC binaries.
