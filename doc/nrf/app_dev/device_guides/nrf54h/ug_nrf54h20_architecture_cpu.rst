...
IronSide Secure Enclave (IronSide SE) is part of the nRF54H20 IronSide SE binaries.
...
The :ref:`IronSide Secure Enclave firmware <ug_nrf54h20_ironside>` relies on the CRACEN driver.
...
The System Controller Firmware (SCFW) is a component of the IronSide Secure Enclave (IronSide SE), and it is included in the nRF54H20 IronSide SE binaries.
