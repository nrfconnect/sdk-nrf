...
.. caution::
   ...
   * Do not update |ISE| Recovery on a snapshot-enabled device.
     ...
     For more information, see :ref:`abi_compatibility_ise_known_issues`.
...
.. tabs::
  ...
  .. group-tab:: nrf Util
    ...
    #. If you have not enabled snapshot and you are updating both slots, complete the following additional steps:
