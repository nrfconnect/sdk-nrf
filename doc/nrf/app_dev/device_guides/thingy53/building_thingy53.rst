...
#. Go to the specific directory for the sample or application.
   ...
   For example, the directory path is :file:`ncs/nrf/applications/matter_weather_station` when building the source code for the `Matter Weather Station`_ application.
