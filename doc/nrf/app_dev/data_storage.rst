...
* ZMS - For nRF54H and nRF54L Series devices, use ZMS for persistent storage instead of NVS.
* RRAMC and ZMS - For nRF54L Series devices, use RRAMC together with ZMS, instead of NVMC and NVS.
...
.. list-table:: Storage features comparison
   ...
   * - :ref:`NVS <data_storage_nvs>`
     ...
     - No
     - No
   * - :ref:`RRAMC for nRF54L15 <data_storage_rramc>`
     - Yes
     - Yes
     - Yes
     - No
   * - :ref:`ZMS for nRF54L15 and nRF54H20 <data_storage_zms>`
     - Yes
     - Yes
     - Yes
     - No
...
.. note::
   RRAMC is only available on the `nRF54L15 SoC <nRF54L15 RRAMC_>`_ and should be used with :ref:`ZMS <data_storage_zms>`.
...
For more information, see `nRF54L15 SoC datasheet <nRF54L15 RRAMC_>`_.
...
.. note::
   ZMS is only available on the nRF54L and nRF54H Series devices.
...
* Write optimization - Reduces write and erase cycles to extend memory lifespan.
