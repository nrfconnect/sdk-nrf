...
* Zephyr debugging services - Disable :ref:`zephyr:thread_analyzer` and :ref:`zephyr:cpu_load` if these were used during the development phase. 
* |NCS| debugging libraries - Disable :ref:`nrf_profiler`, :ref:`cpu_load`, :ref:`etb_trace`, and :ref:`ppi_trace` libraries if these were used during the development phase.

See :ref:`debugging` and :ref:`ug_logging` for more details on Debugging and logging, respectively.

If you want to make sure your products perform correctly and detect potential crashes when they operate in the field, you can consider enabling :ref:`mod_memfault`.
...
* TF-M and storage -  If you use Trusted Firmware-M (TF-M) and plan field updates, define static partitions so that TF-M storage and non-secure application regions do not move.
