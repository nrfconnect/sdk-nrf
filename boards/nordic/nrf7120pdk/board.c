...
#ifndef NRF_MPC03
	#define NRF_MPC03 ((NRF_MPC_Type*) 0x50043000)
#endif

	NRF_MPC03->OVERRIDE[0].STARTADDR = 0x200C0000;
	NRF_MPC03->OVERRIDE[0].ENDADDR = 0x20100000;
	NRF_MPC03->OVERRIDE[0].PERM = 0x7; // 0-NS R,W,X =1
	NRF_MPC03->OVERRIDE[0].PERMMASK = 0xF;
	// NRF_MPC03->OVERRIDE[0].MASTERPORT = 1 << 7;
	NRF_MPC03->OVERRIDE[0].CONFIG = 0x1200;
