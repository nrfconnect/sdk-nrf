...
Set these options in the project configuration file located at :file:`samples/cellular/aws_iot/prj.conf`.
...
.. |sample path| replace:: :file:`samples/cellular/aws_iot`
