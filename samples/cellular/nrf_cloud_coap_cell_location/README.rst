...
Credentials are missing on the configured sec tag. Note that CoAP connections require a different root CA certificate compared to REST and MQTT. It is possible to provision both certificates on the same sec tag.
   .. code-block:: console
