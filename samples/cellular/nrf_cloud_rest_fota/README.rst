...
This covers **modem, application, and full modem FOTA updates (fmfu)**. Also, with the nRF9160 DK, it supports **SMP FOTA updates**.
...
Your device must be onboarded with **nRF Cloud**.
...
Once the device is onboarded and connected, if you want to perform an update check immediately, press the **Button 1**.
