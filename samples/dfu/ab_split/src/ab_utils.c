...
#define SLOT_A_OFFSET PARTITION_OFFSET(SLOT_A_PARTITION)
#define SLOT_B_OFFSET PARTITION_OFFSET(SLOT_B_PARTITION)
#define SLOT_A_SIZE   PARTITION_SIZE(SLOT_A_PARTITION)
#define SLOT_B_SIZE   PARTITION_SIZE(SLOT_B_PARTITION)

#define SLOT_A_FLASH_AREA_ID PARTITION_ID(SLOT_A_PARTITION)
#define SLOT_B_FLASH_AREA_ID PARTITION_ID(SLOT_B_PARTITION)
