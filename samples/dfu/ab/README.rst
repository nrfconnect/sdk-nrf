...
.. _CONFIG_APP_HEALTH_CHECK_FAILURE:

CONFIG_APP_HEALTH_CHECK_FAILURE - Enables emulation of a broken application that fails the self-test.
   This configuration option emulates a broken application that does not pass the self-test.

Additional configuration
========================

:kconfig:option:`CONFIG_MCUBOOT_IMGTOOL_SIGN_VERSION` - This configuration option sets the version to pass to imgtool when signing.
