...
For the Bluetooth LE buttonless build, the application stores a firmware loader advertising name in Settings for the firmware loader to use after reset.
