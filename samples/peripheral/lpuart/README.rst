...
By default, the console and logging are disabled to demonstrate low power consumption while the UART is active.
...
2. Measure the current to confirm that the power consumption indicates that the high-frequency clock is disabled during the idle stage.
