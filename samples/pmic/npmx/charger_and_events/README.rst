...
* Set charger basic configuration.
...
.. |sample path| replace:: :file:`samples/pmic/npmx/charger_and_events`
...
#. |connect_kit|
#. |connect_terminal|
#. Use the `Charging current` option in menuconfig to change charging current.
#. Use the `Termination voltage` option in menuconfig to change Vterm voltage.
