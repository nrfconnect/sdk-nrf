...
.. note::
   ...
   Unplug the battery from nPM2100 EK, and set the DK power switch to "OFF" while applying the wiring described below.
   In case of issues communicating with or programming the DK after applying the wiring, try to power cycle the DK and EK.
