...
To build this sample, you need to choose either nPM1300 EK or nPM1304 EK as a Zephyr shield.
...
.. tabs::
   ...
   .. group-tab:: Command line
      ...
      To choose a shield, use the ``--shield`` option of the ``west build`` command.
