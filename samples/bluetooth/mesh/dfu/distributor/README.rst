...
.. ncs-sample::
   :title: Bluetooth Mesh: Device Firmware Update (DFU) distributor
...
To enable the LE pairing authentication with the LE Pairing Responder model support, set :makevar:`EXTRA_CONF_FILE` to :ncs-file:`/samples/bluetooth/mesh/dfu/distributor/overlay-smp-bt-auth.conf` file when building the sample.
