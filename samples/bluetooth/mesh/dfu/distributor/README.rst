...
To enable the LE pairing authentication with the LE Pairing Responder model support, set :makevar:`OVERLAY_CONFIG` to :file:`overlay-smp-bt-auth.conf` file when building the sample.
