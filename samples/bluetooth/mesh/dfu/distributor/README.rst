...
.. tabs::
   ...
   .. group-tab:: Shell
      ...
      * Through the shell management subsystem of MCU manager (for example, using the `nRF Device Manager mobile app for Android`_ or :ref:`Mcumgr command-line tool <dfu_tools_mcumgr_cli>`).
