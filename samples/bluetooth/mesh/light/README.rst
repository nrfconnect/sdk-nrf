...
This sample is required when working with the :ref:`bluetooth_mesh_light_switch` sample.
...
The provisioning is handled by the :ref:`bt_mesh_dk_prov`, with the default :file:`prj.conf` configuration.
