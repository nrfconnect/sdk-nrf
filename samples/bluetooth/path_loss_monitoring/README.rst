...
To run this sample, you must use two compatible development kits to run this sample: one programmed with the Central application, and the other with the Peripheral application.
