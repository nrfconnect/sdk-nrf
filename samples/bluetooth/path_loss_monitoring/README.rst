...
1. Program one DK with the :file:`samples/bluetooth/path_loss_monitoring/central` program.
#. Program another DK with the :file:`samples/bluetooth/path_loss_monitoring/peripheral` program.
