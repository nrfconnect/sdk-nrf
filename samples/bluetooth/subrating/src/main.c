...
void scan_filter_no_match(struct bt_le_scan_device_info *device_info, bool connectable)
{
	char addr[BT_ADDR_LE_STR_LEN];
...
BT_LE_SCAN_CB_INIT(scan_cb, scan_filter_match, scan_filter_no_match, scan_connecting_error, NULL);
...
static void scan_init(void)
{
	...
	err = bt_le_scan_filter_add(BT_LE_SCAN_FILTER_TYPE_UUID, BT_UUID_LATENCY);
	if (err) {
