...
When connected, the sample sends the state of a button on the development kit to the connected device, such as a phone or tablet.
The mobile application on the device can display the received button state and control the state of an LED on the development kit.
...
.. tabs::
   ...
   .. group-tab:: nRF54 DKs
      ...
      .. note::
         Older nRF54 PDKs follow the same numbering of Buttons and LEDs as nRF52 and nRF53.
         Check the numbering on your DK.
...
.. tabs::
   ...
   .. group-tab:: nRF54 DKs
      ...
      | Hardware platform      | Value   | Effect                                       |
      +========================+=========+==============================================+
      | Development kit        | ``OFF`` | Switch the **LED2** off.                     |
      +                        +---------+----------------------------------------------+
      |                        | ``ON``  | Switch the **LED2** on.                      |
      +------------------------+---------+----------------------------------------------+
      | nRF52840 Dongle        | ``OFF`` | Switch the green channel of the RGB LED off. |
      +                        +---------+----------------------------------------------+
      |                        | ``ON``  | Switch the green channel of the RGB LED on.  |
