...
/**
 * @defgroup fhn_sample_battery_priv Locator Tag sample battery module private API
 ...
 *  @ref BT_FAST_PAIR_FHN_BATTERY_LEVEL_NONE value when the
 *  CONFIG_BT_FAST_PAIR_FHN_BATTERY_DULT is enabled.
 *
 * @param percentage_level Battery level as a percentage [0-100%] or
 *                         @ref BT_FAST_PAIR_FHN_BATTERY_LEVEL_NONE value.
 */
