...
This option is enabled by default if the board target configuration has enough memory to support it (see the following table to learn about supported configurations).
