...
This sample can demonstrate Wi-Fi shutdown and achieve the lowest possible power consumption in the nRF5340 SoC:
...
* Build to demonstrate Wi-Fi shutdown:
