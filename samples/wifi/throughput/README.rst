...
|                        |           |           |           |           |
+========================+===========+===========+===========+===========+
| IoT devices            | 6.3 Mbps  | 22.9 Mbps | 8.3 Mbps  | 6.5 Mbps  |
+------------------------+-----------+-----------+-----------+-----------+
| Memory-optimized       | 6.3 Mbps  | 23.6 Mbps | 6 Mbps    | 8.1 Mbps  |
+------------------------+-----------+-----------+-----------+-----------+
| High performance       | 16.4 Mbps | 22.5 Mbps | 11.2 Mbps | 12.1 Mbps |
+------------------------+-----------+-----------+-----------+-----------+
| TX prioritized         | 17.8 Mbps | 21.1 Mbps | 9.5 Mbps  | 8.1 Mbps  |
+------------------------+-----------+-----------+-----------+-----------+
| RX prioritized         | 9.3 Mbps  | 23.5 Mbps | 7.4 Mbps  | 8.9 Mbps  |
+------------------------+-----------+-----------+-----------+-----------+
