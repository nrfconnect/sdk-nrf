...
An empty image can be added to a project using the following options (depending upon if a SoC has the CPU):
...
.. |sample path| replace:: :file:`samples/multicore/empty`
