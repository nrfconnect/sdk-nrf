...
/** Wrap all desh prints into JSON and send to nRF Cloud over MQTT */
...
static char desh_print_buf[CONFIG_SAMPLE_DESH_PRINT_BUFFER_SIZE];
...
char *desh_print_version_str_get(void)
{
	...
	(void)snprintf(version_str, sizeof(version_str), "v%s-%s",
