...
The :ncs-file:`/samples/dect/dect_shell/eth_common.conf` file sets :kconfig:option:`CONFIG_NRF_MODEM_LIB_SHMEM_TX_SIZE` and :kconfig:option:`CONFIG_NRF_MODEM_LIB_SHMEM_RX_SIZE` Kconfig option values.
Keep these Kconfig values aligned with the region sizes defined in the :ncs-file:`/samples/dect/dect_shell/eth-rx.overlay` file.
