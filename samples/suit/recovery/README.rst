...
#. Recover the application using Device Manager in the same way as described in the :ref:`nrf54h_suit_sample` sample documentation.

  .. note::
     In recovery state, Device Manager uses legacy mode.
