...
#define GENERATED_ATTRIBUTES                                                                                                                        \
	{                                                                                                                                           \
		...
		{ ZAP_SIMPLE_DEFAULT(0xFF), 0x00000008, 1, ZAP_TYPE(PERCENT),                                                                       \
		  ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentPositionLiftPercentage    \
														 */                                 \
		{ ZAP_SIMPLE_DEFAULT(0xFF), 0x00000009, 1, ZAP_TYPE(PERCENT),                                                                       \
		  ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentPositionTiltPercentage    \
														 */                                 \
		...
		{ ZAP_SIMPLE_DEFAULT(0xFFFF), 0x0000000E, 2, ZAP_TYPE(PERCENT100THS),                                                               \
		  ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentPositionLiftPercent100ths \
														 */                                 \
		{ ZAP_SIMPLE_DEFAULT(0xFFFF), 0x0000000F, 2, ZAP_TYPE(PERCENT100THS),                                                               \
		  ZAP_ATTRIBUTE_MASK(TOKENIZE) | ZAP_ATTRIBUTE_MASK(READABLE) | ZAP_ATTRIBUTE_MASK(NULLABLE) }, /* CurrentPositionTiltPercent100ths \
														 */                                 \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 15, 8 },                                                                       \
		{ ZAP_CLUSTER_INDEX(15), 3, 25 },                                                                      \
	}
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 4 }, { 0x00000202, 3 } }
