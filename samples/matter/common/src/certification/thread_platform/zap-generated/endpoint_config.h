...
#define GENERATED_ATTRIBUTES                                                                                                                       \
	{                                                                                                                                          \
		...
		{ ZAP_EMPTY_DEFAULT(), 0x00000006, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* UserActiveModeTriggerHint             \
													   */                                      \
		{ ZAP_EMPTY_DEFAULT(), 0x00000007, 129, ZAP_TYPE(CHAR_STRING), ZAP_ATTRIBUTE_MASK(READABLE) }, /* UserActiveModeTriggerInstruction \
														*/                                 \
		...
		{ ZAP_SIMPLE_DEFAULT(1), 0x00000000, 1, ZAP_TYPE(BITMAP8), ZAP_ATTRIBUTE_MASK(READABLE) }, /* NameSupport                          \
													    */                                     \
		{ ZAP_SIMPLE_DEFAULT(1), 0x0000FFFC, 4, ZAP_TYPE(BITMAP32), ZAP_ATTRIBUTE_MASK(READABLE) }, /* FeatureMap                          \
													     */                                    \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 18, 191 },                                                                     \
		{ ZAP_CLUSTER_INDEX(18), 4, 20 },                                                                      \
	}
...
#define FIXED_DEVICE_TYPES { { 0x00000012, 1 }, { 0x00000016, 4 }, { 0x00000100, 3 } }
