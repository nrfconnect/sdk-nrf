	...
	{                                                                                                                       \
		...
		{ 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion \
			...
			{ 0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON),                                           \
			  ZAP_LONG_DEFAULTS_INDEX(160) }, /* SoftwareVersion */                                                 \
			...
			{ 0x000C, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),                                     \
			  ZAP_LONG_DEFAULTS_INDEX(244) }, /* PartNumber */                                                      \
			{ 0x000D, ZAP_TYPE(CHAR_STRING), 256, ZAP_ATTRIBUTE_MASK(SINGLETON),                                    \
			  ZAP_LONG_DEFAULTS_INDEX(276) }, /* ProductURL */                                                      \
			{ 0x000E, ZAP_TYPE(CHAR_STRING), 64, ZAP_ATTRIBUTE_MASK(SINGLETON),                                     \
			  ZAP_LONG_DEFAULTS_INDEX(532) }, /* ProductLabel */                                                    \
			{ 0x000F, ZAP_TYPE(CHAR_STRING), 32, ZAP_ATTRIBUTE_MASK(SINGLETON),                                     \
			  ZAP_LONG_DEFAULTS_INDEX(596) }, /* SerialNumber */                                                    \
			...
			{ 0x0011, ZAP_TYPE(BOOLEAN), 1, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_SIMPLE_DEFAULT(1) }, /* Reachable    \
														 */             \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_SIMPLE_DEFAULT(3) }, /* cluster       \
														  revision      \
														*/              \
                                                                                                                                \
			...
			{ 0x0001, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),                                            \
			  ZAP_LONG_DEFAULTS_INDEX(636) }, /* Breadcrumb */                                                      \
			...
			{ 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1626) }, /* fabrics list */                  \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */                  \
                                                                                                                                \
	...
	{                                                                                                              \
		{ 0x0028,                                                                                              \
		  ...
		  chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                               \
			{ 0x0030, ZAP_ATTRIBUTE_INDEX(19), 3, 18, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,    \
												       Cluster:        \
												       General         \
												       Commissioning   \
												       (server) */     \
			{ 0x0031, ZAP_ATTRIBUTE_INDEX(22), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      ...
												      Commissioning    \
												      (server) */      \
			{ 0x0032, ZAP_ATTRIBUTE_INDEX(23), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      Cluster:         \
												      Diagnostic Logs  \
												      (server) */      \
			{ 0x0033, ZAP_ATTRIBUTE_INDEX(23), 3, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,   \
													...
													Diagnostics    \
													(server) */    \
			{ 0x0034, ZAP_ATTRIBUTE_INDEX(26), 2, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,    \
												       Cluster:        \
												       Software        \
												       Diagnostics     \
												       (server) */     \
			{ 0x0035, ZAP_ATTRIBUTE_INDEX(28), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,  \
													 Cluster:      \
													 Thread        \
													 Network       \
													 Diagnostics   \
													 (server) */   \
			{ 0x003E, ZAP_ATTRIBUTE_INDEX(89), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,   \
													Cluster:       \
													Operational    \
													Credentials    \
													(server) */    \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 8, 1933 }, { ZAP_CLUSTER_INDEX(8), 2, 16 },                                    \
	}
...
#define ATTRIBUTE_MAX_SIZE (1949)
