...
namespace app
{
	...
	namespace clusters
	{
		...
		{
			void DispatchServerCommand(app::CommandHandler *apCommandObj, CommandId aCommandId,
						   EndpointId aEndpointId, TLV::TLVReader &aDataTlv)
			{
				...
				bool wasHandled = false;
				{
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfDiagnosticLogsClusterRetrieveLogsRequestCallback(
									aEndpointId, apCommandObj, intent,
					...
					default: {
						...
						ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32,
							     aCommandId, Clusters::DiagnosticLogs::Id);
						return;
					}
					}
				}
				...
				if (CHIP_NO_ERROR != TLVError || CHIP_NO_ERROR != TLVUnpackError ||
					...
					ChipLogProgress(Zcl,
							...
							validArgumentCount, expectArgumentCount,
							ChipError::FormatError(TLVError),
				...
				bool wasHandled = false;
				{
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfGeneralCommissioningClusterArmFailSafeCallback(
									aEndpointId, apCommandObj, expiryLengthSeconds,
					...
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
						ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32,
							     aCommandId, Clusters::GeneralCommissioning::Id);
						return;
					}
					}
				}
				...
				bool wasHandled = false;
				{
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfLevelControlClusterMoveToLevelWithOnOffCallback(
									aEndpointId, apCommandObj, level,
									transitionTime);
						}
						break;
					}
					...
					case Clusters::LevelControl::Commands::Ids::Step: {
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled = emberAfLevelControlClusterStepCallback(
								aEndpointId, apCommandObj, stepMode, stepSize,
					...
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
						ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32,
							     aCommandId, Clusters::LevelControl::Id);
						return;
					}
					}
				}
				...
				bool wasHandled = false;
				{
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfNetworkCommissioningClusterAddThreadNetworkCallback(
									aEndpointId, apCommandObj, operationalDataset,
									breadcrumb, timeoutMs);
						}
						break;
					}
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfNetworkCommissioningClusterDisableNetworkCallback(
									aEndpointId, apCommandObj, networkID,
									breadcrumb, timeoutMs);
						}
						break;
					}
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfNetworkCommissioningClusterScanNetworksCallback(
									aEndpointId, apCommandObj, ssid, breadcrumb,
									timeoutMs);
						}
						break;
					}
					...
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
						ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32,
							     aCommandId, Clusters::NetworkCommissioning::Id);
						return;
					}
					}
				}
						   ...
						   EndpointId aEndpointId, TLV::TLVReader &aDataTlv)
			{
				...
				bool wasHandled = false;
				{
					...
					case Clusters::OnOff::Commands::Ids::Toggle: {
						wasHandled =
							emberAfOnOffClusterToggleCallback(aEndpointId, apCommandObj);
						break;
					}
					default: {
						// Unrecognized command ID, error status will apply.
				...
				bool wasHandled = false;
				{
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterAddOpCertCallback(
									aEndpointId, apCommandObj, NOCArray, IPKValue,
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterRemoveFabricCallback(
									aEndpointId, apCommandObj, FabricId, NodeId,
									VendorId);
						}
						break;
					}
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterSetFabricCallback(
									aEndpointId, apCommandObj, VendorId);
						}
						break;
					}
					...
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::InteractionModel::ProtocolCode::UnsupportedCommand);
						ChipLogError(Zcl, "Unknown command %" PRIx32 " for cluster %" PRIx32,
							     aCommandId, Clusters::OperationalCredentials::Id);
						return;
					}
					}
				}
	...
	{
		ChipLogDetail(Zcl,
			      "Received Cluster Command: Cluster=%" PRIx32 " Command=%" PRIx32 " Endpoint=%" PRIx16,
	...
	void DispatchSingleClusterResponseCommand(chip::ClusterId aClusterId, chip::CommandId aCommandId,
						  chip::EndpointId aEndPointId, chip::TLV::TLVReader &aReader,
