...
#define GENERATED_ATTRIBUTES                                                                                                                \
	{                                                                                                                                   \
		...
		{ 0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_EMPTY_DEFAULT() }, /* device                    \
			...
			{ 0x00000002, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(16) }, /* UpTime */                                   \
			{ 0x00000003, ZAP_TYPE(INT32U), 4, 0, ZAP_LONG_DEFAULTS_INDEX(24) }, /* TotalOperationalHours                       \
											      */                                            \
			...
			{ 0x00000001, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(28) }, /* CurrentHeapFree */                          \
			{ 0x00000002, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(36) }, /* CurrentHeapUsed */                          \
			{ 0x00000003, ZAP_TYPE(INT64U), 8, 0, ZAP_LONG_DEFAULTS_INDEX(44) }, /* CurrentHeapHighWatermark                    \
											      */                                            \
			{ 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */                           \
                                                                                                                                            \
...
#define GENERATED_CLUSTERS                                                                                                            \
	{                                                                                                                             \
		{ 0x0000001D, ZAP_ATTRIBUTE_INDEX(0), 6, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster:                \
												 Descriptor (server)                  \
											       */                                     \
			{ 0x00000028,                                                                                                 \
			...
			{ 0x00000030, ZAP_ATTRIBUTE_INDEX(19), 6, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   General                    \
													   Commissioning              \
													   (server) */                \
			{ 0x00000031, ZAP_ATTRIBUTE_INDEX(25), 10, 44, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                 \
													    0,                        \
													    Cluster:                  \
													    Network                   \
													    Commissioning             \
													    (server)                  \
													  */                          \
			{ 0x00000033, ZAP_ATTRIBUTE_INDEX(35), 7, 17, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   General                    \
													   Diagnostics                \
													   (server) */                \
			{ 0x00000034, ZAP_ATTRIBUTE_INDEX(42), 4, 26, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   Software                   \
													   Diagnostics                \
													   (server) */                \
			{ 0x00000035, ZAP_ATTRIBUTE_INDEX(46), 64, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   Thread                     \
													   Network                    \
													   Diagnostics                \
													   (server) */                \
			{ 0x0000003C, ZAP_ATTRIBUTE_INDEX(110), 5, 6, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   AdministratorCommissioning \
													   (server) */                \
			{ 0x0000003E, ZAP_ATTRIBUTE_INDEX(115), 8, 5, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   0, Cluster:                \
													   Operational                \
													   Credentials                \
													   (server) */                \
			...
			{ 0x0000001D, ZAP_ATTRIBUTE_INDEX(136), 6, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   1, Cluster:                \
													   Descriptor                 \
													   (server) */                \
	}
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 9, 358 }, { ZAP_CLUSTER_INDEX(9), 3, 18 },                                     \
	}
