...
#define GENERATED_CLUSTERS { \
  ...
  { 0x003E, ZAP_ATTRIBUTE_INDEX(82), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Operational Credentials (server) */ \
  { 0x003F, ZAP_ATTRIBUTE_INDEX(84), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster: Trusted Root Certificates (server) */ \
}
...
#define ATTRIBUTE_MAX_SIZE (1530)
