...
CHIP_ERROR TemperatureManager::Init()
{
	...
	Thermostat::Attributes::OccupiedCoolingSetpoint::Get(kThermostatEndpoint, &mHeatingCelsiusSetPoint);
	Thermostat::Attributes::OccupiedHeatingSetpoint::Get(kThermostatEndpoint, &mCoolingCelsiusSetPoint);
...
uint16_t TemperatureManager::GetCurrentTemp()
{
	return mCurrentTempCelsius;
}
uint16_t TemperatureManager::GetHeatingSetPoint()
{
	return mHeatingCelsiusSetPoint;
}

uint16_t TemperatureManager::GetCoolingSetPoint()
{
