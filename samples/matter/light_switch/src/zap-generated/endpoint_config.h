...
#define GENERATED_ATTRIBUTES                                                                                                            \
	{                                                                                                                               \
		...
		{ 0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_EMPTY_DEFAULT() }, /* device                \
			...
			{ 0x00000000, ZAP_TYPE(OCTET_STRING), 0,                                                                        \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* bssid */                                                                            \
			{ 0x00000001, ZAP_TYPE(ENUM8), 0,                                                                               \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* SecurityType */                                                                     \
			{ 0x00000002, ZAP_TYPE(ENUM8), 0,                                                                               \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* WiFiVersion */                                                                      \
			{ 0x00000003, ZAP_TYPE(INT16U), 0,                                                                              \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* ChannelNumber */                                                                    \
			{ 0x00000004, ZAP_TYPE(INT8S), 0,                                                                               \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* Rssi */                                                                             \
			{ 0x00000005, ZAP_TYPE(INT32U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			  ZAP_EMPTY_DEFAULT() }, /* BeaconLostCount */                                                                  \
			{ 0x00000006, ZAP_TYPE(INT32U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			...
			{ 0x0000000B, ZAP_TYPE(INT64U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			  ZAP_EMPTY_DEFAULT() }, /* CurrentMaxRate */                                                                   \
			{ 0x0000000C, ZAP_TYPE(INT64U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			  ZAP_EMPTY_DEFAULT() }, /* OverrunCount */                                                                     \
			{ 0x0000FFFC, ZAP_TYPE(BITMAP32), 4, 0, ZAP_LONG_DEFAULTS_INDEX(213) }, /* FeatureMap */                        \
			{ 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */                       \
                                                                                                                                        \
			/* Endpoint: 0, Cluster: Ethernet Network Diagnostics (server) */                                               \
			{ 0x00000000, ZAP_TYPE(ENUM8), 0,                                                                               \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* PHYRate */                                                                          \
			{ 0x00000001, ZAP_TYPE(BOOLEAN), 0,                                                                             \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			...
			{ 0x00000005, ZAP_TYPE(INT64U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			  ZAP_EMPTY_DEFAULT() }, /* CollisionCount */                                                                   \
			{ 0x00000006, ZAP_TYPE(INT64U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
			  ZAP_EMPTY_DEFAULT() }, /* OverrunCount */                                                                     \
			{ 0x00000007, ZAP_TYPE(BOOLEAN), 0,                                                                             \
			  ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE) | ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			  ZAP_EMPTY_DEFAULT() }, /* CarrierDetect */                                                                    \
			{ 0x00000008, ZAP_TYPE(INT64U), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                        \
