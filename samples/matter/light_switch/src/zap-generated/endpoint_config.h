...
#define GENERATED_ATTRIBUTES                                                                                                            \
	{                                                                                                                               \
		...
		{ 0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_EMPTY_DEFAULT() }, /* device                \
			...
			{ 0x00000000, ZAP_TYPE(OCTET_STRING), 7, ZAP_ATTRIBUTE_MASK(NULLABLE),                                          \
			...
			{ 0x00000003, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(NULLABLE),                                                \
			  ZAP_SIMPLE_DEFAULT(0x0000) }, /* ChannelNumber */                                                             \
			{ 0x00000004, ZAP_TYPE(INT8S), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),                                                 \
			  ZAP_SIMPLE_DEFAULT(0x00) }, /* Rssi */                                                                        \
