...
namespace app
{
	...
	namespace clusters
	{
		...
		{
			void DispatchServerCommand(app::Command *apCommandObj, CommandId aCommandId,
						   EndpointId aEndpointId, TLV::TLVReader &aDataTlv)
			{
				...
				bool wasHandled = false;
				{
					...
					case ZCL_ARM_FAIL_SAFE_COMMAND_ID: {
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							// TODO(#5098) We should pass the Command Object and EndpointId
							// to the cluster callbacks.
							wasHandled =
								emberAfGeneralCommissioningClusterArmFailSafeCallback(
									apCommandObj, expiryLengthSeconds, breadcrumb,
									timeoutMs);
						}
						break;
					}
					case ZCL_COMMISSIONING_COMPLETE_COMMAND_ID: {
						// TODO(#5098) We should pass the Command Object and EndpointId to the
						// cluster callbacks.
						wasHandled =
					...
					case ZCL_SET_REGULATORY_CONFIG_COMMAND_ID: {
						...
						while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR) {
							...
							case 0:
								...
								break;
							case 1:
								// TODO(#5542): The cluster handlers should accept a
								// ByteSpan for all string types.
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfGeneralCommissioningClusterSetRegulatoryConfigCallback(
									apCommandObj, location,
									const_cast<uint8_t *>(countryCode), breadcrumb,
									timeoutMs);
						}
						break;
					}
					default: {
						...
						chip::app::CommandPathParams returnStatusParam = {
							aEndpointId,
							0, // GroupId
						...
						ChipLogError(Zcl, "Unknown command %" PRIx16 " for cluster %" PRIx16,
							     aCommandId, ZCL_GENERAL_COMMISSIONING_CLUSTER_ID);
						return;
					}
					}
				}
				...
				if (CHIP_NO_ERROR != TLVError || CHIP_NO_ERROR != TLVUnpackError ||
					...
					apCommandObj->AddStatusCode(
						...
						Protocols::SecureChannel::kProtocolCodeGeneralFailure);
					ChipLogProgress(Zcl,
							"Failed to dispatch command, %d/%" PRIu32
							" arguments parsed, TLVError=%" PRIu32 ", UnpackError=%" PRIu32
							" (last decoded tag = %" PRIu32,
							validArgumentCount, expectArgumentCount, TLVError,
							TLVUnpackError, currentDecodeTagId);
				}
			}
				...
				bool wasHandled = false;
				{
					...
					case ZCL_ADD_THREAD_NETWORK_COMMAND_ID: {
						...
						while ((TLVError = aDataTlv.Next()) == CHIP_NO_ERROR) {
							...
							case 0: {
								...
								operationalDataset =
									chip::ByteSpan(data, aDataTlv.GetLength());
							} break;
							case 1:
								TLVUnpackError = aDataTlv.Get(breadcrumb);
								break;
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfNetworkCommissioningClusterAddThreadNetworkCallback(
									apCommandObj, operationalDataset, breadcrumb,
									timeoutMs);
						}
						break;
					}
					...
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::SecureChannel::kProtocolCodeGeneralFailure);
						ChipLogError(Zcl, "Unknown command %" PRIx16 " for cluster %" PRIx16,
							     aCommandId, ZCL_NETWORK_COMMISSIONING_CLUSTER_ID);
						return;
					}
					}
				}
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterAddOpCertCallback(
									apCommandObj, NOC, ICACertificate, IPKValue,
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterRemoveFabricCallback(
									apCommandObj, FabricId, NodeId, VendorId);
						}
						break;
					}
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							wasHandled =
								emberAfOperationalCredentialsClusterUpdateFabricLabelCallback(
									apCommandObj, const_cast<uint8_t *>(Label));
						}
						break;
					}
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::SecureChannel::kProtocolCodeGeneralFailure);
						ChipLogError(Zcl, "Unknown command %" PRIx16 " for cluster %" PRIx16,
							     aCommandId, ZCL_OPERATIONAL_CREDENTIALS_CLUSTER_ID);
						return;
					}
					}
				}
				...
				bool wasHandled = false;
				{
					...
					case ZCL_ADD_TRUSTED_ROOT_CERTIFICATE_COMMAND_ID: {
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							// to the cluster callbacks.
							wasHandled =
								emberAfTrustedRootCertificatesClusterAddTrustedRootCertificateCallback(
									apCommandObj, RootCertificate);
						}
						break;
					}
					case ZCL_REMOVE_TRUSTED_ROOT_CERTIFICATE_COMMAND_ID: {
						...
						if (CHIP_NO_ERROR == TLVError && CHIP_NO_ERROR == TLVUnpackError &&
							...
							// to the cluster callbacks.
							wasHandled =
								emberAfTrustedRootCertificatesClusterRemoveTrustedRootCertificateCallback(
									apCommandObj, TrustedRootIdentifier);
						}
						break;
					}
					default: {
						...
						apCommandObj->AddStatusCode(
							...
							Protocols::SecureChannel::kProtocolCodeGeneralFailure);
						ChipLogError(Zcl, "Unknown command %" PRIx16 " for cluster %" PRIx16,
							     aCommandId, ZCL_TRUSTED_ROOT_CERTIFICATES_CLUSTER_ID);
						return;
					}
					}
				}
	...
	void DispatchSingleClusterCommand(chip::ClusterId aClusterId, chip::CommandId aCommandId,
					  chip::EndpointId aEndPointId, chip::TLV::TLVReader &aReader,
					  Command *apCommandObj)
	{
		ChipLogDetail(Zcl, "Received Cluster Command: Cluster=%" PRIx16 " Command=%" PRIx8 " Endpoint=%" PRIx8,
		...
		case ZCL_GENERAL_COMMISSIONING_CLUSTER_ID:
			clusters::GeneralCommissioning::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId,
									      aReader);
			break;
		case ZCL_NETWORK_COMMISSIONING_CLUSTER_ID:
			clusters::NetworkCommissioning::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId,
									      aReader);
			break;
		case ZCL_OPERATIONAL_CREDENTIALS_CLUSTER_ID:
			clusters::OperationalCredentials::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId,
										aReader);
			break;
		case ZCL_TRUSTED_ROOT_CERTIFICATES_CLUSTER_ID:
			clusters::TrustedRootCertificates::DispatchServerCommand(apCommandObj, aCommandId, aEndPointId,
										 aReader);
			break;
		default:
			...
			chip::app::CommandPathParams returnStatusParam = {
				aEndPointId,
				0, // GroupId
				aClusterId, aCommandId, (chip::app::CommandPathFlags::kEndpointIdValid)
			};

			apCommandObj->AddStatusCode(&returnStatusParam,
						    Protocols::SecureChannel::GeneralStatusCode::kNotFound,
						    Protocols::SecureChannel::Id,
						    Protocols::SecureChannel::kProtocolCodeGeneralFailure);
