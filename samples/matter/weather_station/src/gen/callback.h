 ...
 */
void emberAfBasicClusterServerManufacturerSpecificAttributeChangedCallback(chip::EndpointId endpoint,
 ...
 */
EmberAfStatus emberAfBasicClusterServerPreAttributeChangedCallback(chip::EndpointId endpoint,
								   chip::AttributeId attributeId,
 ...
 * @param attributeId Attribute that changed
 */
void emberAfGeneralCommissioningClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
								      chip::AttributeId attributeId);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfGeneralDiagnosticsClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
								    chip::AttributeId attributeId);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfNetworkCommissioningClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
								      chip::AttributeId attributeId);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfOperationalCredentialsClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
									chip::AttributeId attributeId);
 ...
 * @param manufacturerCode  Manufacturer Code of the attribute that changed
 */
void emberAfOperationalCredentialsClusterServerManufacturerSpecificAttributeChangedCallback(
 ...
 * @param attributeId Attribute that changed
 */
void emberAfPressureMeasurementClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
								     chip::AttributeId attributeId);
 ...
 * @param value         Attribute value
 */
EmberAfStatus emberAfRelativeHumidityMeasurementClusterServerPreAttributeChangedCallback(
	chip::EndpointId endpoint, chip::AttributeId attributeId, EmberAfAttributeType attributeType, uint16_t size,
	uint8_t *value);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfSoftwareDiagnosticsClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
								     chip::AttributeId attributeId);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfTemperatureMeasurementClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
									chip::AttributeId attributeId);
 ...
 * @param manufacturerCode  Manufacturer Code of the attribute that changed
 */
void emberAfTemperatureMeasurementClusterServerManufacturerSpecificAttributeChangedCallback(
	chip::EndpointId endpoint, chip::AttributeId attributeId, uint16_t manufacturerCode);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfThreadNetworkDiagnosticsClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
									  chip::AttributeId attributeId);
 ...
 * @param manufacturerCode  Manufacturer Code of the attribute that changed
 */
void emberAfThreadNetworkDiagnosticsClusterServerManufacturerSpecificAttributeChangedCallback(
	chip::EndpointId endpoint, chip::AttributeId attributeId, uint16_t manufacturerCode);
 ...
 * @param value         Attribute value
 */
EmberAfStatus emberAfThreadNetworkDiagnosticsClusterServerPreAttributeChangedCallback(
	chip::EndpointId endpoint, chip::AttributeId attributeId, EmberAfAttributeType attributeType, uint16_t size,
	uint8_t *value);
 ...
 * @param attributeId Attribute that changed
 */
void emberAfTrustedRootCertificatesClusterServerAttributeChangedCallback(chip::EndpointId endpoint,
									 chip::AttributeId attributeId);
 ...
 * @param manufacturerCode  Manufacturer Code of the attribute that changed
 */
void emberAfTrustedRootCertificatesClusterServerManufacturerSpecificAttributeChangedCallback(
	chip::EndpointId endpoint, chip::AttributeId attributeId, uint16_t manufacturerCode);
...
bool emberAfGeneralCommissioningClusterSetRegulatoryConfigCallback(chip::app::Command *commandObj, uint8_t location,
								   uint8_t *countryCode, uint64_t breadcrumb,
								   uint32_t timeoutMs);
...
bool emberAfNetworkCommissioningClusterAddThreadNetworkCallback(chip::app::Command *commandObj,
 ...
 */
EmberAfAttributeWritePermission emberAfAllowNetworkWriteAttributeCallback(chip::EndpointId endpoint,
									  chip::ClusterId clusterId,
									  chip::AttributeId attributeId, uint8_t mask,
									  uint16_t manufacturerCode, uint8_t *value,
									  uint8_t type);
...
bool emberAfAttributeWriteAccessCallback(chip::EndpointId endpoint, chip::ClusterId clusterId,
					 uint16_t manufacturerCode, chip::AttributeId attributeId);
 ...
 */
bool emberAfDiscoverCommandsGeneratedResponseCallback(chip::ClusterId clusterId, uint16_t manufacturerCode,
						      bool discoveryComplete, chip::CommandId *commandIds,
 ...
 * the number of identifiers.  Ver.: always
 */
bool emberAfDiscoverCommandsReceivedResponseCallback(chip::ClusterId clusterId, uint16_t manufacturerCode,
						     bool discoveryComplete, chip::CommandId *commandIds,
						     uint16_t commandIdCount);
 ...
 */
bool emberAfMessageSentCallback(EmberOutgoingMessageType type, chip::MessageSendDestination destination,
 ...
 * @param value   Ver.: always
 */
EmberAfStatus emberAfPreAttributeChangeCallback(chip::EndpointId endpoint, chip::ClusterId clusterId,
 ...
 * @param value   Ver.: always
 */
void emberAfPostAttributeChangeCallback(chip::EndpointId endpoint, chip::ClusterId clusterId,
					chip::AttributeId attributeId, uint8_t mask, uint16_t manufacturerCode,
					uint8_t type, uint16_t size, uint8_t *value);
...
EmberAfStatus emberAfExternalAttributeWriteCallback(chip::EndpointId endpoint, chip::ClusterId clusterId,
						    EmberAfAttributeMetadata *attributeMetadata,
						    uint16_t manufacturerCode, uint8_t *buffer, int32_t index = -1);
