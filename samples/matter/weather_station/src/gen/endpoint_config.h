		...
		{ 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON),                                          \
		  ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion                                                    \
			...
			{ 0x0009, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(SINGLETON),                                  \
			  ZAP_LONG_DEFAULTS_INDEX(176) }, /* SoftwareVersion */                                        \
			...
			{ 0x0001, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),                                   \
			  ZAP_LONG_DEFAULTS_INDEX(252) }, /* Breadcrumb */                                             \
			...
			{ 0x0022, ZAP_TYPE(INT32U), 4, 0,                                                              \
			  ZAP_LONG_DEFAULTS_INDEX(1131) }, /* TxDirectMaxRetryExpiryCount                              \
							    */                                                         \
			{ 0x0023, ZAP_TYPE(INT32U), 4, 0,                                                              \
			  ZAP_LONG_DEFAULTS_INDEX(1135) }, /* TxIndirectMaxRetryExpiryCount                            \
							    */                                                         \
			...
			{ 0x0033, ZAP_TYPE(INT32U), 4, 0,                                                              \
			  ZAP_LONG_DEFAULTS_INDEX(1199) }, /* RxErrUnknownNeighborCount                                \
							    */                                                         \
			...
			{ 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1223) }, /* fabrics list */         \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */         \
                                                                                                                       \
			...
			{ 0x0001, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(-4000) }, /* min measured value */        \
			{ 0x0002, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(8500) }, /* max measured value */         \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */         \
                                                                                                                       \
			...
			{ 0x0001, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(300) }, /* min measured value */          \
			{ 0x0002, ZAP_TYPE(INT16S), 2, 0, ZAP_SIMPLE_DEFAULT(1100) }, /* max measured value */         \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(2) }, /* cluster revision */              \
	}
	...
	{                                                                                                              \
		{ 0x0028,                                                                                              \
		  ...
		  chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                               \
			{ 0x0030, ZAP_ATTRIBUTE_INDEX(12), 3, 18, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,    \
												       Cluster:        \
												       General         \
												       Commissioning   \
												       (server) */     \
			{ 0x0031, ZAP_ATTRIBUTE_INDEX(15), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      Cluster: Network \
												      Commissioning    \
												      (server) */      \
			{ 0x0033, ZAP_ATTRIBUTE_INDEX(16), 3, 258, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,   \
													Cluster:       \
													General        \
													Diagnostics    \
													(server) */    \
			{ 0x0034, ZAP_ATTRIBUTE_INDEX(19), 2, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,    \
												       Cluster:        \
												       Software        \
												       Diagnostics     \
												       (server) */     \
			{ 0x0035, ZAP_ATTRIBUTE_INDEX(21), 61, 730, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,  \
													 Cluster:      \
													 Thread        \
													 Network       \
													 Diagnostics   \
													 (server) */   \
			{ 0x003E, ZAP_ATTRIBUTE_INDEX(82), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,   \
													Cluster:       \
													Operational    \
													Credentials    \
													(server) */    \
			{ 0x003F, ZAP_ATTRIBUTE_INDEX(84), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      Cluster: Trusted \
												      Root             \
												      Certificates     \
												      (server) */      \
			{ 0x0402, ZAP_ATTRIBUTE_INDEX(85), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1,     \
												      Cluster:         \
												      Temperature      \
												      Measurement      \
												      (server) */      \
			{ 0x0405, ZAP_ATTRIBUTE_INDEX(89), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2,     \
												      Cluster:         \
												      Relative         \
												      Humidity         \
												      Measurement      \
												      (server) */      \
			{ 0x0403, ZAP_ATTRIBUTE_INDEX(93), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3,     \
												      Cluster:         \
												      Pressure         \
												      Measurement      \
												      (server) */      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 8, 1530 }, { ZAP_CLUSTER_INDEX(8), 1, 8 }, { ZAP_CLUSTER_INDEX(9), 1, 8 },     \
...
#define ATTRIBUTE_MAX_SIZE (1554)
