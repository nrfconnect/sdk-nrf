	...
	{                                                                                                                       \
		...
		{ 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion \
			...
			{ 0x0001, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),                                            \
			  ZAP_LONG_DEFAULTS_INDEX(236) }, /* Breadcrumb */                                                      \
			...
			{ 0x0001, ZAP_TYPE(ARRAY), 254, 0, ZAP_LONG_DEFAULTS_INDEX(1226) }, /* fabrics list */                  \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* cluster revision */                  \
                                                                                                                                \
		...
		{ 0x0028,                                                                                              \
		  ...
		  chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                               \
			...
			{ 0x0034, ZAP_ATTRIBUTE_INDEX(19), 2, 10, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,    \
												       ...
												       Diagnostics     \
												       (server) */     \
			{ 0x0035, ZAP_ATTRIBUTE_INDEX(21), 61, 747, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,  \
													 Cluster:      \
													 Thread        \
													 Network       \
													 Diagnostics   \
			...
			{ 0x003E, ZAP_ATTRIBUTE_INDEX(82), 2, 256, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,   \
													...
													Credentials    \
													(server) */    \
			{ 0x0402, ZAP_ATTRIBUTE_INDEX(84), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 1,     \
												      Cluster:         \
												      Temperature      \
												      Measurement      \
												      (server) */      \
			{ 0x0405, ZAP_ATTRIBUTE_INDEX(88), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 2,     \
												      Cluster:         \
												      Relative         \
												      Humidity         \
												      Measurement      \
												      (server) */      \
			{ 0x0403, ZAP_ATTRIBUTE_INDEX(92), 4, 8, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 3,     \
												      Cluster:         \
												      Pressure         \
												      Measurement      \
												      (server) */      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 7, 1531 }, { ZAP_CLUSTER_INDEX(7), 1, 8 }, { ZAP_CLUSTER_INDEX(8), 1, 8 },     \
...
#define ATTRIBUTE_MAX_SIZE (1555)
