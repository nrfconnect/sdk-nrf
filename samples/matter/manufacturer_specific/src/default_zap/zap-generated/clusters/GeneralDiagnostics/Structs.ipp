			...
			namespace Structs
			{
				...
				namespace DeviceLoadStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kCurrentSubscriptions),
							       currentSubscriptions);
						encoder.Encode(to_underlying(Fields::kCurrentSubscriptionsForFabric),
							       currentSubscriptionsForFabric);
						encoder.Encode(to_underlying(Fields::kTotalSubscriptionsEstablished),
							       totalSubscriptionsEstablished);
						encoder.Encode(
							to_underlying(Fields::kTotalInteractionModelMessagesSent),
							totalInteractionModelMessagesSent);
						encoder.Encode(
							to_underlying(Fields::kTotalInteractionModelMessagesReceived),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kCurrentSubscriptions)) {
								err = DataModel::Decode(reader, currentSubscriptions);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kCurrentSubscriptionsForFabric)) {
								err = DataModel::Decode(reader,
											currentSubscriptionsForFabric);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kTotalSubscriptionsEstablished)) {
								err = DataModel::Decode(reader,
											totalSubscriptionsEstablished);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kTotalInteractionModelMessagesSent)) {
								err = DataModel::Decode(
									reader, totalInteractionModelMessagesSent);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kTotalInteractionModelMessagesReceived)) {
								err = DataModel::Decode(
									reader, totalInteractionModelMessagesReceived);
							}
