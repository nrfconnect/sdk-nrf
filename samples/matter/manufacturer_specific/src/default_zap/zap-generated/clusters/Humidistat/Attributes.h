			...
			namespace Attributes
			{
				...
				namespace SystemState
				{
					struct TypeInfo {
						...
						using DecodableArgType =
							chip::app::Clusters::Humidistat::SystemStateEnum;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SystemState::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SystemState
				namespace UserSetpoint
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::UserSetpoint::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace UserSetpoint
				namespace MinSetpoint
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MinSetpoint::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MinSetpoint
				namespace MaxSetpoint
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxSetpoint::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxSetpoint
				...
				namespace TargetSetpoint
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TargetSetpoint::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TargetSetpoint
				...
				namespace Continuous
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::Continuous::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace Continuous
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::Mode::TypeInfo::DecodableType mode =
							static_cast<chip::app::Clusters::Humidistat::ModeEnum>(0);
						Attributes::SystemState::TypeInfo::DecodableType systemState =
							static_cast<chip::app::Clusters::Humidistat::SystemStateEnum>(
								0);
						Attributes::UserSetpoint::TypeInfo::DecodableType userSetpoint =
							static_cast<chip::Percent>(0);
						Attributes::MinSetpoint::TypeInfo::DecodableType minSetpoint =
							static_cast<chip::Percent>(0);
						Attributes::MaxSetpoint::TypeInfo::DecodableType maxSetpoint =
							static_cast<chip::Percent>(0);
						Attributes::Step::TypeInfo::DecodableType step =
							static_cast<chip::Percent>(0);
						Attributes::TargetSetpoint::TypeInfo::DecodableType targetSetpoint =
							static_cast<chip::Percent>(0);
						Attributes::MistType::TypeInfo::DecodableType mistType = static_cast<
							chip::BitMask<chip::app::Clusters::Humidistat::MistTypeBitmap>>(
							0);
						Attributes::Continuous::TypeInfo::DecodableType continuous =
							static_cast<bool>(0);
						Attributes::Sleep::TypeInfo::DecodableType sleep = static_cast<bool>(0);
						Attributes::Optimal::TypeInfo::DecodableType optimal =
							static_cast<bool>(0);
