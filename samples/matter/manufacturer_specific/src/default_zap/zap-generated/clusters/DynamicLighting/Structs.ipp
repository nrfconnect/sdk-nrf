			...
			namespace Structs
			{
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kLevel)) {
								...
								err = DataModel::Decode(reader, hue);
								   ...
								   to_underlying(Fields::kEnhancedHue)) {
				...
				namespace EffectStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kSupportsColorPalette),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kEffectID)) {
								...
								err = DataModel::Decode(reader, maxSpeed);
								   ...
								   to_underlying(Fields::kDefaultSpeed)) {
								err = DataModel::Decode(reader, defaultSpeed);
							} else if (__context_tag ==
								   to_underlying(Fields::kSupportsColorPalette)) {
