			...
			namespace Attributes
			{
				...
				namespace AvailableEffects
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::DynamicLighting::Structs::
								EffectStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::DynamicLighting::Structs::EffectStruct::
								DecodableType>;
						...
						{
							return Clusters::DynamicLighting::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AvailableEffects::Id;
						}
				...
				namespace CurrentEffectID
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentEffectID::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentEffectID
				namespace CurrentSpeed
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentSpeed::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentSpeed
