			...
			namespace Structs
			{
				...
				namespace RDRStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kAzimuthAccuracy),
							       azimuthAccuracy);
						encoder.Encode(to_underlying(Fields::kElevationAccuracy),
							       elevationAccuracy);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kAzimuth)) {
								...
								err = DataModel::Decode(reader, elevation);
								   ...
								   to_underlying(Fields::kAzimuthAccuracy)) {
								err = DataModel::Decode(reader, azimuthAccuracy);
							} else if (__context_tag ==
								   to_underlying(Fields::kElevationAccuracy)) {
				...
				namespace RangingMeasurementDataStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kTimeOfMeasurement),
							       timeOfMeasurement);
						encoder.Encode(to_underlying(Fields::kTimeOfMeasurementOffset),
						...
						encoder.Encode(to_underlying(Fields::kDetectedAttackLevel),
							       detectedAttackLevel);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kWiFiDevIK)) {
								err = DataModel::Decode(reader, wiFiDevIK);
								   ...
								   to_underlying(Fields::kBLEDeviceID)) {
				...
				namespace BLERangingDeviceRoleConfigStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kPeerBLEDeviceID),
							       peerBLEDeviceID);
						return encoder.Finalize();
					}
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kRole)) {
								err = DataModel::Decode(reader, role);
								   ...
								   to_underlying(Fields::kPeerBLEDeviceID)) {
				...
				namespace BLTChannelSoundingDeviceRoleConfigStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kBLTCSSecurityLevel),
							       BLTCSSecurityLevel);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kRole)) {
								err = DataModel::Decode(reader, role);
								   ...
								   to_underlying(Fields::kPeerBLTDevIK)) {
								...
								err = DataModel::Decode(reader, BLTCSMode);
								   ...
								   to_underlying(Fields::kBLTCSSecurityLevel)) {
				...
				namespace RangingCapabilitiesStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kPeriodicRangingSupport),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kTechnology)) {
								err = DataModel::Decode(reader, technology);
								   ...
								   to_underlying(Fields::kFrequencyBand)) {
								err = DataModel::Decode(reader, frequencyBand);
							} else if (__context_tag ==
								   to_underlying(Fields::kPeriodicRangingSupport)) {
				...
				namespace RangingTriggerConditionStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kRangingInstanceInterval),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kStartTime)) {
								...
								err = DataModel::Decode(reader, endTime);
								   ...
								   to_underlying(Fields::kRangingInstanceInterval)) {
								err = DataModel::Decode(reader,
											rangingInstanceInterval);
							}
				...
				namespace ReportingConditionStruct
				{
					...
					{
						DataModel::WrappedStructEncoder encoder{ aWriter, aTag };
						encoder.Encode(to_underlying(Fields::kMinDistanceCondition),
							       minDistanceCondition);
						encoder.Encode(to_underlying(Fields::kMaxDistanceCondition),
							       maxDistanceCondition);
						encoder.Encode(to_underlying(Fields::kErrorMarginCondition),
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kMinDistanceCondition)) {
								err = DataModel::Decode(reader, minDistanceCondition);
							} else if (__context_tag ==
								   to_underlying(Fields::kMaxDistanceCondition)) {
								err = DataModel::Decode(reader, maxDistanceCondition);
							} else if (__context_tag ==
								   to_underlying(Fields::kErrorMarginCondition)) {
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kRole)) {
								err = DataModel::Decode(reader, role);
								   ...
								   to_underlying(Fields::kPeerWiFiDevIK)) {
