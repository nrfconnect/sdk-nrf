			...
			namespace Commands
			{
				namespace StartRangingRequest
				{
					...
					public:
						...
						{
							return Commands::StartRangingRequest::Id;
						}
						...
						Optional<Structs::WiFiRangingDeviceRoleConfigStruct::Type>
							wiFiRangingDeviceRoleConfig;
						Optional<Structs::BLERangingDeviceRoleConfigStruct::Type>
							BLERangingDeviceRoleConfig;
						Optional<Structs::BLTChannelSoundingDeviceRoleConfigStruct::Type>
						...
						using ResponseType = Clusters::ProximityRanging::Commands::
							StartRangingResponse::DecodableType;
					...
					public:
						...
						RangingTechEnum technology = static_cast<RangingTechEnum>(0);
						Optional<Structs::WiFiRangingDeviceRoleConfigStruct::DecodableType>
							wiFiRangingDeviceRoleConfig;
						Optional<Structs::BLERangingDeviceRoleConfigStruct::DecodableType>
							BLERangingDeviceRoleConfig;
						Optional<Structs::BLTChannelSoundingDeviceRoleConfigStruct::DecodableType>
							BLTChannelSoundingDeviceRoleConfig;
						Optional<chip::BitMask<RadioBandBitmap>> frequencyBand;
						Optional<chip::BitMask<RangingBandwidthBitmap>> bandwidth;
						RangingSecurityEnum securityMode = static_cast<RangingSecurityEnum>(0);
						Structs::RangingTriggerConditionStruct::DecodableType trigger;
						Optional<Structs::ReportingConditionStruct::DecodableType>
							reportingCondition;
				...
				namespace StartRangingResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StartRangingResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ProximityRanging::Id;
				...
				namespace StopRangingRequest
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::StopRangingRequest::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::ProximityRanging::Id;
