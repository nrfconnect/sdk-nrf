	...
	namespace Clusters
	{
		namespace ProximityRanging
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BLTCSSecurityLevel::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BLTCSSecurityLevel
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(BLTCSModeCapability::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace BLTCSModeCapability
			...
			namespace Commands
			{
				...
				namespace StartRangingRequest
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StartRangingRequest::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(StopRangingRequest::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace StopRangingRequest
