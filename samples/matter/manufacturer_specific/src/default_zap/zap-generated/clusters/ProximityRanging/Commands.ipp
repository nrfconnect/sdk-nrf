			...
			namespace Commands
			{
				namespace StartRangingRequest
				{
					...
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kWiFiRangingDeviceRoleConfig),
							       wiFiRangingDeviceRoleConfig);
						encoder.Encode(to_underlying(Fields::kBLERangingDeviceRoleConfig),
							       BLERangingDeviceRoleConfig);
						encoder.Encode(
							to_underlying(Fields::kBLTChannelSoundingDeviceRoleConfig),
						...
						encoder.Encode(to_underlying(Fields::kReportingCondition),
							       reportingCondition);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kTechnology)) {
								err = DataModel::Decode(reader, technology);
								   ...
								   to_underlying(
									   Fields::kWiFiRangingDeviceRoleConfig)) {
								err = DataModel::Decode(reader,
											wiFiRangingDeviceRoleConfig);
							} else if (__context_tag ==
								   to_underlying(Fields::kBLERangingDeviceRoleConfig)) {
								err = DataModel::Decode(reader,
											BLERangingDeviceRoleConfig);
							} else if (__context_tag ==
								   to_underlying(
									   Fields::kBLTChannelSoundingDeviceRoleConfig)) {
								err = DataModel::Decode(
									reader, BLTChannelSoundingDeviceRoleConfig);
							} else if (__context_tag ==
								...
								err = DataModel::Decode(reader, bandwidth);
								   ...
								   to_underlying(Fields::kSecurityMode)) {
								...
								err = DataModel::Decode(reader, trigger);
								   ...
								   to_underlying(Fields::kReportingCondition)) {
