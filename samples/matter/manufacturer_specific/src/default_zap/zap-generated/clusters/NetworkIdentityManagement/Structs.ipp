			...
			namespace Structs
			{
				...
				namespace ActiveNetworkIdentityStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kCreatedTimestamp),
							       createdTimestamp);
						encoder.Encode(to_underlying(Fields::kCurrent), current);
						encoder.Encode(to_underlying(Fields::kRemainingClients),
							       remainingClients);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kIndex)) {
								...
								err = DataModel::Decode(reader, identifier);
								   ...
								   to_underlying(Fields::kCreatedTimestamp)) {
								...
								err = DataModel::Decode(reader, current);
								   ...
								   to_underlying(Fields::kRemainingClients)) {
				...
				namespace ClientStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kClientIdentifier),
							       clientIdentifier);
						encoder.Encode(to_underlying(Fields::kClientIdentityType),
							       clientIdentityType);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kClientIndex)) {
								...
								err = DataModel::Decode(reader, clientIdentifier);
								   ...
								   to_underlying(Fields::kClientIdentityType)) {
