			...
			namespace Attributes
			{
				...
				namespace ActiveNetworkIdentities
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::NetworkIdentityManagement::Structs::
								ActiveNetworkIdentityStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::NetworkIdentityManagement::Structs::
								ActiveNetworkIdentityStruct::DecodableType>;
						...
						{
							return Clusters::NetworkIdentityManagement::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ActiveNetworkIdentities::Id;
						}
				...
				namespace ClientTableSize
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ClientTableSize::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ClientTableSize
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::ActiveNetworkIdentities::TypeInfo::DecodableType
							activeNetworkIdentities;
						Attributes::Clients::TypeInfo::DecodableType clients;
						Attributes::ClientTableSize::TypeInfo::DecodableType clientTableSize =
