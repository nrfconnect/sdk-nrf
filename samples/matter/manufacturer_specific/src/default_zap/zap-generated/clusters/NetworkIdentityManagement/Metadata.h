	...
	namespace Clusters
	{
		namespace NetworkIdentityManagement
		{
			...
			namespace Attributes
			{
				...
				namespace ClientTableSize
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ClientTableSize::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
			...
			namespace Commands
			{
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveClient::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
							       Access::Privilege::kManage);
				} // namespace RemoveClient
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ImportAdminSecret::Id,
							       BitFlags<DataModel::CommandQualityFlags>(
								       DataModel::CommandQualityFlags::kTimed),
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ExportAdminSecret::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kAdminister);
				} // namespace ExportAdminSecret
