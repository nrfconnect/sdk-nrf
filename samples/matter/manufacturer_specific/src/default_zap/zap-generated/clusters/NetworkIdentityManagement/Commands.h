			...
			namespace Commands
			{
				namespace AddClient
				{
					...
					public:
						...
						using ResponseType = Clusters::NetworkIdentityManagement::Commands::
							AddClientResponse::DecodableType;
				...
				namespace AddClientResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::AddClientResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::NetworkIdentityManagement::Id;
				...
				namespace RemoveClient
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveClient::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::NetworkIdentityManagement::Id;
				...
				namespace ImportAdminSecret
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ImportAdminSecret::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::NetworkIdentityManagement::Id;
				...
				namespace ExportAdminSecret
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ExportAdminSecret::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::NetworkIdentityManagement::Id;
						...
						using ResponseType = Clusters::NetworkIdentityManagement::Commands::
							ExportAdminSecretResponse::DecodableType;
				...
				namespace ExportAdminSecretResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ExportAdminSecretResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::NetworkIdentityManagement::Id;
