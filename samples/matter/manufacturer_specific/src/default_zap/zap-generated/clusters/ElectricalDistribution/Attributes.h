			...
			namespace Attributes
			{
				...
				namespace MaxContinuousCurrent
				{
					struct TypeInfo {
						...
						{
							return Clusters::ElectricalDistribution::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxContinuousCurrent::Id;
						}
				...
				namespace MaxVoltage
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxVoltage::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxVoltage
				namespace NumberOfPoles
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::NumberOfPoles::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace NumberOfPoles
				namespace EndOfLife
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::EndOfLife::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace EndOfLife
				namespace ServiceEntranceRated
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ServiceEntranceRated::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ServiceEntranceRated
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MaxContinuousCurrent::TypeInfo::DecodableType
						...
						Attributes::ServiceEntranceRated::TypeInfo::DecodableType
