			...
			namespace Attributes
			{
				...
				namespace MaxContinuousCurrent
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxContinuousCurrent::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(NumberOfPoles::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace NumberOfPoles
				namespace EndOfLife
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ServiceEntranceRated::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ServiceEntranceRated
				constexpr std::array<DataModel::AttributeEntry, 5> kMandatoryMetadata = {
					MaxContinuousCurrent::kMetadataEntry, MaxVoltage::kMetadataEntry,
					NumberOfPoles::kMetadataEntry,	      EndOfLife::kMetadataEntry,
