			...
			namespace Attributes
			{
				...
				namespace HumanActivityDetected
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(HumanActivityDetected::Id,
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ObjectIdentified::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ObjectIdentified
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(AudioContextDetected::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace AudioContextDetected
				...
				{
					inline constexpr DataModel::AttributeEntry kMetadataEntry(
						AmbientContextTypeSupported::Id,
						BitFlags<DataModel::AttributeQualityFlags>(
							DataModel::AttributeQualityFlags::kListAttribute),
						Access::Privilege::kView, std::nullopt);
				} // namespace AmbientContextTypeSupported
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ObjectCountThresholdReached::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ObjectCountThresholdReached
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ObjectCountConfig::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SimultaneousDetectionLimit::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SimultaneousDetectionLimit
				namespace HoldTime
