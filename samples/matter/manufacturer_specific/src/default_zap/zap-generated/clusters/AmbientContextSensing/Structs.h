		...
		namespace AmbientContextSensing
		{
			namespace Structs
			{
				namespace AmbientContextTypeStruct
				{
					...
					struct Type {
					public:
						DataModel::List<const Globals::Structs::SemanticTagStruct::Type>
					...
					public:
						DataModel::DecodableList<
							Globals::Structs::SemanticTagStruct::DecodableType>
							ambientContextSensed;
						Optional<uint32_t> detectionStartTime;
				...
				namespace PredictedActivityStruct
				{
					...
					public:
						...
						Optional<DataModel::List<const Globals::Structs::SemanticTagStruct::Type>>
							ambientContextType;
