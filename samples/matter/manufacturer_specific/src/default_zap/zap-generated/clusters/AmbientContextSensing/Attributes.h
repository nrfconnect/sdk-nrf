			...
			namespace Attributes
			{
				...
				namespace HumanActivityDetected
				{
					struct TypeInfo {
						...
						{
							return Clusters::AmbientContextSensing::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::HumanActivityDetected::Id;
						}
				...
				namespace ObjectIdentified
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ObjectIdentified::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ObjectIdentified
				namespace AudioContextDetected
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AudioContextDetected::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AudioContextDetected
				namespace AmbientContextType
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::AmbientContextSensing::Structs::
								AmbientContextTypeStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::AmbientContextSensing::Structs::
								AmbientContextTypeStruct::DecodableType>;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AmbientContextType::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AmbientContextType
				namespace AmbientContextTypeSupported
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AmbientContextTypeSupported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AmbientContextTypeSupported
				namespace ObjectCountThresholdReached
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ObjectCountThresholdReached::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ObjectCountThresholdReached
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::AmbientContextSensing::Structs::
							ObjectCountConfigStruct::Type;
						using DecodableType = chip::app::Clusters::AmbientContextSensing::
							Structs::ObjectCountConfigStruct::DecodableType;
						using DecodableArgType =
							const chip::app::Clusters::AmbientContextSensing::Structs::
								ObjectCountConfigStruct::DecodableType &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ObjectCountConfig::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ObjectCountConfig
				namespace ObjectCount
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ObjectCount::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ObjectCount
				namespace SimultaneousDetectionLimit
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SimultaneousDetectionLimit::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SimultaneousDetectionLimit
				...
				namespace PredictedActivity
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::AmbientContextSensing::Structs::
								PredictedActivityStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::AmbientContextSensing::Structs::
								PredictedActivityStruct::DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::AmbientContextSensing::Structs::
								PredictedActivityStruct::DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::PredictedActivity::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace PredictedActivity
				namespace SensorFusionSupported
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SensorFusionSupported::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace SensorFusionSupported
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::HumanActivityDetected::TypeInfo::DecodableType
							humanActivityDetected = static_cast<bool>(0);
						Attributes::ObjectIdentified::TypeInfo::DecodableType objectIdentified =
							static_cast<bool>(0);
						Attributes::AudioContextDetected::TypeInfo::DecodableType
							audioContextDetected = static_cast<bool>(0);
						Attributes::AmbientContextType::TypeInfo::DecodableType
							ambientContextType;
						Attributes::AmbientContextTypeSupported::TypeInfo::DecodableType
							ambientContextTypeSupported;
						Attributes::ObjectCountThresholdReached::TypeInfo::DecodableType
							objectCountThresholdReached = static_cast<bool>(0);
						Attributes::ObjectCountConfig::TypeInfo::DecodableType objectCountConfig;
						Attributes::ObjectCount::TypeInfo::DecodableType objectCount =
							static_cast<uint16_t>(0);
						Attributes::SimultaneousDetectionLimit::TypeInfo::DecodableType
							simultaneousDetectionLimit = static_cast<uint8_t>(0);
						...
						Attributes::SensorFusionSupported::TypeInfo::DecodableType
