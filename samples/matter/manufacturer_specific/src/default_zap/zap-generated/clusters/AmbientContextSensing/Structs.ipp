			...
			namespace Structs
			{
				...
				namespace AmbientContextTypeStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kAmbientContextSensed),
							       ambientContextSensed);
						encoder.Encode(to_underlying(Fields::kDetectionConfidence),
							       detectionConfidence);
					...
					CHIP_ERROR DecodableType::Decode(TLV::TLVReader &reader)
					{
						...
						while (true) {
							...
							if (__context_tag ==
							    to_underlying(Fields::kAmbientContextSensed)) {
								err = DataModel::Decode(reader, ambientContextSensed);
							} else if (__context_tag ==
								   to_underlying(Fields::kDetectionConfidence)) {
				...
				namespace ObjectCountConfigStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kObjectCountThreshold),
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kCountingObject)) {
								err = DataModel::Decode(reader, countingObject);
								   ...
								   to_underlying(Fields::kObjectCountThreshold)) {
				...
				namespace PredictedActivityStruct
				{
					CHIP_ERROR Type::Encode(TLV::TLVWriter &aWriter, TLV::Tag aTag) const
					{
						...
						encoder.Encode(to_underlying(Fields::kAmbientContextType),
							       ambientContextType);
						...
						while (true) {
							...
							if (__context_tag == to_underlying(Fields::kStartTimestamp)) {
								...
								err = DataModel::Decode(reader, endTimestamp);
								   ...
								   to_underlying(Fields::kAmbientContextType)) {
								err = DataModel::Decode(reader, ambientContextType);
							} else if (__context_tag ==
								   to_underlying(Fields::kCrowdDetected)) {
								err = DataModel::Decode(reader, crowdDetected);
							} else if (__context_tag ==
								   to_underlying(Fields::kCrowdCount)) {
								err = DataModel::Decode(reader, crowdCount);
							} else if (__context_tag ==
								   to_underlying(Fields::kConfidence)) {
