			...
			namespace Attributes
			{
				...
				namespace MeasuredValue
				{
					struct TypeInfo {
						...
						{
							return Clusters::SmokeConcentrationMeasurement::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::SmokeConcentrationMeasurement::
							MeasurementUnitEnum;
						using DecodableType = chip::app::Clusters::
							SmokeConcentrationMeasurement::MeasurementUnitEnum;
				...
				namespace MeasurementMedium
				{
					struct TypeInfo {
						...
						using DecodableType = chip::app::Clusters::
							SmokeConcentrationMeasurement::MeasurementMediumEnum;
						using DecodableArgType = chip::app::Clusters::
							SmokeConcentrationMeasurement::MeasurementMediumEnum;
				...
				namespace LevelValue
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::SmokeConcentrationMeasurement::
							LevelValueEnum;
						using DecodableType = chip::app::Clusters::
							SmokeConcentrationMeasurement::LevelValueEnum;
						using DecodableArgType = chip::app::Clusters::
							SmokeConcentrationMeasurement::LevelValueEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::MeasurementUnit::TypeInfo::DecodableType measurementUnit =
							static_cast<chip::app::Clusters::SmokeConcentrationMeasurement::
