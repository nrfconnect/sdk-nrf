	...
	namespace Clusters
	{
		namespace ElectricalProtectionAlarm
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OverLoadRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace OverLoadRating
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(OverVoltageRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace OverVoltageRating
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(SurgeProtectionRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace SurgeProtectionRating
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ShortCircuitRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ShortCircuitRating
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ResidualCurrentRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ResidualCurrentRating
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(ArcFaultRating::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace ArcFaultRating
