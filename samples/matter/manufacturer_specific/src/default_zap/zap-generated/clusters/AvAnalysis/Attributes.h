			...
			namespace Attributes
			{
				...
				namespace SupportedAmbientContexts
				{
					struct TypeInfo {
						...
						{
							return Clusters::AvAnalysis::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::SupportedAmbientContexts::Id;
						}
				...
				namespace ActiveAmbientContextTriggers
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::AvAnalysis::Structs::
								ContextTriggerStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::AvAnalysis::Structs::ContextTriggerStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::AvAnalysis::Structs::ContextTriggerStruct::
								DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::ActiveAmbientContextTriggers::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace ActiveAmbientContextTriggers
				namespace MaxAnalysisStreamCount
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::MaxAnalysisStreamCount::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace MaxAnalysisStreamCount
				namespace CurrentAnalysisStreamCount
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::CurrentAnalysisStreamCount::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace CurrentAnalysisStreamCount
				namespace AnalysisStreams
				{
					struct TypeInfo {
						using Type = chip::app::DataModel::List<
							const chip::app::Clusters::AvAnalysis::Structs::
								AnalysisStreamStruct::Type>;
						using DecodableType = chip::app::DataModel::DecodableList<
							chip::app::Clusters::AvAnalysis::Structs::AnalysisStreamStruct::
								DecodableType>;
						using DecodableArgType = const chip::app::DataModel::DecodableList<
							chip::app::Clusters::AvAnalysis::Structs::AnalysisStreamStruct::
								DecodableType> &;
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::AnalysisStreams::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace AnalysisStreams
				namespace TrackingEnabled
				{
					struct TypeInfo {
						...
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::TrackingEnabled::Id;
						}
						static constexpr bool MustUseTimedWrite() { return false; }
					};
				} // namespace TrackingEnabled
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::SupportedAmbientContexts::TypeInfo::DecodableType
							supportedAmbientContexts;
						Attributes::ActiveAmbientContextTriggers::TypeInfo::DecodableType
							activeAmbientContextTriggers;
						Attributes::MaxAnalysisStreamCount::TypeInfo::DecodableType
							maxAnalysisStreamCount = static_cast<uint8_t>(0);
						Attributes::CurrentAnalysisStreamCount::TypeInfo::DecodableType
							currentAnalysisStreamCount = static_cast<uint8_t>(0);
						Attributes::AnalysisStreams::TypeInfo::DecodableType analysisStreams;
						Attributes::TrackingEnabled::TypeInfo::DecodableType trackingEnabled =
							static_cast<bool>(0);
