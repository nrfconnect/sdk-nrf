			...
			namespace Commands
			{
				namespace EnableContextTriggers
				{
					...
					public:
						...
						{
							return Commands::EnableContextTriggers::Id;
						}
						...
						DataModel::Nullable<
							DataModel::List<const Structs::ContextTriggerStruct::Type>>
							contextTriggers;
					...
					public:
						...
						DataModel::Nullable<DataModel::DecodableList<
							Structs::ContextTriggerStruct::DecodableType>>
							contextTriggers;
				...
				namespace DisableContextTriggers
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::DisableContextTriggers::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
				...
				namespace EstablishAnalysisStream
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::EstablishAnalysisStream::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
						...
						using ResponseType = Clusters::AvAnalysis::Commands::
							EstablishAnalysisStreamResponse::DecodableType;
				...
				namespace EstablishAnalysisStreamResponse
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::EstablishAnalysisStreamResponse::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
				...
				namespace ActivateAnalysisStream
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::ActivateAnalysisStream::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
				...
				namespace DeactivateAnalysisStream
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::DeactivateAnalysisStream::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
				...
				namespace RemoveAnalysisStream
				{
					...
					public:
						...
						static constexpr CommandId GetCommandId()
						{
							return Commands::RemoveAnalysisStream::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
