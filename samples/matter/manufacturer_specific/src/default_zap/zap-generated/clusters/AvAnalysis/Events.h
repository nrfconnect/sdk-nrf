			...
			namespace Events
			{
				namespace AnalysisSessionStart
				{
					...
					public:
						...
						{
							return Events::AnalysisSessionStart::Id;
						}
				...
				namespace AnalysisSessionEnd
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::AnalysisSessionEnd::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
				...
				namespace PerceivedContext
				{
					...
					public:
						...
						static constexpr EventId GetEventId()
						{
							return Events::PerceivedContext::Id;
						}
						static constexpr ClusterId GetClusterId()
						{
							return Clusters::AvAnalysis::Id;
						...
						Optional<DataModel::List<const Structs::TrackedContext::Type>>
					...
					public:
						...
						Optional<chip::NodeId> sourceNodeId;
						Optional<uint64_t> sourceStartTimestamp;
						Optional<DataModel::DecodableList<Structs::TrackedContext::DecodableType>>
							newIdentifiedContexts;
						Optional<DataModel::DecodableList<Structs::TrackedContext::DecodableType>>
							currentIdentifiedContexts;
						Optional<DataModel::DecodableList<Structs::TrackedContext::DecodableType>>
