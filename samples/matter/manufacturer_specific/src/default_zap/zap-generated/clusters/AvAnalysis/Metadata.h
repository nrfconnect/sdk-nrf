	...
	namespace Clusters
	{
		namespace AvAnalysis
		{
			...
			namespace Attributes
			{
				...
				{
					inline constexpr DataModel::AttributeEntry kMetadataEntry(
						ActiveAmbientContextTriggers::Id,
						BitFlags<DataModel::AttributeQualityFlags>(
							DataModel::AttributeQualityFlags::kListAttribute),
						Access::Privilege::kView, std::nullopt);
				} // namespace ActiveAmbientContextTriggers
				namespace MaxAnalysisStreamCount
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(MaxAnalysisStreamCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace MaxAnalysisStreamCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(CurrentAnalysisStreamCount::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
							       Access::Privilege::kView, std::nullopt);
				} // namespace CurrentAnalysisStreamCount
				...
				{
					inline constexpr DataModel::AttributeEntry
						kMetadataEntry(TrackingEnabled::Id,
							       BitFlags<DataModel::AttributeQualityFlags>(),
			...
			namespace Commands
			{
				...
				namespace EnableContextTriggers
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EnableContextTriggers::Id,
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(DisableContextTriggers::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace DisableContextTriggers
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(EstablishAnalysisStream::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace EstablishAnalysisStream
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(ActivateAnalysisStream::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace ActivateAnalysisStream
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(DeactivateAnalysisStream::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace DeactivateAnalysisStream
				...
				{
					inline constexpr DataModel::AcceptedCommandEntry
						kMetadataEntry(RemoveAnalysisStream::Id,
							       BitFlags<DataModel::CommandQualityFlags>(),
							       Access::Privilege::kOperate);
				} // namespace RemoveAnalysisStream
