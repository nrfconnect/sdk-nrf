...
namespace app
{
	namespace DataModel
	{
		...
		template <> struct ClusterMetadataProvider<DataModel::AttributeEntry, Clusters::AvAnalysis::Id> {
		...
		template <> struct ClusterMetadataProvider<DataModel::AcceptedCommandEntry, Clusters::AvAnalysis::Id> {
