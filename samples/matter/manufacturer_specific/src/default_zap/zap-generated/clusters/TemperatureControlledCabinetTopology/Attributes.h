			...
			namespace Attributes
			{
				...
				namespace DisabledCabinets
				{
					struct TypeInfo {
						...
						{
							return Clusters::TemperatureControlledCabinetTopology::Id;
						}
						static constexpr AttributeId GetAttributeId()
						{
							return Attributes::DisabledCabinets::Id;
						}
				...
				{
					struct TypeInfo {
						using Type = chip::app::Clusters::TemperatureControlledCabinetTopology::
							TopologyEnum;
						using DecodableType = chip::app::Clusters::
							TemperatureControlledCabinetTopology::TopologyEnum;
				...
				struct TypeInfo {
					struct DecodableType {
						...
						Attributes::Topology::TypeInfo::DecodableType topology = static_cast<
							chip::app::Clusters::TemperatureControlledCabinetTopology::
								TopologyEnum>(0);
