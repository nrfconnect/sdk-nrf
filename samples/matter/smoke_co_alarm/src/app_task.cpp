...
Nrf::Matter::IdentifyCluster sIdentifyCluster(kSmokeCoAlarmEndpointId);
...
bool HandleSmokeCOTestEventTrigger(uint64_t eventTrigger)
{
	...
	case SmokeCOTrigger::kForceSmokeCritical:
		...
		VerifyOrReturnValue(SmokeCoAlarmServer::Instance().SetSmokeState(
					    kSmokeCoAlarmEndpointId, Clusters::SmokeCoAlarm::AlarmStateEnum::kCritical),
				    false);
	...
	case SmokeCOTrigger::kForceMalfunction:
		...
		VerifyOrReturnValue(SmokeCoAlarmServer::Instance().SetHardwareFaultAlert(kSmokeCoAlarmEndpointId, true),
				    false);
		SmokeCoAlarmServer::Instance().SetExpressedStateByPriority(kSmokeCoAlarmEndpointId, sPriorityOrder);
		break;
	...
	case SmokeCOTrigger::kClearSmoke:
		...
		VerifyOrReturnValue(SmokeCoAlarmServer::Instance().SetSmokeState(
					    kSmokeCoAlarmEndpointId, Clusters::SmokeCoAlarm::AlarmStateEnum::kNormal),
				    false);
		SmokeCoAlarmServer::Instance().SetExpressedStateByPriority(kSmokeCoAlarmEndpointId, sPriorityOrder);
		break;
	...
	case SmokeCOTrigger::kClearMalfunction:
		...
		VerifyOrReturnValue(
			SmokeCoAlarmServer::Instance().SetHardwareFaultAlert(kSmokeCoAlarmEndpointId, false), false);
		SmokeCoAlarmServer::Instance().SetExpressedStateByPriority(kSmokeCoAlarmEndpointId, sPriorityOrder);
		break;
	case SmokeCOTrigger::kClearEndOfLife:
		LOG_INF("Triggered end of end of service alert action");
		VerifyOrReturnValue(SmokeCoAlarmServer::Instance().SetEndOfServiceAlert(
					    kSmokeCoAlarmEndpointId, Clusters::SmokeCoAlarm::EndOfServiceEnum::kNormal),
				    false);
		SmokeCoAlarmServer::Instance().SetExpressedStateByPriority(kSmokeCoAlarmEndpointId, sPriorityOrder);
		break;
