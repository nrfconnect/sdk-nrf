...
# This sample is a low power sample, so we need to enable the low power snippet.
if(NOT "matter-low-power" IN_LIST ${DEFAULT_IMAGE}_SNIPPET)
  set(${DEFAULT_IMAGE}_SNIPPET ${${DEFAULT_IMAGE}_SNIPPET} matter-low-power CACHE STRING "" FORCE)
endif()
