...
* Matter over Wi-Fi is supported for ``nrf5340dk_nrf5340_cpuapp`` with the ``nrf7002ek`` shield attached, for ``nrf7002dk_nrf5340_cpuapp``, or for ``nrf7002dk_nrf7001_nrf5340_cpuapp`` (2.4 GHz only).
