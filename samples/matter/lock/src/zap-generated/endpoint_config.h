		...
		{ 0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                \
		  ZAP_EMPTY_DEFAULT() }, /* DeviceTypeList                                                             \
			...
			{ 0x00000000, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(NULLABLE),                                \
			  ZAP_SIMPLE_DEFAULT(0) }, /* LockState                                                        \
						    */                                                                 \
			...
			{ 0x00000014, ZAP_TYPE(INT8U), 1, 0,                                                           \
			  ZAP_SIMPLE_DEFAULT(10) }, /* NumberOfWeekDaySchedulesSupportedPerUser                        \
						     */                                                                \
			{ 0x00000015, ZAP_TYPE(INT8U), 1, 0,                                                           \
			  ZAP_SIMPLE_DEFAULT(10) }, /* NumberOfYearDaySchedulesSupportedPerUser                        \
						     */                                                                \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 15, 170 }, { ZAP_CLUSTER_INDEX(15), 2, 44 },                                   \
	}
