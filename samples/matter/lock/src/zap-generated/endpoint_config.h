	...
	{                                                                                                                               \
		...
		{ 0x00000000, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE), ZAP_EMPTY_DEFAULT() }, /* device                \
			...
			{ 0x00000001, ZAP_TYPE(CHAR_STRING), 36, ZAP_ATTRIBUTE_MASK(WRITABLE),                                          \
			  ZAP_LONG_DEFAULTS_INDEX(8) }, /* ActiveLocale */                                                              \
			{ 0x00000002, ZAP_TYPE(ARRAY), 0, ZAP_ATTRIBUTE_MASK(EXTERNAL_STORAGE),                                         \
			...
			{ 0x00000000, ZAP_TYPE(INT64U), 8, ZAP_ATTRIBUTE_MASK(WRITABLE),                                                \
			  ZAP_LONG_DEFAULTS_INDEX(14) }, /* Breadcrumb */                                                               \
			...
			{ 0x00000007, ZAP_TYPE(INT32S), 4, ZAP_ATTRIBUTE_MASK(NULLABLE),                                                \
			  ZAP_LONG_DEFAULTS_INDEX(26) }, /* LastConnectErrorValue */                                                    \
			...
			{ 0x00000021, ZAP_TYPE(CHAR_STRING), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),                                           \
			  ZAP_LONG_DEFAULTS_INDEX(46) }, /* Language */                                                                 \
			{ 0x00000023, ZAP_TYPE(INT32U), 4, ZAP_ATTRIBUTE_MASK(WRITABLE),                                                \
			  ZAP_LONG_DEFAULTS_INDEX(49) }, /* AutoRelockTime */                                                           \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 17, 180 }, { ZAP_CLUSTER_INDEX(17), 2, 46 },                                   \
	}
