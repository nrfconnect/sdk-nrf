...
#define GENERATED_CLUSTERS                                                                                                            \
	{                                                                                                                             \
		{ 0x0000001D, ZAP_ATTRIBUTE_INDEX(0), 6, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0, Cluster:                \
			...
			{ 0x0000001D, ZAP_ATTRIBUTE_INDEX(125), 6, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint:                  \
													   1, Cluster:                \
													   Descriptor                 \
													   (server) */                \
	}
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 9, 358 }, { ZAP_CLUSTER_INDEX(9), 2, 5 },                                      \
	}
