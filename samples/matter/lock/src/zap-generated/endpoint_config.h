...
#define GENERATED_ATTRIBUTES                                                                                                      \
	{                                                                                                                         \
		...
		{ 0x0000, ZAP_TYPE(INT16U), 2, ZAP_ATTRIBUTE_MASK(SINGLETON), ZAP_EMPTY_DEFAULT() }, /* InteractionModelVersion   \
			...
			{ 0x0001, ZAP_TYPE(ARRAY), 320, 0, ZAP_LONG_DEFAULTS_INDEX(1495) }, /* fabrics list */                    \
			...
			{ 0x0004, ZAP_TYPE(ARRAY), 400, 0, ZAP_LONG_DEFAULTS_INDEX(1815) }, /* TrustedRootCertificates            \
											     */                                   \
			{ 0xFFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(0x0001) }, /* ClusterRevision */                     \
                                                                                                                                  \
	...
	{                                                                                                                        \
		{ 0x0028,                                                                                                        \
		  ...
		  chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                                         \
			{ 0x0030, ZAP_ATTRIBUTE_INDEX(12), 3, 264, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,             \
													Cluster:                 \
													General                  \
													Commissioning            \
													(server) */              \
			...
			{ 0x0034,                                                                                                \
			  ...
			  chipFuncArraySoftwareDiagnosticsServer }, /* Endpoint: 0, Cluster: Software Diagnostics                \
								       (server) */                                               \
			{ 0x0035, ZAP_ATTRIBUTE_INDEX(23), 61, 749, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,            \
													 Cluster:                \
													 Thread                  \
													 Network                 \
													 Diagnostics             \
													 (server) */             \
			{ 0x003C, ZAP_ATTRIBUTE_INDEX(84), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,               \
												      Cluster:                   \
												      AdministratorCommissioning \
												      (server) */                \
			{ 0x003E, ZAP_ATTRIBUTE_INDEX(85), 5, 724, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,             \
													Cluster:                 \
													Operational              \
													Credentials              \
													(server) */              \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 8, 2270 }, { ZAP_CLUSTER_INDEX(8), 1, 3 },                                     \
	}
...
#define ATTRIBUTE_MAX_SIZE (2273)
