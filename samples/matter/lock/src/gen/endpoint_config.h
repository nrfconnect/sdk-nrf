		...
		{ 0x0028,                                                                                              \
		  ...
		  chipFuncArrayBasicServer }, /* Endpoint: 0, Cluster: Basic (server) */                               \
			...
			{ 0x0031, ZAP_ATTRIBUTE_INDEX(15), 1, 2, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      ...
												      Commissioning    \
												      (server) */      \
			{ 0x0032, ZAP_ATTRIBUTE_INDEX(16), 0, 0, ZAP_CLUSTER_MASK(SERVER), NULL }, /* Endpoint: 0,     \
												      Cluster:         \
												      Diagnostic Logs  \
												      (server) */      \
...
#define GENERATED_ENDPOINT_TYPES                                                                                       \
	{                                                                                                              \
		{ ZAP_CLUSTER_INDEX(0), 8, 1531 }, { ZAP_CLUSTER_INDEX(8), 1, 3 },                                     \
	}
...
#define ATTRIBUTE_MAX_SIZE (1534)
