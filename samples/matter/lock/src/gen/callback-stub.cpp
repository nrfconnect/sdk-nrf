...
emberAfAllowNetworkWriteAttributeCallback(EndpointId endpoint, ClusterId clusterId, AttributeId attributeId,
					  uint8_t mask, uint16_t manufacturerCode, uint8_t *value, uint8_t type)
{
 ...
 * @param attributeId   Ver.: always
 */
bool __attribute__((weak)) emberAfAttributeReadAccessCallback(EndpointId endpoint, ClusterId clusterId,
 ...
 * @param attributeId   Ver.: always
 */
bool __attribute__((weak)) emberAfAttributeWriteAccessCallback(EndpointId endpoint, ClusterId clusterId,
							       uint16_t manufacturerCode, AttributeId attributeId)
{
	return true;
}
 ...
 */
bool __attribute__((weak))
emberAfReadReportingConfigurationResponseCallback(ClusterId clusterId, uint8_t *buffer, uint16_t bufLen)
{
	return false;
}
 ...
 * not.  Ver.: always
 */
bool __attribute__((weak)) emberAfDiscoverAttributesResponseCallback(ClusterId clusterId, bool discoveryComplete,
