...
If :kconfig:option:`CONFIG_MEMFAULT_NCS_INTERNAL_FLASH_BACKED_COREDUMP` is enabled, enable the :ref:`snippet-memfault-coredump` snippet to supply the coredump partition using devicetree:
