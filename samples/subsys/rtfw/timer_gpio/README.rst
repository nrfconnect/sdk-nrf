...
both supported boards. Board configuration selects
``CONFIG_SAMPLE_RTFW_IRQ_PRIORITY=1`` on nRF54L and priority 0 on the nRF54H20
application core.
...
to exercise coexistence with MPSL. Priority 0 remains available to MPSL while
the RTFW source ZLI uses priority 1.
