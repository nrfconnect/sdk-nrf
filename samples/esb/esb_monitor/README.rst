...
This sample shows how to use the :ref:`ug_esb` protocol in monitor mode.
...
After building and programming each sample on an nRF54 Series DK, you can monitor traffic generated by the kits programmed with the :ref:`Transmitter <esb_ptx>` and :ref:`Receiver <esb_prx>` respectively.
