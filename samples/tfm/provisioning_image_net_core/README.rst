...
.. ncs-sample::
   :title: TF-M: Provisioning image for network core
   ...
   This sample is included by default as an image of the :ref:`provisioning image<provisioning_image>` sample that runs on the application core.
