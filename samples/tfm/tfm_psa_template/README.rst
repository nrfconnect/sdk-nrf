...
On nRF54L Series devices, the provisioning image is the primary way to provision the device for this application, and it is built together with the application by default (:kconfig:option:`SB_CONFIG_TFM_PSA_TEMPLATE_PROVISIONING_IMAGE`).
...
.. code-block:: console
   ...
   west build -b nrf54l15dk/nrf54l15/cpuapp/ns nrf/samples/tfm/tfm_psa_template \
     -- -DSB_CONFIG_TFM_PSA_TEMPLATE_PROVISIONING_IMAGE=n
