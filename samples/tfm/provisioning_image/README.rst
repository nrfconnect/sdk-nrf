...
Because this step generates secret key material and permanently changes the lifecycle state, it is delivered as a dedicated image rather than being built into the application.
...
The IAK is automatically derived from the CRACEN IKG seed.
