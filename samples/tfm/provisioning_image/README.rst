...
When built for the nrf5340dk_nrf5340_cpuapp target this image will also include a child image for the network core (nrf5340dk_nrf5340_cpunet target).
The child image demonstates how to disable the debugging access on the network core by writing to the UICR->APPROTECT register.
