.. _nrf_cloud_rest_agps:

nRF9160: nRF Cloud REST A-GPS
#############################
...
.. |sample path| replace:: :file:`samples/nrf9160/nrf_cloud_rest_agps`

.. include:: /includes/build_and_run_nrf9160.txt

The configuration file for this sample is located in :file:`samples/nrf9160/nrf_cloud_rest_agps`.
