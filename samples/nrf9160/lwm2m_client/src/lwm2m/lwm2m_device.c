...
int lwm2m_app_init_device(char *serial_num)
{
	...
	lwm2m_engine_set_res_buf(LWM2M_PATH(LWM2M_OBJECT_DEVICE_ID, 0, MODEL_NUMBER_RID),
				  CLIENT_MODEL_NUMBER, sizeof(CLIENT_MODEL_NUMBER), sizeof(CLIENT_MODEL_NUMBER),
				  LWM2M_RES_DATA_FLAG_RO);
	lwm2m_engine_set_res_buf(LWM2M_PATH(LWM2M_OBJECT_DEVICE_ID, 0, SERIAL_NUMBER_RID),
				  serial_num, strlen(serial_num), strlen(serial_num), LWM2M_RES_DATA_FLAG_RO);
	...
	lwm2m_engine_set_res_buf(LWM2M_PATH(LWM2M_OBJECT_DEVICE_ID, 0, SOFTWARE_VERSION_RID),
				  client_sw_ver, strlen(client_sw_ver) + 1, strlen(client_sw_ver) + 1,
				  LWM2M_RES_DATA_FLAG_RO);
