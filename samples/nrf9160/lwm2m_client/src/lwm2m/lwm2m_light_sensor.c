...
int lwm2m_init_light_sensor(void)
{
	...
	lwm2m_engine_set_res_buf(LWM2M_PATH(IPSO_OBJECT_COLOUR_ID, LIGHT_OBJ_INSTANCE_ID,
					     COLOUR_RID),
				  &light_value_str, RGBIR_STR_LENGTH, RGBIR_STR_LENGTH, LWM2M_RES_DATA_FLAG_RW);
	lwm2m_engine_set_res_buf(LWM2M_PATH(IPSO_OBJECT_COLOUR_ID, LIGHT_OBJ_INSTANCE_ID,
	...
	lwm2m_engine_set_res_buf(LWM2M_PATH(IPSO_OBJECT_COLOUR_ID, LIGHT_OBJ_INSTANCE_ID,
					     SENSOR_UNITS_RID),
				  LIGHT_UNIT, sizeof(LIGHT_UNIT), sizeof(LIGHT_UNIT), LWM2M_RES_DATA_FLAG_RO);
	...
	lwm2m_engine_set_res_buf(LWM2M_PATH(IPSO_OBJECT_COLOUR_ID, COLOUR_OBJ_INSTANCE_ID,
					     COLOUR_RID),
				  &colour_value_str, RGBIR_STR_LENGTH, RGBIR_STR_LENGTH, LWM2M_RES_DATA_FLAG_RW);
	lwm2m_engine_set_res_buf(LWM2M_PATH(IPSO_OBJECT_COLOUR_ID, COLOUR_OBJ_INSTANCE_ID,
					     APPLICATION_TYPE_RID),
