...
1. First, the sample performs initialization:
   ...
   #. A random ECDSA key pair is generated and imported into the PSA crypto keystore.
...
#. Then, ECDSA signing and verification is performed:
   ...
   a. Signing is performed using the ECDSA key pair.
   #. The signature is verified using the exported public key.

#. Afterwards, the sample performs cleanup:

   a. The ECDSA key pair and public key are removed from the PSA crypto keystore.
