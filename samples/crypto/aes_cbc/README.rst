...
The AES CBC sample shows how to perform AES encryption and decryption operations using the CBC block cipher mode without padding using a 128-bit AES key.
