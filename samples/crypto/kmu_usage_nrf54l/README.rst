...
The sample also demonstrates how to use the :ref:`generate_psa_key_attributes_script` script to generate the :file:`keys.json` file and then provision it to the KMU using `nRF Util`_.
