...
* :ncs-file:`/samples/net/download/boards/nrf7120dk_nrf7120_cpuapp_ns.conf` - Configuration file for the nRF7120 DK.
* :ncs-file:`/samples/net/download/boards/nrf7002dk_nrf5340_cpuapp_ns.conf` - Configuration file for the nRF7002 DK.
* :ncs-file:`/samples/net/download/wifi.conf` - Wi-Fi networking configuration, common to the nRF71 Series and nRF70 Series devices.
