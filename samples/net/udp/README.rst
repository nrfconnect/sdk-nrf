...
* :ncs-file:`/samples/net/udp/boards/nrf9151dk_nrf9151_ns.conf` - Configuration file for the nRF9151 DK.
* :ncs-file:`/samples/net/udp/boards/nrf9161dk_nrf9161_ns.conf` - Configuration file for the nRF9161 DK.
* :ncs-file:`/samples/net/udp/boards/nrf9160dk_nrf9160_ns.conf` - Configuration file for the nRF9160 DK.
* :ncs-file:`/samples/net/udp/boards/thingy91_nrf9160_ns.conf` - Configuration file for the Thingy:91.
* :ncs-file:`/samples/net/udp/boards/native_sim.conf` - Configuration file for the native simulator emulation.
* :ncs-file:`/samples/net/udp/wifi.conf` - Configuration overlay file for Wi-Fi devices, common to the nRF71 Series and nRF70 Series.
