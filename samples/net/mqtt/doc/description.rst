...
CONFIG_MQTT_SAMPLE_TRANSPORT_CLIENT_ID - MQTT client ID
	...
	If not set, the client ID will default to the modem's IMEI number for nRF91 Series devices, hardware ID for nRF71 Series or nRF70 Series devices, or a random number for native simulator.
