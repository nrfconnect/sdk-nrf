...
* :ncs-file:`/samples/net/http_server/boards/native_sim.conf` - Configuration file for the native simulator emulation.
* :ncs-file:`/samples/net/http_server/boards/nrf7120dk_nrf7120_cpuapp_ns.conf` - Configuration file for the nRF7120 DK.
* :ncs-file:`/samples/net/http_server/boards/nrf7002dk_nrf5340_cpuapp_ns.conf` - Configuration file for the nRF7002 DK.
* :ncs-file:`/samples/net/http_server/wifi.conf` - Wi-Fi networking configuration, common to the nRF71 Series and nRF70 Series devices.
  Must be added explicitly for Wi-Fi builds.
* :ncs-file:`/samples/net/http_server/wifi-tls.conf` - Additional configuration file that enables TLS support (server authentication, with optional mutual authentication) for Wi-Fi builds.
* :ncs-file:`/samples/net/http_server/overlay-tls-nrf91.conf` - Additional configuration file that enables TLS support for nRF91 Series DKs.
