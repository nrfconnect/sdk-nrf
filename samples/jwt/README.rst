...
.. note::
   Due to the extra long strings that the terminal has to print, be sure to configure CONFIG_LOG_BUFFER_SIZE with enough size to avoid truncated strings on the output.
