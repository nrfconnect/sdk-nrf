...
Use the devicetree partition label for slot-to-``<image>`` translation:

    +------------------+--------+-------------+---------------------------+
    | Partition label  | Slot   | -n <image>  |       Firmware part       |
    +==================+========+=============+===========================+
    | ``image-1``      | slot-1 |     0       | Internal application part |
    +------------------+--------+-------------+---------------------------+
    | ``image-3``      | slot-3 |     1       | Networking                |
    +------------------+--------+-------------+---------------------------+
    | ``image-5``      | slot-5 |     2       | QSPI application part     |
    +------------------+--------+-------------+---------------------------+
