...
The sample supports two application architecture options depending on the usage of the Zephyr networking layer.
...
Additionally, you can use the ``l2`` snippet to switch between the two architectures, see the :ref:`ot_cli_sample_activating_variants` section.
