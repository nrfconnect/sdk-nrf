...
* Optionally, one or more compatible development kits programmed with this sample or another :ref:`Thread samples<openthread_samples>` for testing communication.
...
Make sure to enable the OpenThread before building and testing this sample.
