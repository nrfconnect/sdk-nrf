 ...
 *
 * These functions search the chosen PSA nvm backend and return PSA key with the specified
 * attributes.
 *
 ...
 *
 * Depending on key width, choose getKeyRef_128Bits or getKeyRef_256Bits function variant.
 *
