 ...
 */
#if defined(CONFIG_PARTITION_MANAGER_ENABLED)
#define SHARED_BOOT_MEASUREMENT_BASE PM_TFM_SRAM_ADDRESS
#else
#define SHARED_BOOT_MEASUREMENT_BASE TFM_DT_REG_ADDR(TFM_DT_NODELABEL(sram0_s))
#endif

#ifdef CONFIG_TFM_PROFILE_TYPE_MINIMAL
#define SHARED_BOOT_MEASUREMENT_SIZE (0x100)
#else
#define SHARED_BOOT_MEASUREMENT_SIZE (0x400)
#endif
#define SHARED_BOOT_MEASUREMENT_LIMIT                                                              \
	(SHARED_BOOT_MEASUREMENT_BASE + SHARED_BOOT_MEASUREMENT_SIZE - 1)
...
#endif
#else
#if TFM_DT_NODE_EXISTS(TFM_DT_NODELABEL(sram0_dfu_shared))
#define REGION_PCD_SRAM_ADDRESS TFM_DT_REG_ADDR(TFM_DT_NODELABEL(sram0_dfu_shared))
#define REGION_PCD_SRAM_LIMIT (REGION_PCD_SRAM_ADDRESS + \
			       TFM_DT_REG_SIZE(TFM_DT_NODELABEL(sram0_dfu_shared)) - 1)
#endif
#endif /* CONFIG_PARTITION_MANAGER_ENABLED */
