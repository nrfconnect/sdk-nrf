...
config PM_PARTITION_SIZE_TFM
	...
	default 0xE800 if TFM_PROFILE_TYPE_MINIMAL && TFM_CMAKE_BUILD_TYPE_DEBUG && \
		BOOTLOADER_MCUBOOT && (SOC_SERIES_NRF54L || SOC_SERIES_NRF71)
	...
	default 0x17E00 if BOOTLOADER_MCUBOOT && SOC_SERIES_NRF91
...
config PM_PARTITION_SIZE_TFM_INTERNAL_TRUSTED_STORAGE
	...
	default 0x4000 if TFM_PARTITION_INTERNAL_TRUSTED_STORAGE && SOC_SERIES_NRF54L
