...
#define SPIM_FREQUENCY_1M	       1000000
#define SPIM_FREQUENCY_4M	       4000000
#define SPIM_FREQUENCY_8M	       8000000
...
static void test_spim_transmission_latency(size_t buffer_size, uint32_t spim_frequency)
{
	int err;
	...
	spim_spec.config.frequency = spim_frequency;
...
ZTEST(spim_transmission_latency, test_spim_transceive_call_latenct_freq_1M)
{
	test_spim_transmission_latency(1, SPIM_FREQUENCY_1M);
	test_spim_transmission_latency(128, SPIM_FREQUENCY_1M);
	test_spim_transmission_latency(512, SPIM_FREQUENCY_1M);
	test_spim_transmission_latency(2000, SPIM_FREQUENCY_1M);
}

ZTEST(spim_transmission_latency, test_spim_transceive_call_latenct_freq_4M)
{
	test_spim_transmission_latency(1, SPIM_FREQUENCY_4M);
	test_spim_transmission_latency(128, SPIM_FREQUENCY_4M);
	test_spim_transmission_latency(512, SPIM_FREQUENCY_4M);
	test_spim_transmission_latency(2000, SPIM_FREQUENCY_4M);
}

ZTEST(spim_transmission_latency, test_spim_transceive_call_latenct_freq_8M)
{
	test_spim_transmission_latency(1, SPIM_FREQUENCY_8M);
	test_spim_transmission_latency(128, SPIM_FREQUENCY_8M);
	test_spim_transmission_latency(512, SPIM_FREQUENCY_8M);
	test_spim_transmission_latency(2000, SPIM_FREQUENCY_8M);
}
