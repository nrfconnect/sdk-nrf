...
#define STORAGE_AREA_DEVICE PARTITION_DEVICE(STORAGE_PARTITION)
#define STORAGE_AREA_ADDRESS PARTITION_OFFSET(STORAGE_PARTITION)

BUILD_ASSERT(STORAGE_AREA_ADDRESS % CONFIG_FPROTECT_BLOCK_SIZE == 0,
