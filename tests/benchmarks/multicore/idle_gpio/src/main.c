...
#if IS_ENABLED(CONFIG_SOC_NRF54H20_CPUAPP) || IS_ENABLED(CONFIG_SOC_NRF9251_CPUAPP)
#define SW_NODE	 DT_ALIAS(sw0)
#define LED_NODE DT_ALIAS(led0)
#elif IS_ENABLED(CONFIG_SOC_NRF54H20_CPURAD) || IS_ENABLED(CONFIG_SOC_NRF54H20_CPUPPR) || \
	IS_ENABLED(CONFIG_SOC_NRF9251_CPUPPR)
