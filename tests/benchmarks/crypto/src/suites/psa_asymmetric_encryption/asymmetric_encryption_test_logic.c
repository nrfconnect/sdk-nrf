...
#include "../psa_signature/rsa_key_vectors.h"
...
static psa_status_t import_key(const void *context)
{
	...
	status = psa_import_key(&attributes, rsa_2048_private_key, rsa_2048_private_key_len,
				       &key_id);
...
const struct op asymmetric_encryption_keysetup_ops[] = {{"import", import_key, NULL}};
