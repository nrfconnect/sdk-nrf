...
operations share one stack (`CONFIG_CRYPTO_BENCHMARKS_OP_STACK_SIZE`);
...
The Python viewer in `scripts/view_results.py` expects the benchmark JSON data and opens a desktop window to plot the measurements.
