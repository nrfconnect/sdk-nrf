...
FAKE_VALUE_FUNC(int, nrf_inet_pton, int, const char *, void *);
...
static int nrf_inet_pton_custom(int family, const char *src, void *dst)
{
	switch (family) {
	case NRF_AF_INET:
...
void setUp(void)
{
	...
	nrf_inet_pton_fake.custom_fake = nrf_inet_pton_custom;
