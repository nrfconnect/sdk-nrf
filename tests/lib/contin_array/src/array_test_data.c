			   ...
			   bool filled)
{
	...
	uint8_t channels = metadata_num_ch_get(meta_contin);
	int8_t test_byte;
	...
	while (contin_locs) {
		/* Test if this is a common location between the output and the tone position. Test
		 * if this location/channel is matching the tone.
		 */
