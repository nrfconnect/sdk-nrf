...
#include "audio_module/audio_module_template.h"
...
ZTEST(suite_audio_module_template, test_module_template)
{
	...
	zassert_equal(return_configuration.sample_rate_hz, configuration.sample_rate_hz, "Failed to get configuration");
