...
#define RRAMC_REGION_FOR_MCUBOOT 4
...
ZTEST(b0_mcuboot_lock_test, test_writing_mcuboot_image)
{
	...
	nrf_rramc_region_config_set(NRF_RRAMC, RRAMC_REGION_FOR_MCUBOOT, &config);
...
ZTEST_SUITE(b0_mcuboot_lock_test, NULL, get_config, NULL, check_fatal, NULL);
