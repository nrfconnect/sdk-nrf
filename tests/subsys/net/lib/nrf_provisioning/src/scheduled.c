...
static int rest_client_request_connection_refused_cb(struct rest_client_req_context *req_ctx,
						      struct rest_client_resp_context *resp_ctx,
						      int cmock_num_calls)
{
	return -ECONNREFUSED;
...
static int rest_client_request_with_commands_cb(struct rest_client_req_context *req_ctx,
						...
						int cmock_num_calls)
{
	static int scenario_call_count = 0;
...
void test_provisioning_init_should_start_provisioning(void)
{
	...
	for (int i = 0; i < 100; i++) {
		...
		case 1: /* Device not found/claimed */
			...
			__cmock_rest_client_request_AddCallback(rest_client_request_not_found_cb);
			wait_for_provisioning_event(NRF_PROVISIONING_EVENT_FAILED_DEVICE_NOT_CLAIMED);
			break;

		case 2: /* Too many commands */
			__cmock_rest_client_request_ExpectAnyArgsAndReturn(0);
			__cmock_rest_client_request_AddCallback(rest_client_request_too_many_commands_cb);
		...
		case 3: /* Successful provisioning with commands */
			...
			__cmock_rest_client_request_ExpectAnyArgsAndReturn(0);
			__cmock_rest_client_request_AddCallback(rest_client_request_with_commands_cb);
		...
		case 4: /* Wrong root CA */
			__cmock_rest_client_request_ExpectAnyArgsAndReturn(0);
			__cmock_rest_client_request_AddCallback(rest_client_request_wrong_root_ca_cb);
		...
		case 6: /* Server error busy */
			...
			__cmock_rest_client_request_AddCallback(rest_client_request_server_error_cb);
