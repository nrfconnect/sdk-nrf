...
DEFINE_FAKE_VALUE_FUNC(int, nrf_cloud_pgnss_begin_update);
DEFINE_FAKE_VALUE_FUNC(int, nrf_cloud_pgnss_process_update, uint8_t *, size_t);
DEFINE_FAKE_VALUE_FUNC(int, nrf_cloud_pgnss_finish_update);
