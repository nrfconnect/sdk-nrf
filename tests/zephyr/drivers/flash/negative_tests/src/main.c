...
#define FLASH_CONTROLLER_NODE DT_PARENT(DT_PARENT(DT_PARENT(DT_NODELABEL(TEST_AREA))))
#define TEST_FLASH_START      DT_REG_ADDR(DT_PARENT(DT_PARENT(DT_NODELABEL(TEST_AREA))))
#define TEST_FLASH_SIZE       (0 DT_FOREACH_CHILD_STATUS_OKAY(FLASH_CONTROLLER_NODE, _ADD_SIZE))
#define TEST_AREA_DEVICE      DEVICE_DT_GET(FLASH_CONTROLLER_NODE)
#else
