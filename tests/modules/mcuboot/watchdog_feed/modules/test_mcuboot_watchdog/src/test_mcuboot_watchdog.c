...
/**
 * The watchdog initialization function inside MCUboot is not suitable for our test.
 * It does not allow to test the first feed of the watchdog inside MCUBoot.
 * Also, this test allows to easily configure the watchdog parameters using Kconfig,
 * which is needed for tests in CI.
 */
