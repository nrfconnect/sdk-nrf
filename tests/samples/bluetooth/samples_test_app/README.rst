...
The Bluetooth LE Master Test app implements a BLE central device that can discover and connect to peripheral devices.
...
#. Scanning - Active scanning for supported peripheral devices
#. Connection - Automatic connection to discovered devices
#. Service discovery - GATT service discovery and logging
#. Connection maintenance - Maintains connection for 5 seconds
#. Disconnection - Graceful disconnection
#. Reconnection - Waits 3 seconds, then reconnects
#. Extended test - Maintains connection for 10 seconds
#. Final disconnection - Completes the test cycle
#. Success indication - Prints ``SUCCESS`` when all steps complete
...
If you want to view the debug messages, follow the procedure described in :ref:`testing_rtt_connect`.
...
The application is designed for integration with automated test frameworks, offering:
