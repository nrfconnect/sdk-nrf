...
if(SB_CONFIG_MCUBOOT_BUILD_DIRECT_XIP_VARIANT)
  ...
  foreach(primary_image ${images})
    # Do not build variant projects for MCUboot as well as MCUboot secondary slot.
    if(${primary_image} STREQUAL "mcuboot")
      continue()
    elseif(${primary_image} STREQUAL "s1_image")
      continue()
    elseif(${primary_image} STREQUAL ${DEFAULT_IMAGE})
      # Keep the old name for backward compatibility.
      set(image "mcuboot_secondary_app")
    elseif(SB_CONFIG_SOC_SERIES_NRF53X)
      # Direct XIP on the radio image is not supported on nRF5340 SoC.
      continue()
    else()
