 ...
 */
#define TAC5112_DAC_VOL_HALF_DB_MIN ((int32_t)TAC5112_DAC_DVOL_MIN - (int32_t)TAC5112_DAC_DVOL_0DB)
#define TAC5112_DAC_VOL_HALF_DB_MAX ((int32_t)TAC5112_DAC_DVOL_MAX - (int32_t)TAC5112_DAC_DVOL_0DB)
#define TAC5112_ADC_VOL_half_db_min ((int32_t)TAC5112_ADC_DVOL_MIN - (int32_t)TAC5112_ADC_DVOL_0DB)
#define TAC5112_ADC_VOL_half_db_max ((int32_t)TAC5112_ADC_DVOL_MAX - (int32_t)TAC5112_ADC_DVOL_0DB)
