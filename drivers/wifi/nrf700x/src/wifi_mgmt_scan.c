			   ...
			   scan_result_cb_t cb)
{
	...
	if (params) {
		...
		if ((params->dwell_time_active < 5) || (params->dwell_time_active > 1000)) {
		...
		if ((params->dwell_time_passive < 10) || (params->dwell_time_passive > 1000)) {
		...
		if ((params->max_bss_cnt < 0) || (params->max_bss_cnt > 65535)) {
