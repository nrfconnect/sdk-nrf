...
/**
 * nrf_wifi_fmac_init() - Initializes the UMAC IF layer of the RPU WLAN FullMAC
 *                        driver.
 *
 ...
 */
struct nrf_wifi_fmac_priv *nrf_wifi_fmac_init(void);


/**
 * nrf_wifi_fmac_stats_get() - Issue a request to get stats from the RPU.
...
/**
 * nrf_wifi_fmac_radio_test_init() - Initialize the RPU for radio tests.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_radio_test_prog_tx() - Start TX tests in radio test mode.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_radio_test_prog_rx() - Start RX tests in radio test mode.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_scan() - Issue a scan request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_scan_res_get() - Issue a scan results request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_scan() - Issue abort of an ongoing scan to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the scan results are to be fetched.
 *
 * This function is used to send a command to
...
/**
 * nrf_wifi_fmac_auth() - Issue a authentication request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_deauth() - Issue a deauthentication request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_assoc() - Issue a association request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_disassoc() - Issue a disassociation request to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_add_key() - Add a key into the RPU security database.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_del_key() - Delete a key from the RPU security database.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_key() - Set a key as a default for data or management
...
/**
 * nrf_wifi_fmac_set_bss() - Set BSS parameters for an AP mode interface to the
 *                           RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_chg_bcn() - Update the Beacon Template.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_start_ap() - Start a SoftAP.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_stop_ap() - Stop a SoftAP.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_start_p2p_dev() - Start P2P mode on an interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_stop_p2p_dev() - Start P2P mode on an interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the P2P mode is to be started.
 *
 * This function is used to send a command to
 ...
 *
 * Returns: Status
 *		Pass: %NRF_WIFI_FMAC_STATUS_SUCCESS
 *		Fail: %NRF_WIFI_FMAC_STATUS_FAIL
 */
...
/**
 * nrf_wifi_fmac_mgmt_tx() - Transmit a management frame.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_del_sta() - Remove a station.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_add_sta() - Indicate a new STA connection to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the STA is connected.
...
/**
 * nrf_wifi_fmac_chg_sta() - Indicate changes to STA connection parameters to
 *                           the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the STA is connected.
...
/**
 * nrf_wifi_fmac_mgmt_frame_reg() - Register the management frame type which
...
/**
 * nrf_wifi_fmac_mac_addr() - Get unused MAC address from base mac address.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_vif_idx_get() - Assign a index for a new VIF.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 *
...
/**
 * nrf_wifi_fmac_add_vif() - Add a new virtual interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_chg_vif() - Change the attributes of an interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_chg_vif_state() - Change the state of a virtual interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_vif_macaddr() - Set MAC address on interface.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_start_xmit() - Trasmit a frame to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the frame is to be
 *              transmitted.
...
/**
 * nrf_wifi_fmac_suspend() - Inform the RPU that host is going to suspend
 *                           state.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 *
 * This function is used to send a command to
...
/**
 * nrf_wifi_fmac_resume() - Notify RPU that host has resumed from a suspended
 *                          state.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 *
 * This function is used to send a command
...
/**
 * nrf_wifi_fmac_get_tx_power() - Get tx power
 *
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: VIF index.
 *
...
/**
 * nrf_wifi_fmac_get_channel() - Get channel definition.
 *
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: VIF index.
 *
...
/**
 * nrf_wifi_fmac_get_station() - Get station statistics
 *
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: VIF index.
...
/* nrf_wifi_fmac_get_interface() - Get interface statistics
 *
...
/**
 * nrf_wifi_fmac_set_power_save() - Configure WLAN power management.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_qos_map() - Configure qos_map of for data
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_wowlan() - Configure WOWLAN.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_get_wiphy() - Get PHY configuration.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_register_frame() - Register to get MGMT frames.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the CMD needs to be sent.
...
/**
 * nrf_wifi_fmac_set_wiphy_params() - set wiphy parameters
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_twt_setup() - TWT setup command
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_twt_teardown() - TWT teardown command
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which the TWT parameters be set.
 * @twt_info: TWT parameters
 *
...
/**
 * nrf_wifi_fmac_get_conn_info() - Get connection info from RPU
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_deinit() - De-initializes the UMAC IF layer of the RPU WLAN
 *                          FullMAC driver.
...
/**
 * nrf_wifi_fmac_dev_add() - Adds a RPU instance.
 * @fpriv: Pointer to the context of the UMAC IF layer.
 *
...
/**
 * nrf_wifi_fmac_dev_rem() - Removes a RPU instance.
...
/**
 * nrf_wifi_fmac_dev_init() - Initializes a RPU instance.
 * @fmac_dev_ctx: Pointer to the context of the RPU instance to be removed.
...
/**
 * nrf_wifi_fmac_dev_deinit() - De-initializes a RPU instance.
 * @fmac_dev_ctx: Pointer to the context of the RPU instance to be removed.
 *
...
/**
 * nrf_wifi_fmac_fw_load() - Loads the Firmware(s) to the RPU WLAN device.
...
/**
 * nrf_wifi_fmac_ver_get() - Get FW versions from the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_conf_btcoex() - Configure BT-Coex parameters in RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_conf_ltf_gi() - Configure HE LTF and GI parameters.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_mcast_addr - set the Multicast filter address.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface whose state needs to be changed.
...
/**
 * nrf_wifi_fmac_otp_mac_addr_get() - Fetch MAC address from OTP.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_rf_params_get() - Get the RF parameters to be programmed to the RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_set_reg() - Set regulatory domain in RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
...
/**
 * nrf_wifi_fmac_get_reg() - Get regulatory domain from RPU.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @reg_info: Pointer to the address where the regulatory domain information
 *		  needs to be copied.
...
/**
 * nrf_wifi_fmac_get_power_save_info() - Get the current power save info.
 * @fmac_dev_ctx: Pointer to the UMAC IF context for a RPU WLAN device.
 * @if_idx: Index of the interface on which power management is to be set.
 *
 * This function is used to send a command
...
#ifdef CONFIG_NRF_WIFI_LOW_POWER
/**
 * nrf_wifi_fmac_get_host_ref_rpu_ps_ctrl_state() - Get the RPU power save
