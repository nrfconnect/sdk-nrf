 ...
 *
 */
#define NRF_WIFI_CMD_MGMT_BUFF_CONFIG 0
/* host uses NRF_WIFI_CMD_TX_BUFF to give tx packet to RPU */
#define NRF_WIFI_CMD_TX_BUFF 1
/* RPU sends tx status to the host using NRF_WIFI_CMD_TX_BUFF_DONE */
#define NRF_WIFI_CMD_TX_BUFF_DONE 2
/* RPU send received buffer using NRF_WIFI_CMD_RX_BUFF to host */
#define NRF_WIFI_CMD_RX_BUFF 3
#define NRF_WIFI_CMD_CARRIER_ON 4
#define NRF_WIFI_CMD_CARRIER_OFF 5
#define NRF_WIFI_CMD_PM_MODE 6
#define NRF_WIFI_CMD_PS_GET_FRAMES 7
 ...
 *
 */
#define NRF_WIFI_RX_PKT_DATA 0
#define NRF_WIFI_RX_PKT_BCN_PRB_RSP 1
