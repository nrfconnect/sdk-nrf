...
#if defined(CONFIG_BUILD_ONLY_NO_BLOBS) || defined(CONFIG_NRF71_NO_HOST_FW_LOAD)
/* No host-side FW load: no blobs build or nRF71 flat (FW on network core). */
...
#endif /* CONFIG_BUILD_ONLY_NO_BLOBS || CONFIG_NRF71_NO_HOST_FW_LOAD */
