			       ...
			       struct nrf_wifi_tx_pwr_ceil_params *tx_pwr_ceil_params)
{
	...
	tx_pwr_ctrl_params->ant_gain_2g = DT_PROP(NRF71_WIFI_NODE, nordic_wifi_ant_gain_2g);
