...
ctrl_mdm_activation_state_t dect_mdm_ctrl_get_mdm_activation_state(void)
{
...
ctrl_ft_cluster_state_t dect_mdm_ctrl_get_ft_cluster_state(void)
{
...
ctrl_ft_nw_beacon_state_t dect_mdm_ctrl_get_ft_nw_beacon_state(void)
{
...
ctrl_pt_association_state_t dect_mdm_ctrl_get_pt_association_state(void)
{
...
int dect_mdm_ctrl_internal_msgq_non_data_op_add(dect_mdm_ctrl_op_t event_id)
{
	int ret = 0;
...
int dect_mdm_ctrl_internal_msgq_data_op_add(dect_mdm_ctrl_op_t event_id, void *data,
					      size_t data_size)
{
	int ret = 0;
	struct dect_mdm_common_op_event_msgq_item event;
...
static int dect_mdm_ctrl_configure_cmd(dect_mdm_ctrl_configure_params_t *params)
{
...
{
	dect_mdm_ctrl_configure_params_t params;
	struct dect_mdm_settings *set_ptr = dect_mdm_settings_ref_get();
	int ret;
...
static void handle_mdm_configure_resp(struct dect_mdm_common_op_event_msgq_item *event)
{
	...
	ctrl_mdm_activation_state_t activation_state = dect_mdm_ctrl_get_mdm_activation_state();
