...
int dect_mdm_ctrl_api_nw_scan_cmd(
...
int dect_mdm_ctrl_api_tx_cmd(dect_mdm_ctrl_api_tx_cmd_params_t *params)
{
...
{
	ARG_UNUSED(params);
	ctrl_ft_nw_beacon_state_t nw_beacon_state = dect_mdm_ctrl_get_ft_nw_beacon_state();
